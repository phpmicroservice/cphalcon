...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_phalcon_db_adapter_pdo_factory_load, 0, 1, Phalcon\\Db\\AdapterInterface, 0)
#else
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_phalcon_db_adapter_pdo_factory_load, 0, 1, IS_OBJECT, "Phalcon\\Db\\AdapterInterface", 0)
#endif
