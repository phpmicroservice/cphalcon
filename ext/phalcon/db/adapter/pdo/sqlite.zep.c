...
PHP_METHOD(Phalcon_Db_Adapter_Pdo_Sqlite, describeColumns) {
	...
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *table_param = NULL, *schema_param = NULL, __$true, columns, columnType, field, definition, oldColumn, sizePattern, matches, matchOne, matchTwo, columnName, _0, _1, _2, _3, *_4, _5, _29$$3, _30$$3, _31$$3, _32$$3, _33$$3, _36$$3, _7$$4, _8$$4, _9$$5, _10$$5, _11$$6, _12$$6, _13$$6, _14$$8, _15$$9, _16$$10, _17$$11, _18$$11, _19$$12, _20$$13, _21$$14, _22$$15, _23$$15, _24$$16, _25$$17, _26$$18, _27$$20, _28$$21, _37$$27, _38$$27, _39$$27, _40$$27, _43$$28, _67$$28, _68$$28, _69$$28, _70$$28, _71$$28, _73$$28, _45$$29, _46$$29, _47$$30, _48$$30, _49$$31, _50$$31, _51$$31, _52$$33, _53$$34, _54$$35, _55$$36, _56$$36, _57$$37, _58$$38, _59$$39, _60$$40, _61$$40, _62$$41, _63$$42, _64$$43, _65$$45, _66$$46, _74$$52, _75$$52, _76$$52, _77$$52;
	zval table, schema;
	zval *this_ptr = getThis();
	...
	if (Z_TYPE_P(&_0) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_0), _4)
		{
			...
			zephir_array_fetch_long(&columnType, &field, 2, PH_NOISY, "phalcon/db/adapter/pdo/sqlite.zep", 108);
			_6$$3 = zephir_memnstr_str(&columnType, SL("int"), "phalcon/db/adapter/pdo/sqlite.zep", 124);
			if (!(_6$$3)) {
				_6$$3 = zephir_memnstr_str(&columnType, SL("INT"), "phalcon/db/adapter/pdo/sqlite.zep", 124);
			}
			if (zephir_memnstr_str(&columnType, SL("tinyint(1)"), "phalcon/db/adapter/pdo/sqlite.zep", 110)) {
				...
				zephir_array_fetch_long(&_13$$6, &field, 5, PH_NOISY | PH_READONLY, "phalcon/db/adapter/pdo/sqlite.zep", 132);
			...
			if (zephir_memnstr_str(&columnType, SL("("), "phalcon/db/adapter/pdo/sqlite.zep", 194)) {
				...
				zephir_preg_match(&_26$$18, &sizePattern, &columnType, &matches, 0, 0 , 0 );
			...
			zephir_array_fetch_long(&_29$$3, &field, 5, PH_NOISY | PH_READONLY, "phalcon/db/adapter/pdo/sqlite.zep", 225);
			if (zephir_is_true(&_29$$3)) {
				zephir_array_update_string(&definition, SL("primary"), &__$true, PH_COPY | PH_SEPARATE);
			}
			zephir_array_fetch_long(&_30$$3, &field, 3, PH_NOISY | PH_READONLY, "phalcon/db/adapter/pdo/sqlite.zep", 232);
			if (zephir_is_true(&_30$$3)) {
				zephir_array_update_string(&definition, SL("notNull"), &__$true, PH_COPY | PH_SEPARATE);
			}
			zephir_array_fetch_long(&_31$$3, &field, 4, PH_NOISY | PH_READONLY, "phalcon/db/adapter/pdo/sqlite.zep", 240);
			ZEPHIR_INIT_NVAR(&_32$$3);
			ZVAL_STRING(&_32$$3, "null");
			ZEPHIR_CALL_FUNCTION(&_33$$3, "strcasecmp", &_34, 11, &_31$$3, &_32$$3);
			zephir_check_call_status();
			_35$$3 = !ZEPHIR_IS_LONG(&_33$$3, 0);
			if (_35$$3) {
				zephir_array_fetch_long(&_36$$3, &field, 4, PH_NOISY | PH_READONLY, "phalcon/db/adapter/pdo/sqlite.zep", 240);
				_35$$3 = !ZEPHIR_IS_STRING(&_36$$3, "");
			}
			if (_35$$3) {
				zephir_array_fetch_long(&_37$$27, &field, 4, PH_NOISY | PH_READONLY, "phalcon/db/adapter/pdo/sqlite.zep", 241);
				ZEPHIR_INIT_NVAR(&_38$$27);
				ZVAL_STRING(&_38$$27, "/^'|'$/");
				ZEPHIR_INIT_NVAR(&_39$$27);
				ZVAL_STRING(&_39$$27, "");
				ZEPHIR_CALL_FUNCTION(&_40$$27, "preg_replace", &_41, 35, &_38$$27, &_39$$27, &_37$$27);
				zephir_check_call_status();
				zephir_array_update_string(&definition, SL("default"), &_40$$27, PH_COPY | PH_SEPARATE);
			}
			zephir_array_fetch_long(&columnName, &field, 1, PH_NOISY | PH_READONLY, "phalcon/db/adapter/pdo/sqlite.zep", 247);
			ZEPHIR_INIT_NVAR(&_32$$3);
			object_init_ex(&_32$$3, phalcon_db_column_ce);
			ZEPHIR_CALL_METHOD(NULL, &_32$$3, "__construct", &_42, 154, &columnName, &definition);
			zephir_check_call_status();
			zephir_array_append(&columns, &_32$$3, PH_SEPARATE, "phalcon/db/adapter/pdo/sqlite.zep", 248);
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				zephir_create_array(&_43$$28, 1, 0);
				add_assoc_long_ex(&_43$$28, SL("bindType"), 2);
				ZEPHIR_CPY_WRT(&definition, &_43$$28);
				ZEPHIR_OBS_NVAR(&columnType);
				zephir_array_fetch_long(&columnType, &field, 2, PH_NOISY, "phalcon/db/adapter/pdo/sqlite.zep", 108);
				_44$$28 = zephir_memnstr_str(&columnType, SL("int"), "phalcon/db/adapter/pdo/sqlite.zep", 124);
				if (!(_44$$28)) {
					_44$$28 = zephir_memnstr_str(&columnType, SL("INT"), "phalcon/db/adapter/pdo/sqlite.zep", 124);
				}
				if (zephir_memnstr_str(&columnType, SL("tinyint(1)"), "phalcon/db/adapter/pdo/sqlite.zep", 110)) {
					...
					ZEPHIR_INIT_NVAR(&_49$$31);
					ZVAL_LONG(&_49$$31, 0);
					zephir_array_update_string(&definition, SL("type"), &_49$$31, PH_COPY | PH_SEPARATE);
					zephir_array_update_string(&definition, SL("isNumeric"), &__$true, PH_COPY | PH_SEPARATE);
					ZEPHIR_INIT_NVAR(&_50$$31);
					ZVAL_LONG(&_50$$31, 1);
					zephir_array_update_string(&definition, SL("bindType"), &_50$$31, PH_COPY | PH_SEPARATE);
					zephir_array_fetch_long(&_51$$31, &field, 5, PH_NOISY | PH_READONLY, "phalcon/db/adapter/pdo/sqlite.zep", 132);
					if (zephir_is_true(&_51$$31)) {
						zephir_array_update_string(&definition, SL("autoIncrement"), &__$true, PH_COPY | PH_SEPARATE);
					}
				} else if (zephir_memnstr_str(&columnType, SL("varchar"), "phalcon/db/adapter/pdo/sqlite.zep", 135)) {
				...
				if (zephir_memnstr_str(&columnType, SL("("), "phalcon/db/adapter/pdo/sqlite.zep", 194)) {
					...
					zephir_preg_match(&_64$$43, &sizePattern, &columnType, &matches, 0, 0 , 0 );
				...
				zephir_array_fetch_long(&_67$$28, &field, 5, PH_NOISY | PH_READONLY, "phalcon/db/adapter/pdo/sqlite.zep", 225);
				if (zephir_is_true(&_67$$28)) {
					zephir_array_update_string(&definition, SL("primary"), &__$true, PH_COPY | PH_SEPARATE);
				}
				zephir_array_fetch_long(&_68$$28, &field, 3, PH_NOISY | PH_READONLY, "phalcon/db/adapter/pdo/sqlite.zep", 232);
				if (zephir_is_true(&_68$$28)) {
					zephir_array_update_string(&definition, SL("notNull"), &__$true, PH_COPY | PH_SEPARATE);
				}
				zephir_array_fetch_long(&_69$$28, &field, 4, PH_NOISY | PH_READONLY, "phalcon/db/adapter/pdo/sqlite.zep", 240);
				ZEPHIR_INIT_NVAR(&_70$$28);
				ZVAL_STRING(&_70$$28, "null");
				ZEPHIR_CALL_FUNCTION(&_71$$28, "strcasecmp", &_34, 11, &_69$$28, &_70$$28);
				zephir_check_call_status();
				_72$$28 = !ZEPHIR_IS_LONG(&_71$$28, 0);
				if (_72$$28) {
					zephir_array_fetch_long(&_73$$28, &field, 4, PH_NOISY | PH_READONLY, "phalcon/db/adapter/pdo/sqlite.zep", 240);
					_72$$28 = !ZEPHIR_IS_STRING(&_73$$28, "");
				}
				if (_72$$28) {
					zephir_array_fetch_long(&_74$$52, &field, 4, PH_NOISY | PH_READONLY, "phalcon/db/adapter/pdo/sqlite.zep", 241);
					ZEPHIR_INIT_NVAR(&_75$$52);
					ZVAL_STRING(&_75$$52, "/^'|'$/");
					ZEPHIR_INIT_NVAR(&_76$$52);
					ZVAL_STRING(&_76$$52, "");
					ZEPHIR_CALL_FUNCTION(&_77$$52, "preg_replace", &_41, 35, &_75$$52, &_76$$52, &_74$$52);
					zephir_check_call_status();
					zephir_array_update_string(&definition, SL("default"), &_77$$52, PH_COPY | PH_SEPARATE);
				}
				ZEPHIR_OBS_NVAR(&columnName);
				zephir_array_fetch_long(&columnName, &field, 1, PH_NOISY, "phalcon/db/adapter/pdo/sqlite.zep", 247);
				ZEPHIR_INIT_NVAR(&_70$$28);
				object_init_ex(&_70$$28, phalcon_db_column_ce);
				ZEPHIR_CALL_METHOD(NULL, &_70$$28, "__construct", &_42, 154, &columnName, &definition);
				zephir_check_call_status();
				zephir_array_append(&columns, &_70$$28, PH_SEPARATE, "phalcon/db/adapter/pdo/sqlite.zep", 248);
				ZEPHIR_CPY_WRT(&oldColumn, &columnName);
...
PHP_METHOD(Phalcon_Db_Adapter_Pdo_Sqlite, describeIndexes) {
	...
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "fetchall", NULL, 0, &_2, &_3);
	zephir_check_call_status();
	zephir_is_iterable(&_0, 0, "phalcon/db/adapter/pdo/sqlite.zep", 304);
	if (Z_TYPE_P(&_0) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_0), _4)
		{
			...
			zephir_array_fetch_string(&keyName, &index, SL("name"), PH_NOISY, "phalcon/db/adapter/pdo/sqlite.zep", 274);
			if (!(zephir_array_isset(&indexes, &keyName))) {
				ZEPHIR_INIT_NVAR(&_6$$4);
				array_init(&_6$$4);
				zephir_array_update_zval(&indexes, &keyName, &_6$$4, PH_COPY | PH_SEPARATE);
			}
			zephir_array_fetch(&_7$$3, &indexes, &keyName, PH_READONLY, "phalcon/db/adapter/pdo/sqlite.zep", 280);
			if (!(zephir_array_isset_string(&_7$$3, SL("columns")))) {
				ZEPHIR_INIT_NVAR(&columns);
				array_init(&columns);
			} else {
				zephir_array_fetch(&_8$$6, &indexes, &keyName, PH_NOISY | PH_READONLY, "phalcon/db/adapter/pdo/sqlite.zep", 283);
				ZEPHIR_OBS_NVAR(&columns);
				zephir_array_fetch_string(&columns, &_8$$6, SL("columns"), PH_NOISY, "phalcon/db/adapter/pdo/sqlite.zep", 283);
			}
			...
			zephir_check_call_status();
			zephir_is_iterable(&_9$$3, 0, "phalcon/db/adapter/pdo/sqlite.zep", 290);
			if (Z_TYPE_P(&_9$$3) == IS_ARRAY) {
				ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_9$$3), _13$$3)
				{
					...
					zephir_array_fetch_string(&_15$$7, &describeIndex, SL("name"), PH_NOISY | PH_READONLY, "phalcon/db/adapter/pdo/sqlite.zep", 287);
					zephir_array_append(&columns, &_15$$7, PH_SEPARATE, "phalcon/db/adapter/pdo/sqlite.zep", 287);
				} ZEND_HASH_FOREACH_END();
			} else {
				...
				while (1) {
					...
					zephir_check_call_status();
						zephir_array_fetch_string(&_16$$8, &describeIndex, SL("name"), PH_NOISY | PH_READONLY, "phalcon/db/adapter/pdo/sqlite.zep", 287);
						zephir_array_append(&columns, &_16$$8, PH_SEPARATE, "phalcon/db/adapter/pdo/sqlite.zep", 287);
			...
			zephir_check_call_status();
			zephir_array_fetch_string(&_19$$3, &index, SL("unique"), PH_NOISY | PH_READONLY, "phalcon/db/adapter/pdo/sqlite.zep", 293);
			if (zephir_is_true(&_19$$3)) {
				...
				zephir_preg_match(&_22$$9, &_23$$9, &indexSql, &_20$$9, 0, 0 , 0 );
				if (zephir_is_true(&_22$$9)) {
					ZEPHIR_INIT_NVAR(&_24$$10);
					ZVAL_STRING(&_24$$10, "UNIQUE");
					zephir_array_update_multi(&indexes, &_24$$10, SL("zs"), 3, &keyName, SL("type"));
				} else {
					ZEPHIR_INIT_NVAR(&_25$$11);
					ZVAL_STRING(&_25$$11, "PRIMARY");
					zephir_array_update_multi(&indexes, &_25$$11, SL("zs"), 3, &keyName, SL("type"));
				}
			} else {
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				zephir_array_fetch(&_27$$13, &indexes, &keyName, PH_READONLY, "phalcon/db/adapter/pdo/sqlite.zep", 280);
				if (!(zephir_array_isset_string(&_27$$13, SL("columns")))) {
					ZEPHIR_INIT_NVAR(&columns);
					array_init(&columns);
				} else {
					zephir_array_fetch(&_28$$16, &indexes, &keyName, PH_NOISY | PH_READONLY, "phalcon/db/adapter/pdo/sqlite.zep", 283);
					ZEPHIR_OBS_NVAR(&columns);
					zephir_array_fetch_string(&columns, &_28$$16, SL("columns"), PH_NOISY, "phalcon/db/adapter/pdo/sqlite.zep", 283);
				}
				...
				zephir_check_call_status();
				zephir_is_iterable(&_29$$13, 0, "phalcon/db/adapter/pdo/sqlite.zep", 290);
				if (Z_TYPE_P(&_29$$13) == IS_ARRAY) {
					ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_29$$13), _33$$13)
					{
						ZEPHIR_INIT_NVAR(&describeIndex);
						ZVAL_COPY(&describeIndex, _33$$13);
						zephir_array_fetch_string(&_35$$17, &describeIndex, SL("name"), PH_NOISY | PH_READONLY, "phalcon/db/adapter/pdo/sqlite.zep", 287);
						zephir_array_append(&columns, &_35$$17, PH_SEPARATE, "phalcon/db/adapter/pdo/sqlite.zep", 287);
					} ZEND_HASH_FOREACH_END();
				} else {
					...
					while (1) {
						...
						zephir_check_call_status();
							zephir_array_fetch_string(&_36$$18, &describeIndex, SL("name"), PH_NOISY | PH_READONLY, "phalcon/db/adapter/pdo/sqlite.zep", 287);
							zephir_array_append(&columns, &_36$$18, PH_SEPARATE, "phalcon/db/adapter/pdo/sqlite.zep", 287);
				...
				zephir_check_call_status();
				zephir_array_fetch_string(&_38$$13, &index, SL("unique"), PH_NOISY | PH_READONLY, "phalcon/db/adapter/pdo/sqlite.zep", 293);
				if (zephir_is_true(&_38$$13)) {
					...
					zephir_preg_match(&_41$$19, &_42$$19, &indexSql, &_39$$19, 0, 0 , 0 );
					if (zephir_is_true(&_41$$19)) {
						ZEPHIR_INIT_NVAR(&_43$$20);
						ZVAL_STRING(&_43$$20, "UNIQUE");
						zephir_array_update_multi(&indexes, &_43$$20, SL("zs"), 3, &keyName, SL("type"));
					} else {
						ZEPHIR_INIT_NVAR(&_44$$21);
						ZVAL_STRING(&_44$$21, "PRIMARY");
						zephir_array_update_multi(&indexes, &_44$$21, SL("zs"), 3, &keyName, SL("type"));
					}
				} else {
					zephir_array_update_multi(&indexes, &__$null, SL("zs"), 3, &keyName, SL("type"));
				}
	...
	zephir_is_iterable(&indexes, 0, "phalcon/db/adapter/pdo/sqlite.zep", 309);
	if (Z_TYPE_P(&indexes) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&indexes), _47, _48, _45)
		{
			...
			zephir_array_fetch_string(&_50$$23, &index, SL("columns"), PH_NOISY | PH_READONLY, "phalcon/db/adapter/pdo/sqlite.zep", 306);
			zephir_array_fetch_string(&_51$$23, &index, SL("type"), PH_NOISY | PH_READONLY, "phalcon/db/adapter/pdo/sqlite.zep", 306);
			ZEPHIR_CALL_METHOD(NULL, &_49$$23, "__construct", &_52, 19, &name, &_50$$23, &_51$$23);
			zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				zephir_array_fetch_string(&_54$$24, &index, SL("columns"), PH_NOISY | PH_READONLY, "phalcon/db/adapter/pdo/sqlite.zep", 306);
				zephir_array_fetch_string(&_55$$24, &index, SL("type"), PH_NOISY | PH_READONLY, "phalcon/db/adapter/pdo/sqlite.zep", 306);
				ZEPHIR_CALL_METHOD(NULL, &_53$$24, "__construct", &_52, 19, &name, &_54$$24, &_55$$24);
				zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Adapter_Pdo_Sqlite, describeReferences) {
	...
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "fetchall", NULL, 0, &_2, &_3);
	zephir_check_call_status();
	zephir_is_iterable(&_0, 0, "phalcon/db/adapter/pdo/sqlite.zep", 354);
	if (Z_TYPE_P(&_0) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&_0), _6, _7, _4)
		{
			...
			if (!(zephir_array_isset(&references, &constraintName))) {
				...
				zephir_array_fetch_long(&referencedTable, &reference, 2, PH_NOISY, "phalcon/db/adapter/pdo/sqlite.zep", 333);
				ZEPHIR_INIT_NVAR(&columns);
				array_init(&columns);
				ZEPHIR_INIT_NVAR(&referencedColumns);
				array_init(&referencedColumns);
			} else {
				zephir_array_fetch(&_8$$5, &references, &constraintName, PH_NOISY | PH_READONLY, "phalcon/db/adapter/pdo/sqlite.zep", 337);
				ZEPHIR_OBS_NVAR(&referencedSchema);
				zephir_array_fetch_string(&referencedSchema, &_8$$5, SL("referencedSchema"), PH_NOISY, "phalcon/db/adapter/pdo/sqlite.zep", 337);
				zephir_array_fetch(&_9$$5, &references, &constraintName, PH_NOISY | PH_READONLY, "phalcon/db/adapter/pdo/sqlite.zep", 338);
				ZEPHIR_OBS_NVAR(&referencedTable);
				zephir_array_fetch_string(&referencedTable, &_9$$5, SL("referencedTable"), PH_NOISY, "phalcon/db/adapter/pdo/sqlite.zep", 338);
				zephir_array_fetch(&_10$$5, &references, &constraintName, PH_NOISY | PH_READONLY, "phalcon/db/adapter/pdo/sqlite.zep", 339);
				ZEPHIR_OBS_NVAR(&columns);
				zephir_array_fetch_string(&columns, &_10$$5, SL("columns"), PH_NOISY, "phalcon/db/adapter/pdo/sqlite.zep", 339);
				zephir_array_fetch(&_11$$5, &references, &constraintName, PH_NOISY | PH_READONLY, "phalcon/db/adapter/pdo/sqlite.zep", 340);
				ZEPHIR_OBS_NVAR(&referencedColumns);
				zephir_array_fetch_string(&referencedColumns, &_11$$5, SL("referencedColumns"), PH_NOISY, "phalcon/db/adapter/pdo/sqlite.zep", 340);
			}
			zephir_array_fetch_long(&_12$$3, &reference, 3, PH_NOISY | PH_READONLY, "phalcon/db/adapter/pdo/sqlite.zep", 343);
			zephir_array_append(&columns, &_12$$3, PH_SEPARATE, "phalcon/db/adapter/pdo/sqlite.zep", 343);
			zephir_array_fetch_long(&_13$$3, &reference, 4, PH_NOISY | PH_READONLY, "phalcon/db/adapter/pdo/sqlite.zep", 344);
			zephir_array_append(&referencedColumns, &_13$$3, PH_SEPARATE, "phalcon/db/adapter/pdo/sqlite.zep", 344);
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				if (!(zephir_array_isset(&references, &constraintName))) {
					...
					zephir_array_fetch(&_15$$8, &references, &constraintName, PH_NOISY | PH_READONLY, "phalcon/db/adapter/pdo/sqlite.zep", 337);
					ZEPHIR_OBS_NVAR(&referencedSchema);
					zephir_array_fetch_string(&referencedSchema, &_15$$8, SL("referencedSchema"), PH_NOISY, "phalcon/db/adapter/pdo/sqlite.zep", 337);
					zephir_array_fetch(&_16$$8, &references, &constraintName, PH_NOISY | PH_READONLY, "phalcon/db/adapter/pdo/sqlite.zep", 338);
					ZEPHIR_OBS_NVAR(&referencedTable);
					zephir_array_fetch_string(&referencedTable, &_16$$8, SL("referencedTable"), PH_NOISY, "phalcon/db/adapter/pdo/sqlite.zep", 338);
					zephir_array_fetch(&_17$$8, &references, &constraintName, PH_NOISY | PH_READONLY, "phalcon/db/adapter/pdo/sqlite.zep", 339);
					ZEPHIR_OBS_NVAR(&columns);
					zephir_array_fetch_string(&columns, &_17$$8, SL("columns"), PH_NOISY, "phalcon/db/adapter/pdo/sqlite.zep", 339);
					zephir_array_fetch(&_18$$8, &references, &constraintName, PH_NOISY | PH_READONLY, "phalcon/db/adapter/pdo/sqlite.zep", 340);
					ZEPHIR_OBS_NVAR(&referencedColumns);
					zephir_array_fetch_string(&referencedColumns, &_18$$8, SL("referencedColumns"), PH_NOISY, "phalcon/db/adapter/pdo/sqlite.zep", 340);
				}
				zephir_array_fetch_long(&_19$$6, &reference, 3, PH_NOISY | PH_READONLY, "phalcon/db/adapter/pdo/sqlite.zep", 343);
				zephir_array_append(&columns, &_19$$6, PH_SEPARATE, "phalcon/db/adapter/pdo/sqlite.zep", 343);
				zephir_array_fetch_long(&_20$$6, &reference, 4, PH_NOISY | PH_READONLY, "phalcon/db/adapter/pdo/sqlite.zep", 344);
				zephir_array_append(&referencedColumns, &_20$$6, PH_SEPARATE, "phalcon/db/adapter/pdo/sqlite.zep", 344);
	...
	zephir_is_iterable(&references, 0, "phalcon/db/adapter/pdo/sqlite.zep", 364);
	if (Z_TYPE_P(&references) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&references), _24, _25, _22)
		{
			...
			zephir_array_fetch_string(&_28$$9, &arrayReference, SL("referencedSchema"), PH_NOISY, "phalcon/db/adapter/pdo/sqlite.zep", 357);
			zephir_array_update_string(&_27$$9, SL("referencedSchema"), &_28$$9, PH_COPY | PH_SEPARATE);
			ZEPHIR_OBS_NVAR(&_28$$9);
			zephir_array_fetch_string(&_28$$9, &arrayReference, SL("referencedTable"), PH_NOISY, "phalcon/db/adapter/pdo/sqlite.zep", 358);
			zephir_array_update_string(&_27$$9, SL("referencedTable"), &_28$$9, PH_COPY | PH_SEPARATE);
			ZEPHIR_OBS_NVAR(&_28$$9);
			zephir_array_fetch_string(&_28$$9, &arrayReference, SL("columns"), PH_NOISY, "phalcon/db/adapter/pdo/sqlite.zep", 359);
			zephir_array_update_string(&_27$$9, SL("columns"), &_28$$9, PH_COPY | PH_SEPARATE);
			ZEPHIR_OBS_NVAR(&_28$$9);
			zephir_array_fetch_string(&_28$$9, &arrayReference, SL("referencedColumns"), PH_NOISY, "phalcon/db/adapter/pdo/sqlite.zep", 361);
			zephir_array_update_string(&_27$$9, SL("referencedColumns"), &_28$$9, PH_COPY | PH_SEPARATE);
			ZEPHIR_CALL_METHOD(NULL, &_26$$9, "__construct", &_29, 20, &name, &_27$$9);
			zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				zephir_array_fetch_string(&_32$$10, &arrayReference, SL("referencedSchema"), PH_NOISY, "phalcon/db/adapter/pdo/sqlite.zep", 357);
				zephir_array_update_string(&_31$$10, SL("referencedSchema"), &_32$$10, PH_COPY | PH_SEPARATE);
				ZEPHIR_OBS_NVAR(&_32$$10);
				zephir_array_fetch_string(&_32$$10, &arrayReference, SL("referencedTable"), PH_NOISY, "phalcon/db/adapter/pdo/sqlite.zep", 358);
				zephir_array_update_string(&_31$$10, SL("referencedTable"), &_32$$10, PH_COPY | PH_SEPARATE);
				ZEPHIR_OBS_NVAR(&_32$$10);
				zephir_array_fetch_string(&_32$$10, &arrayReference, SL("columns"), PH_NOISY, "phalcon/db/adapter/pdo/sqlite.zep", 359);
				zephir_array_update_string(&_31$$10, SL("columns"), &_32$$10, PH_COPY | PH_SEPARATE);
				ZEPHIR_OBS_NVAR(&_32$$10);
				zephir_array_fetch_string(&_32$$10, &arrayReference, SL("referencedColumns"), PH_NOISY, "phalcon/db/adapter/pdo/sqlite.zep", 361);
				zephir_array_update_string(&_31$$10, SL("referencedColumns"), &_32$$10, PH_COPY | PH_SEPARATE);
				ZEPHIR_CALL_METHOD(NULL, &_30$$10, "__construct", &_29, 20, &name, &_31$$10);
				zephir_check_call_status();
