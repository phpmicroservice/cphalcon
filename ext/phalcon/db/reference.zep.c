...
ZEPHIR_INIT_CLASS(Phalcon_Db_Reference) {
	 ...
	 * @var string
	 */
	zend_declare_property_null(phalcon_db_reference_ce, SL("_name"), ZEND_ACC_PROTECTED);
...
PHP_METHOD(Phalcon_Db_Reference, __construct) {
	...
	if (zephir_fast_count_int(&columns) != zephir_fast_count_int(&referencedColumns)) {
