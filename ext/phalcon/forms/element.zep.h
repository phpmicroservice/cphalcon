...
#if PHP_VERSION_ID >= 70200
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_phalcon_forms_element_getmessages, 0, 0, Phalcon\\Validation\\Message\\Group, 0)
#else
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_phalcon_forms_element_getmessages, 0, 0, IS_OBJECT, "Phalcon\\Validation\\Message\\Group", 0)
#endif
ZEND_END_ARG_INFO()
