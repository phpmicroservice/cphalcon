...
PHP_METHOD(Phalcon_Di_Service_Builder, _buildParameter) {
	...
	if (!(zephir_array_isset_string_fetch(&type, &argument, SL("type"), 0))) {
		...
		zephir_throw_exception_debug(&_0$$3, "phalcon/di/service/builder.zep", 49);
		ZEPHIR_MM_RESTORE();
		return;
	}
	do {
		if (ZEPHIR_IS_STRING(&type, "service")) {
			...
			if (!(zephir_array_isset_string_fetch(&name, &argument, SL("name"), 0))) {
				...
				zephir_check_call_status();
				zephir_throw_exception_debug(&_3$$5, "phalcon/di/service/builder.zep", 59);
				ZEPHIR_MM_RESTORE();
				return;
			}
		...
		if (ZEPHIR_IS_STRING(&type, "parameter")) {
			...
			if (!(zephir_array_isset_string_fetch(&value, &argument, SL("value"), 0))) {
				...
				zephir_check_call_status();
				zephir_throw_exception_debug(&_6$$8, "phalcon/di/service/builder.zep", 71);
				ZEPHIR_MM_RESTORE();
				return;
			}
			RETURN_CCTOR(&value);
		...
		if (ZEPHIR_IS_STRING(&type, "instance")) {
			...
			if (!(zephir_array_isset_string_fetch(&name, &argument, SL("className"), 0))) {
				...
				zephir_check_call_status();
				zephir_throw_exception_debug(&_9$$10, "phalcon/di/service/builder.zep", 81);
				ZEPHIR_MM_RESTORE();
				return;
			}
			if (Z_TYPE_P(dependencyInjector) != IS_OBJECT) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_12$$13, "phalcon/di/service/builder.zep", 104);
		ZEPHIR_MM_RESTORE();
		return;
	} while(0);
...
PHP_METHOD(Phalcon_Di_Service_Builder, _buildParameters) {
	...
	zval arguments;
	zval *dependencyInjector, dependencyInjector_sub, *arguments_param = NULL, position, argument, buildArguments, *_0, _1, _4$$3, _6$$4;
	zval *this_ptr = getThis();
	...
	zephir_is_iterable(&arguments, 0, "phalcon/di/service/builder.zep", 119);
...
PHP_METHOD(Phalcon_Di_Service_Builder, build) {
	...
	if (zephir_array_isset_string_fetch(&paramCalls, &definition, SL("calls"), 0)) {
		...
		zephir_is_iterable(&paramCalls, 0, "phalcon/di/service/builder.zep", 235);
		if (Z_TYPE_P(&paramCalls) == IS_ARRAY) {
			ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&paramCalls), _3$$10, _4$$10, _1$$10)
			{
				...
				if (Z_TYPE_P(&method) != IS_ARRAY) {
					...
					ZEPHIR_CALL_METHOD(NULL, &_5$$14, "__construct", &_7, 4, &_6$$14);
					zephir_check_call_status();
					zephir_throw_exception_debug(&_5$$14, "phalcon/di/service/builder.zep", 195);
					ZEPHIR_MM_RESTORE();
					return;
				}
				...
				if (!(zephir_array_isset_string_fetch(&methodName, &method, SL("method"), 0))) {
					...
					ZEPHIR_CALL_METHOD(NULL, &_8$$15, "__construct", &_7, 4, &_9$$15);
					zephir_check_call_status();
					zephir_throw_exception_debug(&_8$$15, "phalcon/di/service/builder.zep", 202);
					ZEPHIR_MM_RESTORE();
					return;
				}
				...
				if (zephir_array_isset_string_fetch(&arguments, &method, SL("arguments"), 0)) {
					if (Z_TYPE_P(&arguments) != IS_ARRAY) {
						...
						ZEPHIR_CALL_METHOD(NULL, &_10$$17, "__construct", &_7, 4, &_11$$17);
						zephir_check_call_status();
						zephir_throw_exception_debug(&_10$$17, "phalcon/di/service/builder.zep", 213);
						ZEPHIR_MM_RESTORE();
						return;
					}
			...
			while (1) {
				...
				zephir_check_call_status();
					if (Z_TYPE_P(&method) != IS_ARRAY) {
						...
						ZEPHIR_CALL_METHOD(NULL, &_15$$20, "__construct", &_7, 4, &_16$$20);
						zephir_check_call_status();
						zephir_throw_exception_debug(&_15$$20, "phalcon/di/service/builder.zep", 195);
						ZEPHIR_MM_RESTORE();
						return;
					}
					ZEPHIR_OBS_NVAR(&methodName);
					if (!(zephir_array_isset_string_fetch(&methodName, &method, SL("method"), 0))) {
						...
						ZEPHIR_CALL_METHOD(NULL, &_17$$21, "__construct", &_7, 4, &_18$$21);
						zephir_check_call_status();
						zephir_throw_exception_debug(&_17$$21, "phalcon/di/service/builder.zep", 202);
						ZEPHIR_MM_RESTORE();
						return;
					}
					...
					if (zephir_array_isset_string_fetch(&arguments, &method, SL("arguments"), 0)) {
						if (Z_TYPE_P(&arguments) != IS_ARRAY) {
							...
							ZEPHIR_CALL_METHOD(NULL, &_20$$23, "__construct", &_7, 4, &_21$$23);
							zephir_check_call_status();
							zephir_throw_exception_debug(&_20$$23, "phalcon/di/service/builder.zep", 213);
							ZEPHIR_MM_RESTORE();
							return;
						}
						if (zephir_fast_count_int(&arguments)) {
	...
	if (zephir_array_isset_string_fetch(&paramCalls, &definition, SL("properties"), 0)) {
		...
		zephir_is_iterable(&paramCalls, 0, "phalcon/di/service/builder.zep", 283);
		if (Z_TYPE_P(&paramCalls) == IS_ARRAY) {
			ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&paramCalls), _27$$25, _28$$25, _25$$25)
			{
				...
				if (Z_TYPE_P(&property) != IS_ARRAY) {
					...
					ZEPHIR_CALL_METHOD(NULL, &_29$$29, "__construct", &_7, 4, &_30$$29);
					zephir_check_call_status();
					zephir_throw_exception_debug(&_29$$29, "phalcon/di/service/builder.zep", 261);
					ZEPHIR_MM_RESTORE();
					return;
				}
				...
				if (!(zephir_array_isset_string_fetch(&propertyName, &property, SL("name"), 0))) {
					...
					ZEPHIR_CALL_METHOD(NULL, &_31$$30, "__construct", &_7, 4, &_32$$30);
					zephir_check_call_status();
					zephir_throw_exception_debug(&_31$$30, "phalcon/di/service/builder.zep", 268);
					ZEPHIR_MM_RESTORE();
					return;
				}
				...
				if (!(zephir_array_isset_string_fetch(&propertyValue, &property, SL("value"), 0))) {
					...
					ZEPHIR_CALL_METHOD(NULL, &_33$$31, "__construct", &_7, 4, &_34$$31);
					zephir_check_call_status();
					zephir_throw_exception_debug(&_33$$31, "phalcon/di/service/builder.zep", 275);
					ZEPHIR_MM_RESTORE();
					return;
				}
			...
			while (1) {
				...
				zephir_check_call_status();
					if (Z_TYPE_P(&property) != IS_ARRAY) {
						...
						ZEPHIR_CALL_METHOD(NULL, &_37$$33, "__construct", &_7, 4, &_38$$33);
						zephir_check_call_status();
						zephir_throw_exception_debug(&_37$$33, "phalcon/di/service/builder.zep", 261);
						ZEPHIR_MM_RESTORE();
						return;
					}
					ZEPHIR_OBS_NVAR(&propertyName);
					if (!(zephir_array_isset_string_fetch(&propertyName, &property, SL("name"), 0))) {
						...
						ZEPHIR_CALL_METHOD(NULL, &_39$$34, "__construct", &_7, 4, &_40$$34);
						zephir_check_call_status();
						zephir_throw_exception_debug(&_39$$34, "phalcon/di/service/builder.zep", 268);
						ZEPHIR_MM_RESTORE();
						return;
					}
					ZEPHIR_OBS_NVAR(&propertyValue);
					if (!(zephir_array_isset_string_fetch(&propertyValue, &property, SL("value"), 0))) {
						...
						ZEPHIR_CALL_METHOD(NULL, &_41$$35, "__construct", &_7, 4, &_42$$35);
						zephir_check_call_status();
						zephir_throw_exception_debug(&_41$$35, "phalcon/di/service/builder.zep", 275);
						ZEPHIR_MM_RESTORE();
						return;
					}
