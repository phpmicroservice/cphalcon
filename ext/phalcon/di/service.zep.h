...
#if PHP_VERSION_ID >= 70200
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_phalcon_di_service_getname, 0, 0, IS_STRING, 0)
#else
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_phalcon_di_service_getname, 0, 0, IS_STRING, NULL, 0)
#endif
ZEND_END_ARG_INFO()
...
ZEPHIR_INIT_FUNCS(phalcon_di_service_method_entry) {
	...
	PHP_ME(Phalcon_Di_Service, getName, arginfo_phalcon_di_service_getname, ZEND_ACC_PUBLIC)
