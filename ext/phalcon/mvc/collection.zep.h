...
#if PHP_VERSION_ID >= 70200
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_phalcon_mvc_collection_validationhasfailed, 0, 0, _IS_BOOL, 0)
#else
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_phalcon_mvc_collection_validationhasfailed, 0, 0, _IS_BOOL, NULL, 0)
#endif
ZEND_END_ARG_INFO()
...
#if PHP_VERSION_ID >= 70200
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_phalcon_mvc_collection_addbehavior, 0, 1, IS_VOID, 0)
#else
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_phalcon_mvc_collection_addbehavior, 0, 1, IS_VOID, NULL, 0)
#endif
#else
ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_mvc_collection_addbehavior, 0, 0, 1)
#define arginfo_phalcon_mvc_collection_addbehavior NULL
#endif
...
ZEPHIR_INIT_FUNCS(phalcon_mvc_collection_method_entry) {
	...
	PHP_ME(Phalcon_Mvc_Collection, validationHasFailed, arginfo_phalcon_mvc_collection_validationhasfailed, ZEND_ACC_PUBLIC)
