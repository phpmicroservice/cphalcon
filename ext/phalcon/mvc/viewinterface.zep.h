...
#if PHP_VERSION_ID >= 70200
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_phalcon_mvc_viewinterface_getparams, 0, 0, IS_ARRAY, 0)
#else
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_phalcon_mvc_viewinterface_getparams, 0, 0, IS_ARRAY, NULL, 0)
#endif
ZEND_END_ARG_INFO()
...
ZEPHIR_INIT_FUNCS(phalcon_mvc_viewinterface_method_entry) {
	...
	PHP_ABSTRACT_ME(Phalcon_Mvc_ViewInterface, getParams, arginfo_phalcon_mvc_viewinterface_getparams)
