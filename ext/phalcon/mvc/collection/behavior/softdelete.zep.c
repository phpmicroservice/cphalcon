...
PHP_METHOD(Phalcon_Mvc_Collection_Behavior_SoftDelete, notify) {
	...
	zval *type_param = NULL, *model, model_sub, options, value, field, updateModel, message, _0$$3, _1$$3, _2$$6, _3$$7, *_4$$7, _5$$7;
	zval type;
	...
	if (ZEPHIR_IS_STRING(&type, "beforeDelete")) {
		...
		if (!ZEPHIR_IS_EQUAL(&_1$$3, &value)) {
			...
			if (!(zephir_is_true(&_2$$6))) {
				...
				zephir_check_call_status();
				zephir_is_iterable(&_3$$7, 0, "phalcon/mvc/collection/behavior/softdelete.zep", 89);
