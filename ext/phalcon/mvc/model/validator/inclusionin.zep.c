...
PHP_METHOD(Phalcon_Mvc_Model_Validator_Inclusionin, validate) {
	...
	zval *record, record_sub, field, domain, value, message, strict, _0, _1, _2, _4, _6, _5$$7, _7$$9, _9$$9;
	...
	if (zephir_is_true(&_4)) {
		...
		ZVAL_STRING(&_5$$7, "strict");
		ZEPHIR_CALL_METHOD(&strict, this_ptr, "getoption", NULL, 0, &_5$$7);
		zephir_check_call_status();
	}
	ZEPHIR_CALL_FUNCTION(&_6, "in_array", NULL, 362, &value, &domain, &strict);
	zephir_check_call_status();
