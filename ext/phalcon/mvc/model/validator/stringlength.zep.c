...
PHP_METHOD(Phalcon_Mvc_Model_Validator_StringLength, validate) {
	...
	zval *record, record_sub, field, isSetMin, isSetMax, value, length, maximum, minimum, message, _0, _2, _4$$8, _5$$9, _7$$9, _8$$11, _9$$12, _11$$12;
