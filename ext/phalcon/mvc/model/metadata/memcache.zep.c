...
ZEPHIR_INIT_CLASS(Phalcon_Mvc_Model_MetaData_Memcache) {
	...
	zend_declare_property_long(phalcon_mvc_model_metadata_memcache_ce, SL("_ttl"), 172800, ZEND_ACC_PROTECTED);

	zend_declare_property_null(phalcon_mvc_model_metadata_memcache_ce, SL("_memcache"), ZEND_ACC_PROTECTED);

	zend_declare_property_null(phalcon_mvc_model_metadata_memcache_ce, SL("_metaData"), ZEND_ACC_PROTECTED);
...
PHP_METHOD(Phalcon_Mvc_Model_MetaData_Memcache, __construct) {
	...
	ZEPHIR_CALL_METHOD(NULL, &_4, "__construct", NULL, 321, &_5, options);
	zephir_check_call_status();
	zephir_update_property_zval(this_ptr, SL("_memcache"), &_4);
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Phalcon_Mvc_Model_MetaData_Memcache, reset) {
	...
	if (Z_TYPE_P(&meta) == IS_ARRAY) {
		...
		zephir_is_iterable(&meta, 0, "phalcon/mvc/model/metadata/memcache.zep", 131);
		if (Z_TYPE_P(&meta) == IS_ARRAY) {
	...
	ZEPHIR_CALL_PARENT(NULL, phalcon_mvc_model_metadata_memcache_ce, getThis(), "reset", &_7, 0);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
