...
ZEPHIR_INIT_CLASS(Phalcon_Mvc_Model_MetaData_Libmemcached) {
	...
	zend_declare_property_long(phalcon_mvc_model_metadata_libmemcached_ce, SL("_ttl"), 172800, ZEND_ACC_PROTECTED);

	zend_declare_property_null(phalcon_mvc_model_metadata_libmemcached_ce, SL("_memcache"), ZEND_ACC_PROTECTED);

	zend_declare_property_null(phalcon_mvc_model_metadata_libmemcached_ce, SL("_metaData"), ZEND_ACC_PROTECTED);
...
PHP_METHOD(Phalcon_Mvc_Model_MetaData_Libmemcached, __construct) {
	...
	ZEPHIR_CALL_METHOD(NULL, &_2, "__construct", NULL, 319, &_3);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, &_1, "__construct", NULL, 320, &_2, options);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_MetaData_Libmemcached, reset) {
	...
	if (Z_TYPE_P(&meta) == IS_ARRAY) {
		...
		zephir_is_iterable(&meta, 0, "phalcon/mvc/model/metadata/libmemcached.zep", 132);
		if (Z_TYPE_P(&meta) == IS_ARRAY) {
