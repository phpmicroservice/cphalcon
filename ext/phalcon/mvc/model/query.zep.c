...
ZEPHIR_INIT_CLASS(Phalcon_Mvc_Model_Query) {
	...
	zend_declare_property_null(phalcon_mvc_model_query_ce, SL("_dependencyInjector"), ZEND_ACC_PROTECTED);
	...
	zend_declare_property_null(phalcon_mvc_model_query_ce, SL("_enableImplicitJoins"), ZEND_ACC_PROTECTED);

	zend_declare_property_null(phalcon_mvc_model_query_ce, SL("_sharedLock"), ZEND_ACC_PROTECTED);
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getQualified) {
	...
	zend_bool _0, _1;
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zephir_fcall_cache_entry *_16 = NULL, *_21 = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS, number = 0;
	zval *expr_param = NULL, columnName, sqlColumnAliases, metaData, sqlAliases, source, sqlAliasesModelsInstances, realColumnName, columnDomain, model, models, columnMap, hasModel, className, _2, _3$$5, _4$$5, _5$$5, _6$$7, _7$$7, _8$$7, _9$$10, _10$$10, _11$$10, _12$$12, *_13$$12, _14$$12, _15$$13, _17$$15, _18$$15, _19$$15, _20$$16, _22$$18, _23$$18, _24$$18, _25$$19, _26$$19, _27$$19, _28$$21, _29$$21, _30$$21, _31$$25, _32$$25, _33$$25;
	zval expr;
	zval *this_ptr = getThis();
	...
	zephir_array_fetch_string(&columnName, &expr, SL("name"), PH_NOISY, "phalcon/mvc/model/query.zep", 241);
	...
	if (_0) {
		...
		if (!(_1)) {
			zephir_array_fetch_string(&_2, &expr, SL("domain"), PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 247);
	...
	if (zephir_array_isset_string_fetch(&columnDomain, &expr, SL("domain"), 0)) {
		...
		if (!(zephir_array_isset_fetch(&source, &sqlAliases, &columnDomain, 0))) {
			...
			zephir_check_call_status();
			zephir_throw_exception_debug(&_3$$5, "phalcon/mvc/model/query.zep", 267);
			ZEPHIR_MM_RESTORE();
			return;
		}
		if (ZEPHIR_GLOBAL(orm).column_renaming) {
			...
			if (!(zephir_array_isset_fetch(&model, &sqlAliasesModelsInstances, &columnDomain, 0))) {
				...
				zephir_check_call_status();
				zephir_throw_exception_debug(&_6$$7, "phalcon/mvc/model/query.zep", 286);
				ZEPHIR_MM_RESTORE();
				return;
			}
		...
		if (Z_TYPE_P(&columnMap) == IS_ARRAY) {
			...
			if (!(zephir_array_isset_fetch(&realColumnName, &columnMap, &columnName, 0))) {
				...
				zephir_check_call_status();
				zephir_throw_exception_debug(&_9$$10, "phalcon/mvc/model/query.zep", 298);
				ZEPHIR_MM_RESTORE();
				return;
			}
		} else {
		...
		if (Z_TYPE_P(&_12$$12) == IS_ARRAY) {
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_12$$12), _13$$12)
			{
				ZEPHIR_INIT_NVAR(&model);
				ZVAL_COPY(&model, _13$$12);
				ZEPHIR_CALL_METHOD(&_15$$13, &metaData, "hasattribute", &_16, 0, &model, &columnName);
				zephir_check_call_status();
				if (zephir_is_true(&_15$$13)) {
					number++;
					if (number > 1) {
						ZEPHIR_INIT_NVAR(&_17$$15);
						object_init_ex(&_17$$15, phalcon_mvc_model_exception_ce);
						zephir_read_property(&_18$$15, this_ptr, SL("_phql"), PH_NOISY_CC | PH_READONLY);
						ZEPHIR_INIT_NVAR(&_19$$15);
						ZEPHIR_CONCAT_SVSV(&_19$$15, "The column '", &columnName, "' is ambiguous, when preparing: ", &_18$$15);
						ZEPHIR_CALL_METHOD(NULL, &_17$$15, "__construct", NULL, 4, &_19$$15);
						zephir_check_call_status();
						zephir_throw_exception_debug(&_17$$15, "phalcon/mvc/model/query.zep", 319);
						ZEPHIR_MM_RESTORE();
						return;
					}
			...
			ZEPHIR_CALL_METHOD(NULL, &_12$$12, "rewind", NULL, 0);
			zephir_check_call_status();
			while (1) {
				ZEPHIR_CALL_METHOD(&_14$$12, &_12$$12, "valid", NULL, 0);
				zephir_check_call_status();
				if (!zend_is_true(&_14$$12)) {
					break;
				}
				ZEPHIR_CALL_METHOD(&model, &_12$$12, "current", NULL, 0);
				zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_20$$16, &metaData, "hasattribute", &_21, 0, &model, &columnName);
					zephir_check_call_status();
					if (zephir_is_true(&_20$$16)) {
						number++;
						if (number > 1) {
							...
							ZEPHIR_CONCAT_SVSV(&_24$$18, "The column '", &columnName, "' is ambiguous, when preparing: ", &_23$$18);
							ZEPHIR_CALL_METHOD(NULL, &_22$$18, "__construct", NULL, 4, &_24$$18);
							zephir_check_call_status();
							zephir_throw_exception_debug(&_22$$18, "phalcon/mvc/model/query.zep", 319);
							ZEPHIR_MM_RESTORE();
							return;
						}
						ZEPHIR_CPY_WRT(&hasModel, &model);
					}
				ZEPHIR_CALL_METHOD(NULL, &_12$$12, "next", NULL, 0);
				zephir_check_call_status();
			}
		}
		ZEPHIR_INIT_NVAR(&model);
		if (ZEPHIR_IS_FALSE_IDENTICAL(&hasModel)) {
			...
			object_init_ex(&_25$$19, phalcon_mvc_model_exception_ce);
			zephir_read_property(&_26$$19, this_ptr, SL("_phql"), PH_NOISY_CC | PH_READONLY);
			ZEPHIR_INIT_VAR(&_27$$19);
			ZEPHIR_CONCAT_SVSV(&_27$$19, "Column '", &columnName, "' doesn't belong to any of the selected models (1), when preparing: ", &_26$$19);
			ZEPHIR_CALL_METHOD(NULL, &_25$$19, "__construct", NULL, 4, &_27$$19);
			zephir_check_call_status();
			zephir_throw_exception_debug(&_25$$19, "phalcon/mvc/model/query.zep", 331);
			ZEPHIR_MM_RESTORE();
			return;
		}
		...
		if (!(zephir_array_isset_fetch(&source, &models, &className, 0))) {
			ZEPHIR_INIT_VAR(&_28$$21);
			object_init_ex(&_28$$21, phalcon_mvc_model_exception_ce);
			zephir_read_property(&_29$$21, this_ptr, SL("_phql"), PH_NOISY_CC | PH_READONLY);
			ZEPHIR_INIT_VAR(&_30$$21);
			ZEPHIR_CONCAT_SVSV(&_30$$21, "Can't obtain model's source from models list: '", &className, "', when preparing: ", &_29$$21);
			ZEPHIR_CALL_METHOD(NULL, &_28$$21, "__construct", NULL, 4, &_30$$21);
			zephir_check_call_status();
			zephir_throw_exception_debug(&_28$$21, "phalcon/mvc/model/query.zep", 349);
			ZEPHIR_MM_RESTORE();
			return;
		}
		if (ZEPHIR_GLOBAL(orm).column_renaming) {
		...
		if (Z_TYPE_P(&columnMap) == IS_ARRAY) {
			...
			if (!(zephir_array_isset_fetch(&realColumnName, &columnMap, &columnName, 0))) {
				...
				object_init_ex(&_31$$25, phalcon_mvc_model_exception_ce);
				zephir_read_property(&_32$$25, this_ptr, SL("_phql"), PH_NOISY_CC | PH_READONLY);
				ZEPHIR_INIT_VAR(&_33$$25);
				ZEPHIR_CONCAT_SVSV(&_33$$25, "Column '", &columnName, "' doesn't belong to any of the selected models (3), when preparing: ", &_32$$25);
				ZEPHIR_CALL_METHOD(NULL, &_31$$25, "__construct", NULL, 4, &_33$$25);
				zephir_check_call_status();
				zephir_throw_exception_debug(&_31$$25, "phalcon/mvc/model/query.zep", 368);
				ZEPHIR_MM_RESTORE();
				return;
			}
		} else {
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getCallArgument) {
	...
	zephir_array_fetch_string(&_0, &argument, SL("type"), PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 391);
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getCaseExpression) {
	...
	zephir_array_fetch_string(&_0, &expr, SL("right"), PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 405);
	...
	if (Z_TYPE_P(&_0) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_0), _1)
		{
			...
			if (zephir_array_isset_string(&whenExpr, SL("right"))) {
				...
				zephir_array_fetch_string(&_5$$4, &whenExpr, SL("left"), PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 409);
				ZEPHIR_CALL_METHOD(&_4$$4, this_ptr, "_getexpression", &_6, 323, &_5$$4);
				zephir_check_call_status();
				zephir_array_update_string(&_3$$4, SL("expr"), &_4$$4, PH_COPY | PH_SEPARATE);
				zephir_array_fetch_string(&_7$$4, &whenExpr, SL("right"), PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 410);
				ZEPHIR_CALL_METHOD(&_4$$4, this_ptr, "_getexpression", &_6, 323, &_7$$4);
				zephir_check_call_status();
				zephir_array_update_string(&_3$$4, SL("then"), &_4$$4, PH_COPY | PH_SEPARATE);
				zephir_array_append(&whenClauses, &_3$$4, PH_SEPARATE, "phalcon/mvc/model/query.zep", 411);
			} else {
				ZEPHIR_INIT_NVAR(&_8$$5);
				zephir_create_array(&_8$$5, 2, 0);
				add_assoc_stringl_ex(&_8$$5, SL("type"), SL("else"));
				zephir_array_fetch_string(&_10$$5, &whenExpr, SL("left"), PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 415);
				ZEPHIR_CALL_METHOD(&_9$$5, this_ptr, "_getexpression", &_6, 323, &_10$$5);
				zephir_check_call_status();
				zephir_array_update_string(&_8$$5, SL("expr"), &_9$$5, PH_COPY | PH_SEPARATE);
				zephir_array_append(&whenClauses, &_8$$5, PH_SEPARATE, "phalcon/mvc/model/query.zep", 416);
			}
		} ZEND_HASH_FOREACH_END();
	} else {
		...
		while (1) {
			...
			zephir_check_call_status();
				if (zephir_array_isset_string(&whenExpr, SL("right"))) {
					...
					zephir_array_fetch_string(&_13$$7, &whenExpr, SL("left"), PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 409);
					ZEPHIR_CALL_METHOD(&_12$$7, this_ptr, "_getexpression", &_6, 323, &_13$$7);
					zephir_check_call_status();
					zephir_array_update_string(&_11$$7, SL("expr"), &_12$$7, PH_COPY | PH_SEPARATE);
					zephir_array_fetch_string(&_14$$7, &whenExpr, SL("right"), PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 410);
					ZEPHIR_CALL_METHOD(&_12$$7, this_ptr, "_getexpression", &_6, 323, &_14$$7);
					zephir_check_call_status();
					zephir_array_update_string(&_11$$7, SL("then"), &_12$$7, PH_COPY | PH_SEPARATE);
					zephir_array_append(&whenClauses, &_11$$7, PH_SEPARATE, "phalcon/mvc/model/query.zep", 411);
				} else {
					ZEPHIR_INIT_NVAR(&_15$$8);
					zephir_create_array(&_15$$8, 2, 0);
					add_assoc_stringl_ex(&_15$$8, SL("type"), SL("else"));
					zephir_array_fetch_string(&_17$$8, &whenExpr, SL("left"), PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 415);
					ZEPHIR_CALL_METHOD(&_16$$8, this_ptr, "_getexpression", &_6, 323, &_17$$8);
					zephir_check_call_status();
					zephir_array_update_string(&_15$$8, SL("expr"), &_16$$8, PH_COPY | PH_SEPARATE);
					zephir_array_append(&whenClauses, &_15$$8, PH_SEPARATE, "phalcon/mvc/model/query.zep", 416);
				}
	...
	zephir_array_fetch_string(&_19, &expr, SL("left"), PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 422);
	ZEPHIR_CALL_METHOD(&_18, this_ptr, "_getexpression", &_6, 323, &_19);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getFunctionCall) {
	...
	if (zephir_array_isset_string_fetch(&arguments, &expr, SL("arguments"), 0)) {
		...
		if (zephir_array_isset_long(&arguments, 0)) {
			...
			if (Z_TYPE_P(&arguments) == IS_ARRAY) {
				ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&arguments), _0$$6)
				{
					...
					ZEPHIR_CALL_METHOD(&_2$$7, this_ptr, "_getcallargument", &_3, 324, &argument);
					zephir_check_call_status();
					zephir_array_append(&functionArgs, &_2$$7, PH_SEPARATE, "phalcon/mvc/model/query.zep", 446);
				} ZEND_HASH_FOREACH_END();
			} else {
				...
				while (1) {
					...
					zephir_check_call_status();
						ZEPHIR_CALL_METHOD(&_4$$8, this_ptr, "_getcallargument", &_3, 324, &argument);
						zephir_check_call_status();
						zephir_array_append(&functionArgs, &_4$$8, PH_SEPARATE, "phalcon/mvc/model/query.zep", 446);
			...
			ZEPHIR_CALL_METHOD(&_6$$9, this_ptr, "_getcallargument", &_3, 324, &arguments);
			zephir_check_call_status();
		...
		if (distinct) {
			...
			zephir_array_fetch_string(&_7$$10, &expr, SL("name"), PH_NOISY, "phalcon/mvc/model/query.zep", 456);
			...
			zephir_array_fetch_string(&_9$$11, &expr, SL("name"), PH_NOISY, "phalcon/mvc/model/query.zep", 463);
	...
	add_assoc_stringl_ex(return_value, SL("type"), SL("functionCall"));
	ZEPHIR_OBS_VAR(&_10);
	zephir_array_fetch_string(&_10, &expr, SL("name"), PH_NOISY, "phalcon/mvc/model/query.zep", 472);
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getExpression) {
	...
	if (zephir_array_isset_string_fetch(&exprType, expr, SL("type"), 0)) {
		...
		if (!ZEPHIR_IS_LONG(&exprType, 409)) {
			...
			if (zephir_array_isset_string_fetch(&exprLeft, expr, SL("left"), 0)) {
				...
				ZEPHIR_CALL_METHOD(&left, this_ptr, "_getexpression", NULL, 323, &exprLeft, &_0$$5);
				zephir_check_call_status();
			}
			...
			if (zephir_array_isset_string_fetch(&exprRight, expr, SL("right"), 0)) {
				...
				ZEPHIR_CALL_METHOD(&right, this_ptr, "_getexpression", NULL, 323, &exprRight, &_1$$6);
				zephir_check_call_status();
			}
		}
		do {
			...
			if (ZEPHIR_IS_LONG(&exprType, 355)) {
				ZEPHIR_CALL_METHOD(&exprReturn, this_ptr, "_getqualified", NULL, 325, expr);
				zephir_check_call_status();
				break;
			}
			if (ZEPHIR_IS_LONG(&exprType, '+')) {
			...
			if (ZEPHIR_IS_LONG(&exprType, 258) || ZEPHIR_IS_LONG(&exprType, 259) || ZEPHIR_IS_LONG(&exprType, 414)) {
				...
				zephir_array_fetch_string(&_19$$25, expr, SL("value"), PH_NOISY, "phalcon/mvc/model/query.zep", 590);
			...
			if (ZEPHIR_IS_LONG(&exprType, 260)) {
				...
				zephir_array_fetch_string(&value, expr, SL("value"), PH_NOISY, "phalcon/mvc/model/query.zep", 602);
				if (quoting == 1) {
			...
			if (ZEPHIR_IS_LONG(&exprType, 273)) {
				...
				zephir_array_fetch_string(&_25$$33, expr, SL("value"), PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 620);
			...
			if (ZEPHIR_IS_LONG(&exprType, 274)) {
				...
				zephir_array_fetch_string(&_29$$34, expr, SL("value"), PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 624);
			...
			if (ZEPHIR_IS_LONG(&exprType, 277)) {
				...
				zephir_array_fetch_string(&value, expr, SL("value"), PH_NOISY, "phalcon/mvc/model/query.zep", 628);
				if (zephir_memnstr_str(&value, SL(":"), "phalcon/mvc/model/query.zep", 629)) {
					...
					ZEPHIR_OBS_VAR(&name);
					zephir_array_fetch_long(&name, &valueParts, 0, PH_NOISY, "phalcon/mvc/model/query.zep", 632);
					ZEPHIR_OBS_VAR(&bindType);
					zephir_array_fetch_long(&bindType, &valueParts, 1, PH_NOISY, "phalcon/mvc/model/query.zep", 633);
					do {
						...
						if (ZEPHIR_IS_STRING(&bindType, "array") || ZEPHIR_IS_STRING(&bindType, "array-str") || ZEPHIR_IS_STRING(&bindType, "array-int")) {
							...
							if (!(zephir_array_isset_fetch(&bind, &_49$$43, &name, 0))) {
								...
								zephir_check_call_status();
								zephir_throw_exception_debug(&_50$$44, "phalcon/mvc/model/query.zep", 672);
								ZEPHIR_MM_RESTORE();
								return;
							}
							if (Z_TYPE_P(&bind) != IS_ARRAY) {
								...
								zephir_check_call_status();
								zephir_throw_exception_debug(&_52$$45, "phalcon/mvc/model/query.zep", 676);
								ZEPHIR_MM_RESTORE();
								return;
							}
							if (zephir_fast_count_int(&bind) < 1) {
								...
								zephir_check_call_status();
								zephir_throw_exception_debug(&_54$$46, "phalcon/mvc/model/query.zep", 680);
								ZEPHIR_MM_RESTORE();
								return;
							}
						...
						zephir_check_call_status();
						zephir_throw_exception_debug(&_58$$47, "phalcon/mvc/model/query.zep", 692);
						ZEPHIR_MM_RESTORE();
						return;
					} while(0);
			...
			if (ZEPHIR_IS_LONG(&exprType, 358)) {
				...
				zephir_create_array(&_78$$65, 2, 0);
				add_assoc_stringl_ex(&_78$$65, SL("type"), SL("literal"));
				ZEPHIR_OBS_VAR(&_79$$65);
				zephir_array_fetch_string(&_79$$65, expr, SL("name"), PH_NOISY, "phalcon/mvc/model/query.zep", 765);
			...
			if (ZEPHIR_IS_LONG(&exprType, 309)) {
				...
				zephir_create_array(&_80$$68, 2, 0);
				add_assoc_stringl_ex(&_80$$68, SL("type"), SL("select"));
				ZVAL_BOOL(&_82$$68, 1);
				ZEPHIR_CALL_METHOD(&_81$$68, this_ptr, "_prepareselect", NULL, 328, expr, &_82$$68);
				zephir_check_call_status();
			...
			zephir_check_call_status();
			zephir_throw_exception_debug(&_83$$69, "phalcon/mvc/model/query.zep", 781);
			ZEPHIR_MM_RESTORE();
			return;
		} while(0);
	...
	if (zephir_array_isset_string(expr, SL("domain"))) {
		ZEPHIR_RETURN_CALL_METHOD(this_ptr, "_getqualified", NULL, 325, expr);
		zephir_check_call_status();
		RETURN_MM();
	}
	if (zephir_array_isset_long(expr, 0)) {
		...
		if (Z_TYPE_P(expr) == IS_ARRAY) {
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(expr), _85$$71)
			{
				...
				ZEPHIR_CALL_METHOD(&_87$$72, this_ptr, "_getexpression", NULL, 323, &exprListItem);
				zephir_check_call_status();
				zephir_array_append(&listItems, &_87$$72, PH_SEPARATE, "phalcon/mvc/model/query.zep", 800);
			} ZEND_HASH_FOREACH_END();
		} else {
			...
			while (1) {
				...
				zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_88$$73, this_ptr, "_getexpression", NULL, 323, &exprListItem);
					zephir_check_call_status();
					zephir_array_append(&listItems, &_88$$73, PH_SEPARATE, "phalcon/mvc/model/query.zep", 800);
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getSelectColumn) {
	...
	if (ZEPHIR_IS_LONG(&columnType, 352)) {
		...
		if (Z_TYPE_P(&_0$$4) == IS_ARRAY) {
			ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&_0$$4), _3$$4, _4$$4, _1$$4)
			{
				...
				ZEPHIR_CALL_FUNCTION(&_5$$5, "lcfirst", &_6, 64, &modelName);
				zephir_check_call_status();
				...
				if (Z_TYPE_P(&eager) != IS_NULL) {
					...
					zephir_array_fetch_string(&_7$$6, &column, SL("eagerType"), PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 844);
			...
			while (1) {
				...
				zephir_check_call_status();
					...
					ZEPHIR_CALL_FUNCTION(&_9$$7, "lcfirst", &_6, 64, &modelName);
					zephir_check_call_status();
					zephir_array_update_string(&_8$$7, SL("balias"), &_9$$7, PH_COPY | PH_SEPARATE);
					ZEPHIR_CPY_WRT(&sqlColumn, &_8$$7);
					if (Z_TYPE_P(&eager) != IS_NULL) {
						zephir_array_update_string(&sqlColumn, SL("eager"), &eager, PH_COPY | PH_SEPARATE);
						zephir_array_fetch_string(&_10$$8, &column, SL("eagerType"), PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 844);
	...
	if (ZEPHIR_IS_LONG(&columnType, 353)) {
		...
		zephir_read_property(&sqlAliases, this_ptr, SL("_sqlAliases"), PH_NOISY_CC);
		ZEPHIR_OBS_VAR(&columnDomain);
		zephir_array_fetch_string(&columnDomain, &column, SL("column"), PH_NOISY, "phalcon/mvc/model/query.zep", 866);
		ZEPHIR_OBS_NVAR(&source);
		if (!(zephir_array_isset_fetch(&source, &sqlAliases, &columnDomain, 0))) {
			...
			zephir_check_call_status();
			zephir_throw_exception_debug(&_11$$11, "phalcon/mvc/model/query.zep", 869);
			ZEPHIR_MM_RESTORE();
			return;
		}
		...
		zephir_array_fetch(&modelName, &sqlAliasesModels, &columnDomain, PH_NOISY, "phalcon/mvc/model/query.zep", 883);
		if (Z_TYPE_P(&preparedAlias) != IS_STRING) {
			if (ZEPHIR_IS_EQUAL(&columnDomain, &modelName)) {
				ZEPHIR_CALL_FUNCTION(&preparedAlias, "lcfirst", &_6, 64, &modelName);
				zephir_check_call_status();
			} else {
		...
		zephir_create_array(&_14$$10, 4, 0);
		...
		if (Z_TYPE_P(&eager) != IS_NULL) {
			zephir_array_update_string(&sqlColumn, SL("eager"), &eager, PH_COPY | PH_SEPARATE);
			zephir_array_fetch_string(&_15$$15, &column, SL("eagerType"), PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 909);
	...
	if (ZEPHIR_IS_LONG(&columnType, 354)) {
		...
		zephir_create_array(&_16$$16, 1, 0);
		add_assoc_stringl_ex(&_16$$16, SL("type"), SL("scalar"));
		ZEPHIR_CPY_WRT(&sqlColumn, &_16$$16);
		ZEPHIR_OBS_VAR(&columnData);
		zephir_array_fetch_string(&columnData, &column, SL("column"), PH_NOISY, "phalcon/mvc/model/query.zep", 926);
		...
		if (Z_TYPE_P(&eager) != IS_NULL) {
			zephir_array_update_string(&sqlColumn, SL("eager"), &eager, PH_COPY | PH_SEPARATE);
			zephir_array_fetch_string(&_17$$18, &column, SL("eagerType"), PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 939);
	...
	zephir_check_call_status();
	zephir_throw_exception_debug(&_18, "phalcon/mvc/model/query.zep", 948);
	ZEPHIR_MM_RESTORE();
	return;
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getJoin) {
	...
	if (zephir_array_isset_string_fetch(&qualified, join, SL("qualified"), 0)) {
		zephir_array_fetch_string(&_0$$3, &qualified, SL("type"), PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 987);
		if (ZEPHIR_IS_LONG(&_0$$3, 355)) {
			ZEPHIR_OBS_VAR(&modelName);
			zephir_array_fetch_string(&modelName, &qualified, SL("name"), PH_NOISY, "phalcon/mvc/model/query.zep", 989);
			if (zephir_memnstr_str(&modelName, SL(":"), "phalcon/mvc/model/query.zep", 991)) {
				ZEPHIR_INIT_VAR(&nsAlias);
				zephir_fast_explode_str(&nsAlias, SL(":"), &modelName, LONG_MAX);
				zephir_array_fetch_long(&_2$$5, &nsAlias, 0, PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 993);
				ZEPHIR_CALL_METHOD(&_1$$5, manager, "getnamespacealias", NULL, 0, &_2$$5);
				zephir_check_call_status();
				zephir_array_fetch_long(&_3$$5, &nsAlias, 1, PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 993);
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getJoinType) {
	...
	zephir_check_call_status();
	zephir_throw_exception_debug(&_0, "phalcon/mvc/model/query.zep", 1046);
	ZEPHIR_MM_RESTORE();
	return;
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getSingleJoin) {
	...
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *joinType_param = NULL, *joinSource, joinSource_sub, *modelAlias, modelAlias_sub, *joinAlias, joinAlias_sub, *relation, relation_sub, fields, referencedFields, sqlJoinConditions, sqlJoinPartialConditions, position, field, referencedField, _0$$3, _2$$3, *_5$$4, _6$$4, _9$$6, _10$$6, _11$$6, _14$$5, _17$$8, _18$$8, _19$$8, _21$$7;
	zval joinType;
	zval *this_ptr = getThis();
	...
	if (Z_TYPE_P(&fields) != IS_ARRAY) {
		...
		ZEPHIR_CALL_METHOD(&_2$$3, this_ptr, "_getqualified", NULL, 325, &_3$$3);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_METHOD(&_2$$3, this_ptr, "_getqualified", NULL, 325, &_4$$3);
		zephir_check_call_status();
		...
		if (Z_TYPE_P(&fields) == IS_ARRAY) {
			ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&fields), _7$$4, _8$$4, _5$$4)
			{
				...
				if (!(zephir_array_isset_fetch(&referencedField, &referencedFields, &position, 0))) {
					...
					zephir_check_call_status();
					zephir_throw_exception_debug(&_9$$6, "phalcon/mvc/model/query.zep", 1112);
					ZEPHIR_MM_RESTORE();
					return;
				}
				...
				ZEPHIR_CALL_METHOD(&_14$$5, this_ptr, "_getqualified", NULL, 325, &_15$$5);
				zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&_14$$5, this_ptr, "_getqualified", NULL, 325, &_16$$5);
				zephir_check_call_status();
				zephir_array_update_string(&_13$$5, SL("right"), &_14$$5, PH_COPY | PH_SEPARATE);
				zephir_array_append(&sqlJoinPartialConditions, &_13$$5, PH_SEPARATE, "phalcon/mvc/model/query.zep", 1133);
			} ZEND_HASH_FOREACH_END();
		} else {
			...
			while (1) {
				...
				zephir_check_call_status();
					...
					if (!(zephir_array_isset_fetch(&referencedField, &referencedFields, &position, 0))) {
						...
						zephir_check_call_status();
						zephir_throw_exception_debug(&_17$$8, "phalcon/mvc/model/query.zep", 1112);
						ZEPHIR_MM_RESTORE();
						return;
					}
					...
					ZEPHIR_CALL_METHOD(&_21$$7, this_ptr, "_getqualified", NULL, 325, &_22$$7);
					zephir_check_call_status();
					...
					ZEPHIR_CALL_METHOD(&_21$$7, this_ptr, "_getqualified", NULL, 325, &_23$$7);
					zephir_check_call_status();
					zephir_array_update_string(&_20$$7, SL("right"), &_21$$7, PH_COPY | PH_SEPARATE);
					zephir_array_append(&sqlJoinPartialConditions, &_20$$7, PH_SEPARATE, "phalcon/mvc/model/query.zep", 1133);
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getMultiJoin) {
	...
	if (Z_TYPE_P(&fields) == IS_ARRAY) {
		...
		if (Z_TYPE_P(&fields) == IS_ARRAY) {
			ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&fields), _2$$3, _3$$3, _0$$3)
			{
				...
				if (!(zephir_array_isset(&referencedFields, &position))) {
					...
					zephir_check_call_status();
					zephir_throw_exception_debug(&_4$$5, "phalcon/mvc/model/query.zep", 1234);
					ZEPHIR_MM_RESTORE();
					return;
				}
				ZEPHIR_OBS_NVAR(&intermediateField);
				zephir_array_fetch(&intermediateField, &intermediateFields, &position, PH_NOISY, "phalcon/mvc/model/query.zep", 1240);
				...
				ZEPHIR_CALL_METHOD(&_8$$4, this_ptr, "_getqualified", &_10, 325, &_9$$4);
				zephir_check_call_status();
				zephir_array_update_string(&sqlEqualsJoinCondition, SL("left"), &_8$$4, PH_COPY | PH_SEPARATE);
				ZEPHIR_INIT_NVAR(&_11$$4);
				zephir_create_array(&_11$$4, 3, 0);
				...
				ZEPHIR_CALL_METHOD(&_8$$4, this_ptr, "_getqualified", &_10, 325, &_11$$4);
				zephir_check_call_status();
			...
			while (1) {
				...
				zephir_check_call_status();
					if (!(zephir_array_isset(&referencedFields, &position))) {
						...
						zephir_check_call_status();
						zephir_throw_exception_debug(&_12$$7, "phalcon/mvc/model/query.zep", 1234);
						ZEPHIR_MM_RESTORE();
						return;
					}
					ZEPHIR_OBS_NVAR(&intermediateField);
					...
					ZEPHIR_CALL_METHOD(&_16$$6, this_ptr, "_getqualified", &_10, 325, &_17$$6);
					zephir_check_call_status();
					...
					ZEPHIR_CALL_METHOD(&_16$$6, this_ptr, "_getqualified", &_10, 325, &_18$$6);
					zephir_check_call_status();
		...
		ZEPHIR_CALL_METHOD(&_23$$8, this_ptr, "_getqualified", &_10, 325, &_24$$8);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_METHOD(&_23$$8, this_ptr, "_getqualified", &_10, 325, &_25$$8);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_METHOD(&_23$$8, this_ptr, "_getqualified", &_10, 325, &_26$$8);
		zephir_check_call_status();
		zephir_array_update_string(&_22$$8, SL("left"), &_23$$8, PH_COPY | PH_SEPARATE);
		...
		ZEPHIR_CALL_METHOD(&_23$$8, this_ptr, "_getqualified", &_10, 325, &_27$$8);
		zephir_check_call_status();
		zephir_array_update_string(&_22$$8, SL("right"), &_23$$8, PH_COPY | PH_SEPARATE);
		zephir_array_fast_append(&_21$$8, &_22$$8);
		zephir_array_update_string(&_20$$8, SL("conditions"), &_21$$8, PH_COPY | PH_SEPARATE);
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getJoins) {
	...
	zval _31$$22, _32$$22, _33$$23, _34$$23, _60$$39, _62$$40, _63$$40, _72$$53, _74$$54, _75$$54, _88$$68, _90$$69, _91$$69, _100$$82, _102$$83, _103$$83;
	...
	zephir_array_fetch_string(&tables, select, SL("tables"), PH_NOISY, "phalcon/mvc/model/query.zep", 1354);
	...
	zephir_array_fetch_string(&joins, select, SL("joins"), PH_NOISY, "phalcon/mvc/model/query.zep", 1361);
	...
	if (Z_TYPE_P(&selectJoins) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&selectJoins), _0)
		{
			...
			ZEPHIR_CALL_METHOD(&joinData, this_ptr, "_getjoin", &_2, 329, &manager, &joinItem);
			zephir_check_call_status();
			ZEPHIR_OBS_NVAR(&source);
			zephir_array_fetch_string(&source, &joinData, SL("source"), PH_NOISY, "phalcon/mvc/model/query.zep", 1374);
			ZEPHIR_OBS_NVAR(&schema);
			zephir_array_fetch_string(&schema, &joinData, SL("schema"), PH_NOISY, "phalcon/mvc/model/query.zep", 1375);
			ZEPHIR_OBS_NVAR(&model);
			zephir_array_fetch_string(&model, &joinData, SL("model"), PH_NOISY, "phalcon/mvc/model/query.zep", 1376);
			ZEPHIR_OBS_NVAR(&realModelName);
			zephir_array_fetch_string(&realModelName, &joinData, SL("modelName"), PH_NOISY, "phalcon/mvc/model/query.zep", 1377);
			...
			ZEPHIR_CALL_METHOD(&joinType, this_ptr, "_getjointype", &_3, 330, &joinItem);
			zephir_check_call_status();
			ZEPHIR_OBS_NVAR(&aliasExpr);
			if (zephir_array_isset_string_fetch(&aliasExpr, &joinItem, SL("alias"), 0)) {
				ZEPHIR_OBS_NVAR(&alias);
				zephir_array_fetch_string(&alias, &aliasExpr, SL("name"), PH_NOISY, "phalcon/mvc/model/query.zep", 1390);
				if (zephir_array_isset(&joinModels, &alias)) {
					...
					zephir_check_call_status();
					zephir_throw_exception_debug(&_4$$9, "phalcon/mvc/model/query.zep", 1398);
					ZEPHIR_MM_RESTORE();
					return;
				}
				...
				if (zephir_array_isset(&joinModels, &realModelName)) {
					...
					zephir_check_call_status();
					zephir_throw_exception_debug(&_8$$11, "phalcon/mvc/model/query.zep", 1459);
					ZEPHIR_MM_RESTORE();
					return;
				}
			...
			zephir_check_call_status();
				...
				if (zephir_array_isset_string_fetch(&aliasExpr, &joinItem, SL("alias"), 0)) {
					...
					if (zephir_array_isset(&joinModels, &alias)) {
						...
						zephir_check_call_status();
						zephir_throw_exception_debug(&_12$$14, "phalcon/mvc/model/query.zep", 1398);
						ZEPHIR_MM_RESTORE();
						return;
					}
					zephir_array_append(&completeSource, &alias, PH_SEPARATE, "phalcon/mvc/model/query.zep", 1404);
					...
					if (zephir_array_isset(&joinModels, &realModelName)) {
						...
						zephir_check_call_status();
						zephir_throw_exception_debug(&_15$$16, "phalcon/mvc/model/query.zep", 1459);
						ZEPHIR_MM_RESTORE();
						return;
					}
					zephir_array_update_zval(&joinTypes, &realModelName, &joinType, PH_COPY | PH_SEPARATE);
	...
	if (Z_TYPE_P(&joinPrepared) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&joinPrepared), _20, _21, _18)
		{
			...
			if (zephir_array_isset_string_fetch(&joinExpr, &joinItem, SL("conditions"), 0)) {
				ZEPHIR_CALL_METHOD(&_22$$18, this_ptr, "_getexpression", &_23, 323, &joinExpr);
				zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				ZEPHIR_OBS_NVAR(&joinExpr);
				if (zephir_array_isset_string_fetch(&joinExpr, &joinItem, SL("conditions"), 0)) {
					ZEPHIR_CALL_METHOD(&_24$$20, this_ptr, "_getexpression", &_23, 323, &joinExpr);
					zephir_check_call_status();
	...
	if (!(zephir_is_true(&_25))) {
		...
		if (Z_TYPE_P(&joinPrepared) == IS_ARRAY) {
			ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&joinPrepared), _29$$21, _30$$21, _27$$21)
			{
				...
				zephir_array_fetch(&joinType, &joinTypes, &joinAliasName, PH_NOISY, "phalcon/mvc/model/query.zep", 1536);
				ZEPHIR_OBS_NVAR(&joinSource);
				zephir_array_fetch(&joinSource, &joinSources, &joinAliasName, PH_NOISY, "phalcon/mvc/model/query.zep", 1537);
				ZEPHIR_OBS_NVAR(&preCondition);
				zephir_array_fetch(&preCondition, &joinPreCondition, &joinAliasName, PH_NOISY, "phalcon/mvc/model/query.zep", 1538);
				...
				zephir_array_append(&sqlJoins, &_31$$22, PH_SEPARATE, "phalcon/mvc/model/query.zep", 1543);
			} ZEND_HASH_FOREACH_END();
		} else {
			ZEPHIR_CALL_METHOD(NULL, &joinPrepared, "rewind", NULL, 0);
			zephir_check_call_status();
			while (1) {
				...
				zephir_check_call_status();
					...
					zephir_array_append(&sqlJoins, &_33$$23, PH_SEPARATE, "phalcon/mvc/model/query.zep", 1543);
				ZEPHIR_CALL_METHOD(NULL, &joinPrepared, "next", NULL, 0);
				zephir_check_call_status();
			}
		}
	...
	if (Z_TYPE_P(&selectTables) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&selectTables), _35)
		{
			...
			zephir_array_fetch_string(&_37$$24, &tableItem, SL("qualifiedName"), PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 1553);
			ZEPHIR_OBS_NVAR(&_38$$24);
			zephir_array_fetch_string(&_38$$24, &_37$$24, SL("name"), PH_NOISY, "phalcon/mvc/model/query.zep", 1553);
		...
		while (1) {
			...
			zephir_check_call_status();
				zephir_array_fetch_string(&_39$$25, &tableItem, SL("qualifiedName"), PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 1553);
				ZEPHIR_OBS_NVAR(&_40$$25);
				zephir_array_fetch_string(&_40$$25, &_39$$25, SL("name"), PH_NOISY, "phalcon/mvc/model/query.zep", 1553);
		...
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&fromModels), _44, _45, _42)
		{
			...
			if (Z_TYPE_P(&joinModels) == IS_ARRAY) {
				ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&joinModels), _48$$26, _49$$26, _46$$26)
				{
					...
					ZEPHIR_OBS_NVAR(&joinSource);
					zephir_array_fetch(&joinSource, &joinSources, &joinAlias, PH_NOISY, "phalcon/mvc/model/query.zep", 1566);
					ZEPHIR_OBS_NVAR(&joinType);
					zephir_array_fetch(&joinType, &joinTypes, &joinAlias, PH_NOISY, "phalcon/mvc/model/query.zep", 1571);
					ZEPHIR_OBS_NVAR(&preCondition);
					if (!(zephir_array_isset_fetch(&preCondition, &joinPreCondition, &joinAlias, 0))) {
						ZEPHIR_OBS_NVAR(&modelNameAlias);
						zephir_array_fetch(&modelNameAlias, &sqlAliasesModels, &joinAlias, PH_NOISY, "phalcon/mvc/model/query.zep", 1581);
						...
						if (ZEPHIR_IS_FALSE_IDENTICAL(&relation)) {
							...
							if (Z_TYPE_P(&relations) == IS_ARRAY) {
								if (zephir_fast_count_int(&relations) != 1) {
									...
									zephir_check_call_status();
									zephir_throw_exception_debug(&_52$$31, "phalcon/mvc/model/query.zep", 1601);
									ZEPHIR_MM_RESTORE();
									return;
								}
								ZEPHIR_OBS_NVAR(&relation);
								zephir_array_fetch_long(&relation, &relations, 0, PH_NOISY, "phalcon/mvc/model/query.zep", 1607);
							}
						}
						if (Z_TYPE_P(&relation) == IS_OBJECT) {
							ZEPHIR_OBS_NVAR(&modelAlias);
							zephir_array_fetch(&modelAlias, &sqlModelsAliases, &fromModelName, PH_NOISY, "phalcon/mvc/model/query.zep", 1619);
							ZEPHIR_CALL_METHOD(&_55$$32, &relation, "isthrough", NULL, 0);
							zephir_check_call_status();
							if (!(zephir_is_true(&_55$$32))) {
								ZEPHIR_CALL_METHOD(&sqlJoin, this_ptr, "_getsinglejoin", &_56, 331, &joinType, &joinSource, &modelAlias, &joinAlias, &relation);
								zephir_check_call_status();
							} else {
								ZEPHIR_CALL_METHOD(&sqlJoin, this_ptr, "_getmultijoin", &_57, 332, &joinType, &joinSource, &modelAlias, &joinAlias, &relation);
								zephir_check_call_status();
							}
							...
							zephir_array_append(&sqlJoins, &_60$$39, PH_SEPARATE, "phalcon/mvc/model/query.zep", 1650);
						}
					} else {
						...
						zephir_array_append(&sqlJoins, &_62$$40, PH_SEPARATE, "phalcon/mvc/model/query.zep", 1662);
					}
				} ZEND_HASH_FOREACH_END();
			} else {
					...
					zephir_check_call_status();
						...
						if (!(zephir_array_isset_fetch(&preCondition, &joinPreCondition, &joinAlias, 0))) {
							...
							if (ZEPHIR_IS_FALSE_IDENTICAL(&relation)) {
								...
								if (Z_TYPE_P(&relations) == IS_ARRAY) {
									if (zephir_fast_count_int(&relations) != 1) {
										...
										zephir_check_call_status();
										zephir_throw_exception_debug(&_66$$45, "phalcon/mvc/model/query.zep", 1601);
										ZEPHIR_MM_RESTORE();
										return;
									}
									ZEPHIR_OBS_NVAR(&relation);
							...
							if (Z_TYPE_P(&relation) == IS_OBJECT) {
								...
								zephir_array_append(&sqlJoins, &_72$$53, PH_SEPARATE, "phalcon/mvc/model/query.zep", 1650);
							}
						} else {
							...
							zephir_array_append(&sqlJoins, &_74$$54, PH_SEPARATE, "phalcon/mvc/model/query.zep", 1662);
						}
					...
					ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&joinModels), _78$$55, _79$$55, _76$$55)
					{
						...
						if (!(zephir_array_isset_fetch(&preCondition, &joinPreCondition, &joinAlias, 0))) {
							...
							if (ZEPHIR_IS_FALSE_IDENTICAL(&relation)) {
								...
								if (Z_TYPE_P(&relations) == IS_ARRAY) {
									if (zephir_fast_count_int(&relations) != 1) {
										...
										zephir_check_call_status();
										zephir_throw_exception_debug(&_82$$60, "phalcon/mvc/model/query.zep", 1601);
										ZEPHIR_MM_RESTORE();
										return;
									}
									ZEPHIR_OBS_NVAR(&relation);
							...
							if (Z_TYPE_P(&relation) == IS_OBJECT) {
								...
								zephir_array_append(&sqlJoins, &_88$$68, PH_SEPARATE, "phalcon/mvc/model/query.zep", 1650);
							}
						} else {
							...
							zephir_array_append(&sqlJoins, &_90$$69, PH_SEPARATE, "phalcon/mvc/model/query.zep", 1662);
						}
					} ZEND_HASH_FOREACH_END();
				} else {
					ZEPHIR_CALL_METHOD(NULL, &joinModels, "rewind", NULL, 0);
						...
						zephir_check_call_status();
							...
							if (!(zephir_array_isset_fetch(&preCondition, &joinPreCondition, &joinAlias, 0))) {
								...
								if (ZEPHIR_IS_FALSE_IDENTICAL(&relation)) {
									...
									if (Z_TYPE_P(&relations) == IS_ARRAY) {
										if (zephir_fast_count_int(&relations) != 1) {
											...
											zephir_check_call_status();
											zephir_throw_exception_debug(&_94$$74, "phalcon/mvc/model/query.zep", 1601);
											ZEPHIR_MM_RESTORE();
											return;
										}
										ZEPHIR_OBS_NVAR(&relation);
								...
								if (Z_TYPE_P(&relation) == IS_OBJECT) {
									...
									zephir_array_append(&sqlJoins, &_100$$82, PH_SEPARATE, "phalcon/mvc/model/query.zep", 1650);
								}
							} else {
								...
								zephir_array_append(&sqlJoins, &_102$$83, PH_SEPARATE, "phalcon/mvc/model/query.zep", 1662);
							}
						ZEPHIR_CALL_METHOD(NULL, &joinModels, "next", NULL, 0);
						zephir_check_call_status();
					}
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getOrderClause) {
	...
	if (Z_TYPE_P(&orderColumns) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&orderColumns), _0)
		{
			...
			zephir_array_fetch_string(&_2$$5, &orderItem, SL("column"), PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 1690);
			ZEPHIR_CALL_METHOD(&orderPartExpr, this_ptr, "_getexpression", &_3, 323, &_2$$5);
			zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				zephir_array_fetch_string(&_9$$10, &orderItem, SL("column"), PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 1690);
				ZEPHIR_CALL_METHOD(&orderPartExpr, this_ptr, "_getexpression", &_3, 323, &_9$$10);
				zephir_check_call_status();
	...
	if (zephir_array_isset_long(&group, 0)) {
		...
		if (Z_TYPE_P(&group) == IS_ARRAY) {
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&group), _0$$3)
			{
				...
				ZEPHIR_CALL_METHOD(&_2$$4, this_ptr, "_getexpression", &_3, 323, &groupItem);
				zephir_check_call_status();
				zephir_array_append(&groupParts, &_2$$4, PH_SEPARATE, "phalcon/mvc/model/query.zep", 1724);
			} ZEND_HASH_FOREACH_END();
		} else {
			...
			while (1) {
				...
				zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_4$$5, this_ptr, "_getexpression", &_3, 323, &groupItem);
					zephir_check_call_status();
					zephir_array_append(&groupParts, &_4$$5, PH_SEPARATE, "phalcon/mvc/model/query.zep", 1724);
		...
		ZEPHIR_CALL_METHOD(&_6$$6, this_ptr, "_getexpression", &_3, 323, &group);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getLimitClause) {
	...
	if (zephir_array_isset_string_fetch(&number, &limitClause, SL("number"), 0)) {
		ZEPHIR_CALL_METHOD(&_0$$3, this_ptr, "_getexpression", NULL, 323, &number);
		zephir_check_call_status();
	...
	if (zephir_array_isset_string_fetch(&offset, &limitClause, SL("offset"), 0)) {
		ZEPHIR_CALL_METHOD(&_1$$4, this_ptr, "_getexpression", NULL, 323, &offset);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _prepareSelect) {
	...
	zval _24$$27, _25$$27, _26$$27, _36$$32, _37$$32, _38$$32, _62$$50, _63$$50, _64$$50, _74$$55, _75$$55, _76$$55;
	zval _16$$27, _28$$32, _54$$50, _66$$55, _98$$75, _101$$82, _107$$90, _110$$97;
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zephir_fcall_cache_entry *_4 = NULL, *_7 = NULL, *_11 = NULL, *_17 = NULL, *_19 = NULL, *_29 = NULL, *_31 = NULL, *_41 = NULL, *_44 = NULL, *_55 = NULL, *_57 = NULL, *_67 = NULL, *_69 = NULL, *_93 = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS, position = 0, number = 0;
	zval *ast = NULL, ast_sub, *merge = NULL, merge_sub, __$null, __$true, sqlModels, sqlTables, sqlAliases, sqlColumns, select, tables, columns, sqlAliasesModels, sqlModelsAliases, sqlAliasesModelsInstances, models, modelsInstances, selectedModels, manager, metaData, selectedModel, qualifiedName, modelName, nsAlias, realModelName, model, schema, source, completeSource, alias, joins, sqlJoins, selectColumns, sqlColumnAliases, column, sqlColumn, sqlSelect, distinct, having, where, groupBy, order, limit, tempModels, tempModelsInstances, tempSqlAliases, tempSqlModelsAliases, tempSqlAliasesModelsInstances, tempSqlAliasesModels, with, withs, withItem, automaticJoins, relation, joinAlias, relationModel, bestAlias, eagerType, *_0, _1, *_90, _91, _2$$15, _3$$15, _5$$15, _6$$14, _8$$20, _9$$20, _10$$20, _12$$22, *_13$$24, _14$$24, _15$$27, _18$$28, _20$$30, _21$$31, _22$$31, _23$$31, _27$$32, _30$$33, _32$$35, _33$$36, _34$$36, _35$$36, _39$$38, _40$$38, _42$$38, _43$$37, _45$$40, _46$$43, _47$$43, _48$$43, _49$$45, _50$$48, *_51$$47, _52$$47, _53$$50, _56$$51, _58$$53, _59$$54, _60$$54, _61$$54, _65$$55, _68$$56, _70$$58, _71$$59, _72$$59, _73$$59, _77$$61, _78$$61, _79$$61, _80$$61, _81$$61, _82$$61, _83$$61, _84$$61, _85$$61, _86$$61, _87$$61, _88$$61, _89$$64, _92$$69, *_94$$69, _95$$69, _96$$74, _97$$75, _99$$81, _100$$82, _102$$84, *_103$$84, _104$$84, _105$$89, _106$$90, _108$$96, _109$$97, _111$$101, _112$$102, _113$$103, _114$$104, _115$$105;
	zval *this_ptr = getThis();
	...
	if (Z_TYPE_P(&selectedModels) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&selectedModels), _0)
		{
			...
			zephir_array_fetch_string(&qualifiedName, &selectedModel, SL("qualifiedName"), PH_NOISY, "phalcon/mvc/model/query.zep", 1860);
			ZEPHIR_OBS_NVAR(&modelName);
			zephir_array_fetch_string(&modelName, &qualifiedName, SL("name"), PH_NOISY, "phalcon/mvc/model/query.zep", 1861);
			if (zephir_memnstr_str(&modelName, SL(":"), "phalcon/mvc/model/query.zep", 1864)) {
				ZEPHIR_INIT_NVAR(&nsAlias);
				zephir_fast_explode_str(&nsAlias, SL(":"), &modelName, LONG_MAX);
				zephir_array_fetch_long(&_3$$15, &nsAlias, 0, PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 1866);
				ZEPHIR_CALL_METHOD(&_2$$15, &manager, "getnamespacealias", &_4, 0, &_3$$15);
				zephir_check_call_status();
				zephir_array_fetch_long(&_5$$15, &nsAlias, 1, PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 1866);
			...
			ZVAL_BOOL(&_6$$14, 1);
			ZEPHIR_CALL_METHOD(&model, &manager, "load", &_7, 0, &realModelName, &_6$$14);
			zephir_check_call_status();
			ZEPHIR_CALL_METHOD(&schema, &model, "getschema", NULL, 0);
			zephir_check_call_status();
			ZEPHIR_CALL_METHOD(&source, &model, "getsource", NULL, 0);
			...
			if (zephir_array_isset_string_fetch(&alias, &selectedModel, SL("alias"), 0)) {
				if (zephir_array_isset(&sqlAliases, &alias)) {
					ZEPHIR_INIT_NVAR(&_8$$20);
					object_init_ex(&_8$$20, phalcon_mvc_model_exception_ce);
					zephir_read_property(&_9$$20, this_ptr, SL("_phql"), PH_NOISY_CC | PH_READONLY);
					ZEPHIR_INIT_NVAR(&_10$$20);
					ZEPHIR_CONCAT_SVSV(&_10$$20, "Alias '", &alias, "' is used more than once, when preparing: ", &_9$$20);
					ZEPHIR_CALL_METHOD(NULL, &_8$$20, "__construct", &_11, 4, &_10$$20);
					zephir_check_call_status();
					zephir_throw_exception_debug(&_8$$20, "phalcon/mvc/model/query.zep", 1890);
					ZEPHIR_MM_RESTORE();
					return;
				}
				zephir_array_update_zval(&sqlAliases, &alias, &alias, PH_COPY | PH_SEPARATE);
				...
				if (Z_TYPE_P(&completeSource) == IS_ARRAY) {
					...
					ZEPHIR_INIT_NVAR(&_12$$22);
					zephir_create_array(&_12$$22, 3, 0);
					zephir_array_fast_append(&_12$$22, &source);
					zephir_array_fast_append(&_12$$22, &__$null);
					zephir_array_fast_append(&_12$$22, &alias);
					ZEPHIR_CPY_WRT(&completeSource, &_12$$22);
				}
				zephir_array_update_zval(&models, &realModelName, &alias, PH_COPY | PH_SEPARATE);
			} else {
			...
			if (zephir_array_isset_string_fetch(&with, &selectedModel, SL("with"), 0)) {
				...
				if (Z_TYPE_P(&withs) == IS_ARRAY) {
					ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&withs), _13$$24)
					{
						ZEPHIR_INIT_NVAR(&withItem);
						ZVAL_COPY(&withItem, _13$$24);
						ZEPHIR_INIT_NVAR(&_15$$27);
						ZVAL_LONG(&_15$$27, number);
						ZEPHIR_INIT_NVAR(&_16$$27);
						ZEPHIR_CONCAT_SV(&_16$$27, "AA", &_15$$27);
						ZEPHIR_CPY_WRT(&joinAlias, &_16$$27);
						ZEPHIR_OBS_NVAR(&relationModel);
						zephir_array_fetch_string(&relationModel, &withItem, SL("name"), PH_NOISY, "phalcon/mvc/model/query.zep", 1930);
						ZEPHIR_CALL_METHOD(&relation, &manager, "getrelationbyalias", &_17, 0, &realModelName, &relationModel);
						zephir_check_call_status();
						if (Z_TYPE_P(&relation) == IS_OBJECT) {
							ZEPHIR_INIT_NVAR(&_18$$28);
							ZVAL_STRING(&_18$$28, "alias");
							ZEPHIR_CALL_METHOD(&bestAlias, &relation, "getoption", NULL, 0, &_18$$28);
							zephir_check_call_status();
							...
							ZEPHIR_CALL_METHOD(&relation, &manager, "getrelationsbetween", &_19, 0, &realModelName, &relationModel);
							zephir_check_call_status();
							if (Z_TYPE_P(&relation) == IS_OBJECT) {
								ZEPHIR_INIT_NVAR(&_20$$30);
								ZVAL_STRING(&_20$$30, "alias");
								ZEPHIR_CALL_METHOD(&bestAlias, &relation, "getoption", NULL, 0, &_20$$30);
								zephir_check_call_status();
								ZEPHIR_CALL_METHOD(&relationModel, &relation, "getreferencedmodel", NULL, 0);
								zephir_check_call_status();
								ZEPHIR_CALL_METHOD(&eagerType, &relation, "gettype", NULL, 0);
								...
								ZEPHIR_INIT_NVAR(&_21$$31);
								object_init_ex(&_21$$31, phalcon_mvc_model_exception_ce);
								zephir_read_property(&_22$$31, this_ptr, SL("_phql"), PH_NOISY_CC | PH_READONLY);
								ZEPHIR_INIT_NVAR(&_23$$31);
								ZEPHIR_CONCAT_SVSVSV(&_23$$31, "Can't find a relationship between '", &realModelName, "' and '", &relationModel, "' when preparing: ", &_22$$31);
								ZEPHIR_CALL_METHOD(NULL, &_21$$31, "__construct", &_11, 4, &_23$$31);
								zephir_check_call_status();
								zephir_throw_exception_debug(&_21$$31, "phalcon/mvc/model/query.zep", 1946);
								ZEPHIR_MM_RESTORE();
								return;
							}
						}
						ZEPHIR_INIT_NVAR(&_24$$27);
						zephir_create_array(&_24$$27, 5, 0);
						add_assoc_long_ex(&_24$$27, SL("type"), 353);
						zephir_array_update_string(&_24$$27, SL("column"), &joinAlias, PH_COPY | PH_SEPARATE);
						zephir_array_update_string(&_24$$27, SL("eager"), &alias, PH_COPY | PH_SEPARATE);
						zephir_array_update_string(&_24$$27, SL("eagerType"), &eagerType, PH_COPY | PH_SEPARATE);
						zephir_array_update_string(&_24$$27, SL("balias"), &bestAlias, PH_COPY | PH_SEPARATE);
						zephir_array_append(&selectColumns, &_24$$27, PH_SEPARATE, "phalcon/mvc/model/query.zep", 1956);
						ZEPHIR_INIT_NVAR(&_25$$27);
						zephir_create_array(&_25$$27, 3, 0);
						add_assoc_long_ex(&_25$$27, SL("type"), 360);
						ZEPHIR_INIT_NVAR(&_26$$27);
						zephir_create_array(&_26$$27, 2, 0);
						add_assoc_long_ex(&_26$$27, SL("type"), 355);
						zephir_array_update_string(&_26$$27, SL("name"), &relationModel, PH_COPY | PH_SEPARATE);
						zephir_array_update_string(&_25$$27, SL("qualified"), &_26$$27, PH_COPY | PH_SEPARATE);
						ZEPHIR_INIT_NVAR(&_26$$27);
						zephir_create_array(&_26$$27, 2, 0);
						add_assoc_long_ex(&_26$$27, SL("type"), 355);
						zephir_array_update_string(&_26$$27, SL("name"), &joinAlias, PH_COPY | PH_SEPARATE);
						zephir_array_update_string(&_25$$27, SL("alias"), &_26$$27, PH_COPY | PH_SEPARATE);
						zephir_array_append(&automaticJoins, &_25$$27, PH_SEPARATE, "phalcon/mvc/model/query.zep", 1968);
						number++;
					} ZEND_HASH_FOREACH_END();
				} else {
					...
					zephir_check_call_status();
					while (1) {
						ZEPHIR_CALL_METHOD(&_14$$24, &withs, "valid", NULL, 0);
						zephir_check_call_status();
						if (!zend_is_true(&_14$$24)) {
							break;
						}
						ZEPHIR_CALL_METHOD(&withItem, &withs, "current", NULL, 0);
						zephir_check_call_status();
							ZEPHIR_INIT_NVAR(&_27$$32);
							ZVAL_LONG(&_27$$32, number);
							ZEPHIR_INIT_NVAR(&_28$$32);
							ZEPHIR_CONCAT_SV(&_28$$32, "AA", &_27$$32);
							ZEPHIR_CPY_WRT(&joinAlias, &_28$$32);
							ZEPHIR_OBS_NVAR(&relationModel);
							zephir_array_fetch_string(&relationModel, &withItem, SL("name"), PH_NOISY, "phalcon/mvc/model/query.zep", 1930);
							ZEPHIR_CALL_METHOD(&relation, &manager, "getrelationbyalias", &_29, 0, &realModelName, &relationModel);
							zephir_check_call_status();
							if (Z_TYPE_P(&relation) == IS_OBJECT) {
								ZEPHIR_INIT_NVAR(&_30$$33);
								ZVAL_STRING(&_30$$33, "alias");
								ZEPHIR_CALL_METHOD(&bestAlias, &relation, "getoption", NULL, 0, &_30$$33);
								zephir_check_call_status();
								ZEPHIR_CALL_METHOD(&relationModel, &relation, "getreferencedmodel", NULL, 0);
								zephir_check_call_status();
								ZEPHIR_CALL_METHOD(&eagerType, &relation, "gettype", NULL, 0);
								...
								ZEPHIR_CALL_METHOD(&relation, &manager, "getrelationsbetween", &_31, 0, &realModelName, &relationModel);
								zephir_check_call_status();
								if (Z_TYPE_P(&relation) == IS_OBJECT) {
									ZEPHIR_INIT_NVAR(&_32$$35);
									ZVAL_STRING(&_32$$35, "alias");
									ZEPHIR_CALL_METHOD(&bestAlias, &relation, "getoption", NULL, 0, &_32$$35);
									zephir_check_call_status();
									ZEPHIR_CALL_METHOD(&relationModel, &relation, "getreferencedmodel", NULL, 0);
									zephir_check_call_status();
									ZEPHIR_CALL_METHOD(&eagerType, &relation, "gettype", NULL, 0);
									...
									object_init_ex(&_33$$36, phalcon_mvc_model_exception_ce);
									zephir_read_property(&_34$$36, this_ptr, SL("_phql"), PH_NOISY_CC | PH_READONLY);
									ZEPHIR_INIT_NVAR(&_35$$36);
									ZEPHIR_CONCAT_SVSVSV(&_35$$36, "Can't find a relationship between '", &realModelName, "' and '", &relationModel, "' when preparing: ", &_34$$36);
									ZEPHIR_CALL_METHOD(NULL, &_33$$36, "__construct", &_11, 4, &_35$$36);
									zephir_check_call_status();
									zephir_throw_exception_debug(&_33$$36, "phalcon/mvc/model/query.zep", 1946);
									ZEPHIR_MM_RESTORE();
									return;
								}
							}
							ZEPHIR_INIT_NVAR(&_36$$32);
							zephir_create_array(&_36$$32, 5, 0);
							add_assoc_long_ex(&_36$$32, SL("type"), 353);
							zephir_array_update_string(&_36$$32, SL("column"), &joinAlias, PH_COPY | PH_SEPARATE);
							zephir_array_update_string(&_36$$32, SL("eager"), &alias, PH_COPY | PH_SEPARATE);
							zephir_array_update_string(&_36$$32, SL("eagerType"), &eagerType, PH_COPY | PH_SEPARATE);
							zephir_array_update_string(&_36$$32, SL("balias"), &bestAlias, PH_COPY | PH_SEPARATE);
							zephir_array_append(&selectColumns, &_36$$32, PH_SEPARATE, "phalcon/mvc/model/query.zep", 1956);
							ZEPHIR_INIT_NVAR(&_37$$32);
							zephir_create_array(&_37$$32, 3, 0);
							add_assoc_long_ex(&_37$$32, SL("type"), 360);
							ZEPHIR_INIT_NVAR(&_38$$32);
							zephir_create_array(&_38$$32, 2, 0);
							add_assoc_long_ex(&_38$$32, SL("type"), 355);
							zephir_array_update_string(&_38$$32, SL("name"), &relationModel, PH_COPY | PH_SEPARATE);
							zephir_array_update_string(&_37$$32, SL("qualified"), &_38$$32, PH_COPY | PH_SEPARATE);
							ZEPHIR_INIT_NVAR(&_38$$32);
							zephir_create_array(&_38$$32, 2, 0);
							add_assoc_long_ex(&_38$$32, SL("type"), 355);
							zephir_array_update_string(&_38$$32, SL("name"), &joinAlias, PH_COPY | PH_SEPARATE);
							zephir_array_update_string(&_37$$32, SL("alias"), &_38$$32, PH_COPY | PH_SEPARATE);
							zephir_array_append(&automaticJoins, &_37$$32, PH_SEPARATE, "phalcon/mvc/model/query.zep", 1968);
							number++;
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				if (zephir_memnstr_str(&modelName, SL(":"), "phalcon/mvc/model/query.zep", 1864)) {
					ZEPHIR_INIT_NVAR(&nsAlias);
					zephir_fast_explode_str(&nsAlias, SL(":"), &modelName, LONG_MAX);
					zephir_array_fetch_long(&_40$$38, &nsAlias, 0, PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 1866);
					ZEPHIR_CALL_METHOD(&_39$$38, &manager, "getnamespacealias", &_41, 0, &_40$$38);
					zephir_check_call_status();
					zephir_array_fetch_long(&_42$$38, &nsAlias, 1, PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 1866);
					ZEPHIR_INIT_NVAR(&realModelName);
					ZEPHIR_CONCAT_VSV(&realModelName, &_39$$38, "\\", &_42$$38);
				} else {
					ZEPHIR_CPY_WRT(&realModelName, &modelName);
				}
				ZVAL_BOOL(&_43$$37, 1);
				ZEPHIR_CALL_METHOD(&model, &manager, "load", &_44, 0, &realModelName, &_43$$37);
				zephir_check_call_status();
				ZEPHIR_CALL_METHOD(&schema, &model, "getschema", NULL, 0);
				zephir_check_call_status();
				ZEPHIR_CALL_METHOD(&source, &model, "getsource", NULL, 0);
				...
				if (zephir_is_true(&schema)) {
					...
					zephir_create_array(&_45$$40, 2, 0);
				...
				if (zephir_array_isset_string_fetch(&alias, &selectedModel, SL("alias"), 0)) {
					if (zephir_array_isset(&sqlAliases, &alias)) {
						...
						zephir_read_property(&_47$$43, this_ptr, SL("_phql"), PH_NOISY_CC | PH_READONLY);
						ZEPHIR_INIT_NVAR(&_48$$43);
						ZEPHIR_CONCAT_SVSV(&_48$$43, "Alias '", &alias, "' is used more than once, when preparing: ", &_47$$43);
						ZEPHIR_CALL_METHOD(NULL, &_46$$43, "__construct", &_11, 4, &_48$$43);
						zephir_check_call_status();
						zephir_throw_exception_debug(&_46$$43, "phalcon/mvc/model/query.zep", 1890);
						ZEPHIR_MM_RESTORE();
						return;
					}
					zephir_array_update_zval(&sqlAliases, &alias, &alias, PH_COPY | PH_SEPARATE);
					...
					if (Z_TYPE_P(&completeSource) == IS_ARRAY) {
						...
						zephir_create_array(&_49$$45, 3, 0);
				...
				if (zephir_array_isset_string_fetch(&with, &selectedModel, SL("with"), 0)) {
					if (!(zephir_array_isset_long(&with, 0))) {
						...
						zephir_create_array(&_50$$48, 1, 0);
					...
					if (Z_TYPE_P(&withs) == IS_ARRAY) {
						ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&withs), _51$$47)
						{
							...
							ZEPHIR_INIT_NVAR(&_53$$50);
							ZVAL_LONG(&_53$$50, number);
							ZEPHIR_INIT_NVAR(&_54$$50);
							...
							if (Z_TYPE_P(&relation) == IS_OBJECT) {
								...
								if (Z_TYPE_P(&relation) == IS_OBJECT) {
									...
									zephir_read_property(&_60$$54, this_ptr, SL("_phql"), PH_NOISY_CC | PH_READONLY);
									...
									ZEPHIR_CALL_METHOD(NULL, &_59$$54, "__construct", &_11, 4, &_61$$54);
									zephir_check_call_status();
									zephir_throw_exception_debug(&_59$$54, "phalcon/mvc/model/query.zep", 1946);
									ZEPHIR_MM_RESTORE();
									return;
								}
							}
							ZEPHIR_INIT_NVAR(&_62$$50);
							zephir_create_array(&_62$$50, 5, 0);
							...
							zephir_array_append(&selectColumns, &_62$$50, PH_SEPARATE, "phalcon/mvc/model/query.zep", 1956);
							ZEPHIR_INIT_NVAR(&_63$$50);
							zephir_create_array(&_63$$50, 3, 0);
							add_assoc_long_ex(&_63$$50, SL("type"), 360);
							ZEPHIR_INIT_NVAR(&_64$$50);
							zephir_create_array(&_64$$50, 2, 0);
							...
							zephir_array_append(&automaticJoins, &_63$$50, PH_SEPARATE, "phalcon/mvc/model/query.zep", 1968);
							number++;
						} ZEND_HASH_FOREACH_END();
					} else {
						ZEPHIR_CALL_METHOD(NULL, &withs, "rewind", NULL, 0);
							...
							zephir_check_call_status();
								...
								if (Z_TYPE_P(&relation) == IS_OBJECT) {
									...
									if (Z_TYPE_P(&relation) == IS_OBJECT) {
										...
										zephir_read_property(&_72$$59, this_ptr, SL("_phql"), PH_NOISY_CC | PH_READONLY);
										...
										ZEPHIR_CALL_METHOD(NULL, &_71$$59, "__construct", &_11, 4, &_73$$59);
										zephir_check_call_status();
										zephir_throw_exception_debug(&_71$$59, "phalcon/mvc/model/query.zep", 1946);
										ZEPHIR_MM_RESTORE();
										return;
									}
								}
								ZEPHIR_INIT_NVAR(&_74$$55);
								zephir_create_array(&_74$$55, 5, 0);
								...
								zephir_array_append(&selectColumns, &_74$$55, PH_SEPARATE, "phalcon/mvc/model/query.zep", 1956);
								ZEPHIR_INIT_NVAR(&_75$$55);
								zephir_create_array(&_75$$55, 3, 0);
								add_assoc_long_ex(&_75$$55, SL("type"), 360);
								ZEPHIR_INIT_NVAR(&_76$$55);
								zephir_create_array(&_76$$55, 2, 0);
								...
								zephir_array_append(&automaticJoins, &_75$$55, PH_SEPARATE, "phalcon/mvc/model/query.zep", 1968);
								number++;
							ZEPHIR_CALL_METHOD(NULL, &withs, "next", NULL, 0);
							zephir_check_call_status();
						}
	...
	if (!(zephir_is_true(merge))) {
		...
		zephir_read_property(&_78$$61, this_ptr, SL("_models"), PH_NOISY_CC | PH_READONLY);
		zephir_fast_array_merge(&_77$$61, &_78$$61, &models);
		zephir_update_property_zval(this_ptr, SL("_models"), &_77$$61);
		ZEPHIR_INIT_VAR(&_79$$61);
		zephir_read_property(&_80$$61, this_ptr, SL("_modelsInstances"), PH_NOISY_CC | PH_READONLY);
		zephir_fast_array_merge(&_79$$61, &_80$$61, &modelsInstances);
		zephir_update_property_zval(this_ptr, SL("_modelsInstances"), &_79$$61);
		ZEPHIR_INIT_VAR(&_81$$61);
		zephir_read_property(&_82$$61, this_ptr, SL("_sqlAliases"), PH_NOISY_CC | PH_READONLY);
		zephir_fast_array_merge(&_81$$61, &_82$$61, &sqlAliases);
		zephir_update_property_zval(this_ptr, SL("_sqlAliases"), &_81$$61);
		ZEPHIR_INIT_VAR(&_83$$61);
		zephir_read_property(&_84$$61, this_ptr, SL("_sqlAliasesModels"), PH_NOISY_CC | PH_READONLY);
		zephir_fast_array_merge(&_83$$61, &_84$$61, &sqlAliasesModels);
		zephir_update_property_zval(this_ptr, SL("_sqlAliasesModels"), &_83$$61);
		ZEPHIR_INIT_VAR(&_85$$61);
		zephir_read_property(&_86$$61, this_ptr, SL("_sqlModelsAliases"), PH_NOISY_CC | PH_READONLY);
		zephir_fast_array_merge(&_85$$61, &_86$$61, &sqlModelsAliases);
		zephir_update_property_zval(this_ptr, SL("_sqlModelsAliases"), &_85$$61);
		ZEPHIR_INIT_VAR(&_87$$61);
		zephir_read_property(&_88$$61, this_ptr, SL("_sqlAliasesModelsInstances"), PH_NOISY_CC | PH_READONLY);
		zephir_fast_array_merge(&_87$$61, &_88$$61, &sqlAliasesModelsInstances);
		zephir_update_property_zval(this_ptr, SL("_sqlAliasesModelsInstances"), &_87$$61);
	}
	ZEPHIR_OBS_VAR(&joins);
	...
	if (zephir_fast_count_int(&joins)) {
		if (zephir_fast_count_int(&automaticJoins)) {
			if (zephir_array_isset_long(&joins, 0)) {
				...
				zephir_fast_array_merge(&_89$$64, &joins, &automaticJoins);
	...
	if (Z_TYPE_P(&selectColumns) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&selectColumns), _90)
		{
			...
			ZEPHIR_CALL_METHOD(&_92$$69, this_ptr, "_getselectcolumn", &_93, 334, &column);
			zephir_check_call_status();
			zephir_is_iterable(&_92$$69, 0, "phalcon/mvc/model/query.zep", 2064);
				...
				ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_92$$69), _94$$69)
				{
					...
					if (zephir_array_isset_string_fetch(&alias, &column, SL("alias"), 0)) {
						...
						if (zephir_array_isset_string_fetch(&alias, &sqlColumn, SL("balias"), 0)) {
							...
							zephir_array_fetch_string(&_96$$74, &sqlColumn, SL("type"), PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 2054);
							if (ZEPHIR_IS_STRING(&_96$$74, "scalar")) {
								ZEPHIR_INIT_NVAR(&_97$$75);
								ZVAL_LONG(&_97$$75, position);
								ZEPHIR_INIT_NVAR(&_98$$75);
								ZEPHIR_CONCAT_SV(&_98$$75, "_", &_97$$75);
								zephir_array_update_zval(&sqlColumns, &_98$$75, &sqlColumn, PH_COPY | PH_SEPARATE);
							} else {
					...
					zephir_check_call_status();
						...
						if (zephir_array_isset_string_fetch(&alias, &column, SL("alias"), 0)) {
							...
							if (zephir_array_isset_string_fetch(&alias, &sqlColumn, SL("balias"), 0)) {
								...
								zephir_array_fetch_string(&_99$$81, &sqlColumn, SL("type"), PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 2054);
								if (ZEPHIR_IS_STRING(&_99$$81, "scalar")) {
									ZEPHIR_INIT_NVAR(&_100$$82);
									ZVAL_LONG(&_100$$82, position);
									ZEPHIR_INIT_NVAR(&_101$$82);
									ZEPHIR_CONCAT_SV(&_101$$82, "_", &_100$$82);
									zephir_array_update_zval(&sqlColumns, &_101$$82, &sqlColumn, PH_COPY | PH_SEPARATE);
								} else {
									zephir_array_append(&sqlColumns, &sqlColumn, PH_SEPARATE, "phalcon/mvc/model/query.zep", 2057);
								}
							}
		...
		while (1) {
			...
			zephir_check_call_status();
				ZEPHIR_CALL_METHOD(&_102$$84, this_ptr, "_getselectcolumn", &_93, 334, &column);
				zephir_check_call_status();
				zephir_is_iterable(&_102$$84, 0, "phalcon/mvc/model/query.zep", 2064);
				if (Z_TYPE_P(&_102$$84) == IS_ARRAY) {
					ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_102$$84), _103$$84)
					{
						ZEPHIR_INIT_NVAR(&sqlColumn);
						ZVAL_COPY(&sqlColumn, _103$$84);
						ZEPHIR_OBS_NVAR(&alias);
						if (zephir_array_isset_string_fetch(&alias, &column, SL("alias"), 0)) {
							zephir_array_update_string(&sqlColumn, SL("balias"), &alias, PH_COPY | PH_SEPARATE);
							zephir_array_update_string(&sqlColumn, SL("sqlAlias"), &alias, PH_COPY | PH_SEPARATE);
							...
							if (zephir_array_isset_string_fetch(&alias, &sqlColumn, SL("balias"), 0)) {
								...
								zephir_array_fetch_string(&_105$$89, &sqlColumn, SL("type"), PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 2054);
								if (ZEPHIR_IS_STRING(&_105$$89, "scalar")) {
									ZEPHIR_INIT_NVAR(&_106$$90);
									ZVAL_LONG(&_106$$90, position);
									ZEPHIR_INIT_NVAR(&_107$$90);
									ZEPHIR_CONCAT_SV(&_107$$90, "_", &_106$$90);
									zephir_array_update_zval(&sqlColumns, &_107$$90, &sqlColumn, PH_COPY | PH_SEPARATE);
								} else {
									zephir_array_append(&sqlColumns, &sqlColumn, PH_SEPARATE, "phalcon/mvc/model/query.zep", 2057);
								}
							}
					...
					ZEPHIR_CALL_METHOD(NULL, &_102$$84, "rewind", NULL, 0);
					zephir_check_call_status();
					while (1) {
						ZEPHIR_CALL_METHOD(&_104$$84, &_102$$84, "valid", NULL, 0);
						zephir_check_call_status();
						if (!zend_is_true(&_104$$84)) {
							break;
						}
						ZEPHIR_CALL_METHOD(&sqlColumn, &_102$$84, "current", NULL, 0);
						zephir_check_call_status();
							ZEPHIR_OBS_NVAR(&alias);
							if (zephir_array_isset_string_fetch(&alias, &column, SL("alias"), 0)) {
								zephir_array_update_string(&sqlColumn, SL("balias"), &alias, PH_COPY | PH_SEPARATE);
								...
								if (zephir_array_isset_string_fetch(&alias, &sqlColumn, SL("balias"), 0)) {
									...
									zephir_array_fetch_string(&_108$$96, &sqlColumn, SL("type"), PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 2054);
									if (ZEPHIR_IS_STRING(&_108$$96, "scalar")) {
										ZEPHIR_INIT_NVAR(&_109$$97);
										ZVAL_LONG(&_109$$97, position);
										ZEPHIR_INIT_NVAR(&_110$$97);
										ZEPHIR_CONCAT_SV(&_110$$97, "_", &_109$$97);
										zephir_array_update_zval(&sqlColumns, &_110$$97, &sqlColumn, PH_COPY | PH_SEPARATE);
									} else {
										zephir_array_append(&sqlColumns, &sqlColumn, PH_SEPARATE, "phalcon/mvc/model/query.zep", 2057);
									}
								}
							...
							position++;
						ZEPHIR_CALL_METHOD(NULL, &_102$$84, "next", NULL, 0);
						zephir_check_call_status();
					}
				}
				ZEPHIR_INIT_NVAR(&sqlColumn);
	...
	if (zephir_array_isset_string_fetch(&where, ast, SL("where"), 0)) {
		ZEPHIR_CALL_METHOD(&_111$$101, this_ptr, "_getexpression", NULL, 323, &where);
		zephir_check_call_status();
		zephir_array_update_string(&sqlSelect, SL("where"), &_111$$101, PH_COPY | PH_SEPARATE);
	}
	ZEPHIR_OBS_VAR(&groupBy);
	if (zephir_array_isset_string_fetch(&groupBy, ast, SL("groupBy"), 0)) {
		ZEPHIR_CALL_METHOD(&_112$$102, this_ptr, "_getgroupclause", NULL, 335, &groupBy);
		zephir_check_call_status();
		zephir_array_update_string(&sqlSelect, SL("group"), &_112$$102, PH_COPY | PH_SEPARATE);
	}
	ZEPHIR_OBS_VAR(&having);
	if (zephir_array_isset_string_fetch(&having, ast, SL("having"), 0)) {
		ZEPHIR_CALL_METHOD(&_113$$103, this_ptr, "_getexpression", NULL, 323, &having);
		zephir_check_call_status();
		zephir_array_update_string(&sqlSelect, SL("having"), &_113$$103, PH_COPY | PH_SEPARATE);
	}
	ZEPHIR_OBS_VAR(&order);
	if (zephir_array_isset_string_fetch(&order, ast, SL("orderBy"), 0)) {
		ZEPHIR_CALL_METHOD(&_114$$104, this_ptr, "_getorderclause", NULL, 336, &order);
		zephir_check_call_status();
		zephir_array_update_string(&sqlSelect, SL("order"), &_114$$104, PH_COPY | PH_SEPARATE);
	}
	ZEPHIR_OBS_VAR(&limit);
	if (zephir_array_isset_string_fetch(&limit, ast, SL("limit"), 0)) {
		ZEPHIR_CALL_METHOD(&_115$$105, this_ptr, "_getlimitclause", NULL, 337, &limit);
		zephir_check_call_status();
		zephir_array_update_string(&sqlSelect, SL("limit"), &_115$$105, PH_COPY | PH_SEPARATE);
	}
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _prepareInsert) {
	...
	zval ast, qualifiedName, nsAlias, manager, modelName, model, source, schema, exprValues, exprValue, sqlInsert, metaData, fields, sqlFields, field, name, realModelName, _3, _5, *_6, _7, _0$$6, _1$$6, _2$$6, _4$$8, _9$$9, _10$$9, _11$$9, _14$$10, _15$$10, _16$$10, *_17$$11, _18$$11, _19$$12, _21$$13, _22$$13, _23$$13, _25$$14, _27$$15, _28$$15, _29$$15;
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	...
	zephir_array_fetch_string(&qualifiedName, &ast, SL("qualifiedName"), PH_NOISY, "phalcon/mvc/model/query.zep", 2144);
	...
	zephir_read_property(&manager, this_ptr, SL("_manager"), PH_NOISY_CC);
	ZEPHIR_OBS_VAR(&modelName);
	zephir_array_fetch_string(&modelName, &qualifiedName, SL("name"), PH_NOISY, "phalcon/mvc/model/query.zep", 2152);
	if (zephir_memnstr_str(&modelName, SL(":"), "phalcon/mvc/model/query.zep", 2155)) {
		ZEPHIR_INIT_VAR(&nsAlias);
		zephir_fast_explode_str(&nsAlias, SL(":"), &modelName, LONG_MAX);
		zephir_array_fetch_long(&_1$$6, &nsAlias, 0, PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 2157);
		ZEPHIR_CALL_METHOD(&_0$$6, &manager, "getnamespacealias", NULL, 0, &_1$$6);
		zephir_check_call_status();
		zephir_array_fetch_long(&_2$$6, &nsAlias, 1, PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 2157);
		ZEPHIR_INIT_VAR(&realModelName);
	...
	zephir_array_fetch_string(&_5, &ast, SL("values"), PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 2173);
	zephir_is_iterable(&_5, 0, "phalcon/mvc/model/query.zep", 2182);
	if (Z_TYPE_P(&_5) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_5), _6)
		{
			...
			zephir_array_fetch_string(&_9$$9, &exprValue, SL("type"), PH_NOISY, "phalcon/mvc/model/query.zep", 2177);
			...
			ZEPHIR_CALL_METHOD(&_10$$9, this_ptr, "_getexpression", &_12, 323, &exprValue, &_11$$9);
			zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				zephir_create_array(&_13$$10, 2, 0);
				ZEPHIR_OBS_NVAR(&_14$$10);
				zephir_array_fetch_string(&_14$$10, &exprValue, SL("type"), PH_NOISY, "phalcon/mvc/model/query.zep", 2177);
				...
				ZEPHIR_CALL_METHOD(&_15$$10, this_ptr, "_getexpression", &_12, 323, &exprValue, &_16$$10);
				zephir_check_call_status();
				zephir_array_update_string(&_13$$10, SL("value"), &_15$$10, PH_COPY | PH_SEPARATE);
				zephir_array_append(&exprValues, &_13$$10, PH_SEPARATE, "phalcon/mvc/model/query.zep", 2179);
	...
	if (zephir_array_isset_string_fetch(&fields, &ast, SL("fields"), 0)) {
		...
		if (Z_TYPE_P(&fields) == IS_ARRAY) {
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&fields), _17$$11)
			{
				...
				zephir_array_fetch_string(&name, &field, SL("name"), PH_NOISY, "phalcon/mvc/model/query.zep", 2193);
				...
				if (!(zephir_is_true(&_19$$12))) {
					...
					zephir_read_property(&_22$$13, this_ptr, SL("_phql"), PH_NOISY_CC | PH_READONLY);
					...
					ZEPHIR_CALL_METHOD(NULL, &_21$$13, "__construct", &_24, 4, &_23$$13);
					zephir_check_call_status();
					zephir_throw_exception_debug(&_21$$13, "phalcon/mvc/model/query.zep", 2199);
					ZEPHIR_MM_RESTORE();
					return;
				}
			...
			while (1) {
				...
				zephir_check_call_status();
					...
					if (!(zephir_is_true(&_25$$14))) {
						...
						zephir_read_property(&_28$$15, this_ptr, SL("_phql"), PH_NOISY_CC | PH_READONLY);
						...
						ZEPHIR_CALL_METHOD(NULL, &_27$$15, "__construct", &_24, 4, &_29$$15);
						zephir_check_call_status();
						zephir_throw_exception_debug(&_27$$15, "phalcon/mvc/model/query.zep", 2199);
						ZEPHIR_MM_RESTORE();
						return;
					}
					zephir_array_append(&sqlFields, &name, PH_SEPARATE, "phalcon/mvc/model/query.zep", 2203);
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _prepareUpdate) {
	...
	zend_bool notQuoting = 0;
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zval __$null, ast, update, tables, values, modelsInstances, models, sqlTables, sqlAliases, sqlAliasesModelsInstances, updateTables, nsAlias, realModelName, completeSource, sqlModels, manager, table, qualifiedName, modelName, model, source, schema, alias, sqlFields, sqlValues, updateValues, updateValue, exprColumn, sqlUpdate, where, limit, *_0, _1, *_18, _19, _2$$9, _3$$9, _5$$9, _6$$8, _8$$11, _9$$12, _10$$16, _11$$16, _13$$16, _14$$15, _16$$18, _17$$19, _20$$24, _21$$24, _22$$24, _25$$24, _26$$24, _27$$24, _28$$25, _29$$25, _30$$25, _32$$25, _33$$25, _34$$25, _35$$26, _36$$26, _37$$27;
	zephir_fcall_cache_entry *_4 = NULL, *_7 = NULL, *_12 = NULL, *_15 = NULL, *_23 = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *this_ptr = getThis();
	...
	if (Z_TYPE_P(&updateTables) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&updateTables), _0)
		{
			...
			ZVAL_COPY(&table, _0);
			ZEPHIR_OBS_NVAR(&qualifiedName);
			zephir_array_fetch_string(&qualifiedName, &table, SL("qualifiedName"), PH_NOISY, "phalcon/mvc/model/query.zep", 2261);
			ZEPHIR_OBS_NVAR(&modelName);
			zephir_array_fetch_string(&modelName, &qualifiedName, SL("name"), PH_NOISY, "phalcon/mvc/model/query.zep", 2262);
			if (zephir_memnstr_str(&modelName, SL(":"), "phalcon/mvc/model/query.zep", 2267)) {
				ZEPHIR_INIT_NVAR(&nsAlias);
				zephir_fast_explode_str(&nsAlias, SL(":"), &modelName, LONG_MAX);
				zephir_array_fetch_long(&_3$$9, &nsAlias, 0, PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 2269);
				ZEPHIR_CALL_METHOD(&_2$$9, &manager, "getnamespacealias", &_4, 0, &_3$$9);
				zephir_check_call_status();
				zephir_array_fetch_long(&_5$$9, &nsAlias, 1, PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 2269);
				ZEPHIR_INIT_NVAR(&realModelName);
			...
			ZVAL_BOOL(&_6$$8, 1);
			ZEPHIR_CALL_METHOD(&model, &manager, "load", &_7, 0, &realModelName, &_6$$8);
			zephir_check_call_status();
			ZEPHIR_CALL_METHOD(&source, &model, "getsource", NULL, 0);
			zephir_check_call_status();
			ZEPHIR_CALL_METHOD(&schema, &model, "getschema", NULL, 0);
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				if (zephir_memnstr_str(&modelName, SL(":"), "phalcon/mvc/model/query.zep", 2267)) {
					ZEPHIR_INIT_NVAR(&nsAlias);
					zephir_fast_explode_str(&nsAlias, SL(":"), &modelName, LONG_MAX);
					zephir_array_fetch_long(&_11$$16, &nsAlias, 0, PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 2269);
					ZEPHIR_CALL_METHOD(&_10$$16, &manager, "getnamespacealias", &_12, 0, &_11$$16);
					zephir_check_call_status();
					zephir_array_fetch_long(&_13$$16, &nsAlias, 1, PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 2269);
					ZEPHIR_INIT_NVAR(&realModelName);
				...
				ZVAL_BOOL(&_14$$15, 1);
				ZEPHIR_CALL_METHOD(&model, &manager, "load", &_15, 0, &realModelName, &_14$$15);
				zephir_check_call_status();
				ZEPHIR_CALL_METHOD(&source, &model, "getsource", NULL, 0);
				zephir_check_call_status();
				ZEPHIR_CALL_METHOD(&schema, &model, "getschema", NULL, 0);
				...
				if (zephir_is_true(&schema)) {
					...
					zephir_create_array(&_16$$18, 2, 0);
					zephir_array_fast_append(&_16$$18, &source);
					zephir_array_fast_append(&_16$$18, &schema);
					ZEPHIR_CPY_WRT(&completeSource, &_16$$18);
				} else {
					ZEPHIR_INIT_NVAR(&_17$$19);
					zephir_create_array(&_17$$19, 2, 0);
					zephir_array_fast_append(&_17$$19, &source);
					zephir_array_fast_append(&_17$$19, &__$null);
					ZEPHIR_CPY_WRT(&completeSource, &_17$$19);
				}
				ZEPHIR_OBS_NVAR(&alias);
				if (zephir_array_isset_string_fetch(&alias, &table, SL("alias"), 0)) {
					zephir_array_update_zval(&sqlAliases, &alias, &alias, PH_COPY | PH_SEPARATE);
	...
	if (Z_TYPE_P(&updateValues) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&updateValues), _18)
		{
			ZEPHIR_INIT_NVAR(&updateValue);
			ZVAL_COPY(&updateValue, _18);
			zephir_array_fetch_string(&_21$$24, &updateValue, SL("column"), PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 2329);
			if (notQuoting) {
				ZVAL_BOOL(&_22$$24, 1);
			} else {
				ZVAL_BOOL(&_22$$24, 0);
			}
			ZEPHIR_CALL_METHOD(&_20$$24, this_ptr, "_getexpression", &_23, 323, &_21$$24, &_22$$24);
			zephir_check_call_status();
			zephir_array_append(&sqlFields, &_20$$24, PH_SEPARATE, "phalcon/mvc/model/query.zep", 2329);
			ZEPHIR_OBS_NVAR(&exprColumn);
			zephir_array_fetch_string(&exprColumn, &updateValue, SL("expr"), PH_NOISY, "phalcon/mvc/model/query.zep", 2330);
			ZEPHIR_INIT_NVAR(&_24$$24);
			zephir_create_array(&_24$$24, 2, 0);
			ZEPHIR_OBS_NVAR(&_25$$24);
			zephir_array_fetch_string(&_25$$24, &exprColumn, SL("type"), PH_NOISY, "phalcon/mvc/model/query.zep", 2332);
			zephir_array_update_string(&_24$$24, SL("type"), &_25$$24, PH_COPY | PH_SEPARATE);
			if (notQuoting) {
				ZVAL_BOOL(&_27$$24, 1);
			} else {
				ZVAL_BOOL(&_27$$24, 0);
			}
			ZEPHIR_CALL_METHOD(&_26$$24, this_ptr, "_getexpression", &_23, 323, &exprColumn, &_27$$24);
			zephir_check_call_status();
			zephir_array_update_string(&_24$$24, SL("value"), &_26$$24, PH_COPY | PH_SEPARATE);
			zephir_array_append(&sqlValues, &_24$$24, PH_SEPARATE, "phalcon/mvc/model/query.zep", 2334);
		} ZEND_HASH_FOREACH_END();
	} else {
		ZEPHIR_CALL_METHOD(NULL, &updateValues, "rewind", NULL, 0);
		zephir_check_call_status();
		while (1) {
			ZEPHIR_CALL_METHOD(&_19, &updateValues, "valid", NULL, 0);
			zephir_check_call_status();
			if (!zend_is_true(&_19)) {
				break;
			}
			...
			zephir_check_call_status();
				zephir_array_fetch_string(&_29$$25, &updateValue, SL("column"), PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 2329);
				if (notQuoting) {
					ZVAL_BOOL(&_30$$25, 1);
				} else {
					ZVAL_BOOL(&_30$$25, 0);
				}
				ZEPHIR_CALL_METHOD(&_28$$25, this_ptr, "_getexpression", &_23, 323, &_29$$25, &_30$$25);
				zephir_check_call_status();
				zephir_array_append(&sqlFields, &_28$$25, PH_SEPARATE, "phalcon/mvc/model/query.zep", 2329);
				ZEPHIR_OBS_NVAR(&exprColumn);
				zephir_array_fetch_string(&exprColumn, &updateValue, SL("expr"), PH_NOISY, "phalcon/mvc/model/query.zep", 2330);
				ZEPHIR_INIT_NVAR(&_31$$25);
				zephir_create_array(&_31$$25, 2, 0);
				ZEPHIR_OBS_NVAR(&_32$$25);
				zephir_array_fetch_string(&_32$$25, &exprColumn, SL("type"), PH_NOISY, "phalcon/mvc/model/query.zep", 2332);
				zephir_array_update_string(&_31$$25, SL("type"), &_32$$25, PH_COPY | PH_SEPARATE);
				if (notQuoting) {
					ZVAL_BOOL(&_34$$25, 1);
				} else {
					ZVAL_BOOL(&_34$$25, 0);
				}
				ZEPHIR_CALL_METHOD(&_33$$25, this_ptr, "_getexpression", &_23, 323, &exprColumn, &_34$$25);
				zephir_check_call_status();
				zephir_array_update_string(&_31$$25, SL("value"), &_33$$25, PH_COPY | PH_SEPARATE);
				zephir_array_append(&sqlValues, &_31$$25, PH_SEPARATE, "phalcon/mvc/model/query.zep", 2334);
	...
	if (zephir_array_isset_string_fetch(&where, &ast, SL("where"), 0)) {
		ZVAL_BOOL(&_36$$26, 1);
		ZEPHIR_CALL_METHOD(&_35$$26, this_ptr, "_getexpression", &_23, 323, &where, &_36$$26);
		zephir_check_call_status();
		zephir_array_update_string(&sqlUpdate, SL("where"), &_35$$26, PH_COPY | PH_SEPARATE);
	}
	ZEPHIR_OBS_VAR(&limit);
	if (zephir_array_isset_string_fetch(&limit, &ast, SL("limit"), 0)) {
		ZEPHIR_CALL_METHOD(&_37$$27, this_ptr, "_getlimitclause", NULL, 337, &limit);
		zephir_check_call_status();
		zephir_array_update_string(&sqlUpdate, SL("limit"), &_37$$27, PH_COPY | PH_SEPARATE);
	}
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _prepareDelete) {
	...
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zval __$null, ast, delete, tables, models, modelsInstances, sqlTables, sqlModels, sqlAliases, sqlAliasesModelsInstances, deleteTables, manager, table, qualifiedName, modelName, nsAlias, realModelName, model, source, schema, completeSource, alias, sqlDelete, where, limit, *_0, _1, _2$$8, _3$$8, _5$$8, _6$$7, _8$$10, _9$$11, _10$$15, _11$$15, _13$$15, _14$$14, _16$$17, _17$$18, _18$$21, _19$$21, _20$$22;
	zephir_fcall_cache_entry *_4 = NULL, *_7 = NULL, *_12 = NULL, *_15 = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *this_ptr = getThis();
	...
	if (Z_TYPE_P(&deleteTables) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&deleteTables), _0)
		{
			...
			ZVAL_COPY(&table, _0);
			ZEPHIR_OBS_NVAR(&qualifiedName);
			zephir_array_fetch_string(&qualifiedName, &table, SL("qualifiedName"), PH_NOISY, "phalcon/mvc/model/query.zep", 2397);
			ZEPHIR_OBS_NVAR(&modelName);
			zephir_array_fetch_string(&modelName, &qualifiedName, SL("name"), PH_NOISY, "phalcon/mvc/model/query.zep", 2398);
			if (zephir_memnstr_str(&modelName, SL(":"), "phalcon/mvc/model/query.zep", 2403)) {
				ZEPHIR_INIT_NVAR(&nsAlias);
				zephir_fast_explode_str(&nsAlias, SL(":"), &modelName, LONG_MAX);
				zephir_array_fetch_long(&_3$$8, &nsAlias, 0, PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 2405);
				ZEPHIR_CALL_METHOD(&_2$$8, &manager, "getnamespacealias", &_4, 0, &_3$$8);
				zephir_check_call_status();
				zephir_array_fetch_long(&_5$$8, &nsAlias, 1, PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 2405);
				ZEPHIR_INIT_NVAR(&realModelName);
			...
			ZVAL_BOOL(&_6$$7, 1);
			ZEPHIR_CALL_METHOD(&model, &manager, "load", &_7, 0, &realModelName, &_6$$7);
			zephir_check_call_status();
			ZEPHIR_CALL_METHOD(&source, &model, "getsource", NULL, 0);
			zephir_check_call_status();
			ZEPHIR_CALL_METHOD(&schema, &model, "getschema", NULL, 0);
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				if (zephir_memnstr_str(&modelName, SL(":"), "phalcon/mvc/model/query.zep", 2403)) {
					ZEPHIR_INIT_NVAR(&nsAlias);
					zephir_fast_explode_str(&nsAlias, SL(":"), &modelName, LONG_MAX);
					zephir_array_fetch_long(&_11$$15, &nsAlias, 0, PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 2405);
					ZEPHIR_CALL_METHOD(&_10$$15, &manager, "getnamespacealias", &_12, 0, &_11$$15);
					zephir_check_call_status();
					zephir_array_fetch_long(&_13$$15, &nsAlias, 1, PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 2405);
					ZEPHIR_INIT_NVAR(&realModelName);
				...
				ZVAL_BOOL(&_14$$14, 1);
				ZEPHIR_CALL_METHOD(&model, &manager, "load", &_15, 0, &realModelName, &_14$$14);
				zephir_check_call_status();
				ZEPHIR_CALL_METHOD(&source, &model, "getsource", NULL, 0);
				zephir_check_call_status();
				ZEPHIR_CALL_METHOD(&schema, &model, "getschema", NULL, 0);
				...
				if (zephir_is_true(&schema)) {
					...
					zephir_create_array(&_16$$17, 2, 0);
					zephir_array_fast_append(&_16$$17, &source);
					zephir_array_fast_append(&_16$$17, &schema);
					ZEPHIR_CPY_WRT(&completeSource, &_16$$17);
				} else {
					ZEPHIR_INIT_NVAR(&_17$$18);
					zephir_create_array(&_17$$18, 2, 0);
					zephir_array_fast_append(&_17$$18, &source);
					zephir_array_fast_append(&_17$$18, &__$null);
					ZEPHIR_CPY_WRT(&completeSource, &_17$$18);
				}
				ZEPHIR_OBS_NVAR(&alias);
				if (zephir_array_isset_string_fetch(&alias, &table, SL("alias"), 0)) {
					zephir_array_update_zval(&sqlAliases, &alias, &alias, PH_COPY | PH_SEPARATE);
	...
	if (zephir_array_isset_string_fetch(&where, &ast, SL("where"), 0)) {
		ZVAL_BOOL(&_19$$21, 1);
		ZEPHIR_CALL_METHOD(&_18$$21, this_ptr, "_getexpression", NULL, 323, &where, &_19$$21);
		zephir_check_call_status();
		zephir_array_update_string(&sqlDelete, SL("where"), &_18$$21, PH_COPY | PH_SEPARATE);
	}
	ZEPHIR_OBS_VAR(&limit);
	if (zephir_array_isset_string_fetch(&limit, &ast, SL("limit"), 0)) {
		ZEPHIR_CALL_METHOD(&_20$$22, this_ptr, "_getlimitclause", NULL, 337, &limit);
		zephir_check_call_status();
		zephir_array_update_string(&sqlDelete, SL("limit"), &_20$$22, PH_COPY | PH_SEPARATE);
	}
...
PHP_METHOD(Phalcon_Mvc_Model_Query, parse) {
	...
	if (Z_TYPE_P(&ast) == IS_ARRAY) {
		...
		if (zephir_array_isset_string_fetch(&uniqueId, &ast, SL("id"), 0)) {
			...
			if (zephir_array_isset_fetch(&irPhql, &_0$$5, &uniqueId, 0)) {
				if (Z_TYPE_P(&irPhql) == IS_ARRAY) {
					zephir_array_fetch_string(&_1$$7, &ast, SL("type"), PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 2494);
		...
		if (zephir_array_isset_string_fetch(&type, &ast, SL("type"), 0)) {
			...
			do {
				...
				zephir_check_call_status();
				zephir_throw_exception_debug(&_2$$13, "phalcon/mvc/model/query.zep", 2527);
				ZEPHIR_MM_RESTORE();
				return;
			} while(0);
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _executeSelect) {
	...
	zend_class_entry *_101$$101;
	zval _26$$34, _28$$35, _35$$38, _36$$39, _47$$52, _49$$53, _56$$56, _57$$57, _80$$95, _82$$96, _88$$98, _90$$99;
	zend_string *_18, *_64$$64, *_70$$74, *_87$$97;
	zend_ulong _17, _63$$64, _69$$74, _86$$97;
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zephir_fcall_cache_entry *_4 = NULL, *_5 = NULL, *_9 = NULL, *_21 = NULL, *_22 = NULL, *_23 = NULL, *_31 = NULL, *_42 = NULL, *_43 = NULL, *_44 = NULL, *_52 = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS, numberObjects = 0;
	zend_bool simulate, haveObjects = 0, haveScalars = 0, isComplex = 0, isSimpleStd = 0, isKeepingSnapshots = 0, _75, _39$$28, _60$$46, _93$$87;
	zval *intermediate, intermediate_sub, *bindParams, bindParams_sub, *bindTypes, bindTypes_sub, *simulate_param = NULL, __$true, __$null, manager, modelName, models, model, connection, connectionTypes, columns, column, selectColumns, simpleColumnMap, metaData, aliasCopy, sqlColumn, attributes, instance, columnMap, attribute, columnAlias, sqlAlias, dialect, sqlSelect, bindCounts, processed, wildcard, value, processedTypes, typeWildcard, result, resultData, cache, resultObject, columns1, typesColumnMap, wildcardValue, resultsetClassName, *_0, _1, *_11, _12, *_15, _16, _73, _76, _2$$3, _3$$4, _6$$5, _7$$7, _8$$8, _10$$9, _13$$11, _14$$16, _19$$28, _20$$29, *_24$$31, _25$$31, _30$$31, _27$$34, _29$$35, _32$$36, *_33$$37, _34$$37, _37$$41, _38$$42, _40$$46, _41$$47, *_45$$49, _46$$49, _51$$49, _48$$52, _50$$53, _53$$54, *_54$$55, _55$$55, _58$$59, _59$$60, *_61$$64, _62$$64, _65$$68, _66$$72, *_67$$74, _68$$74, _71$$76, _72$$79, _74$$83, _77$$94, *_78$$94, _79$$94, _81$$95, _83$$96, *_84$$97, _85$$97, _89$$98, _91$$99, _92$$89, _103$$87, _94$$102, _95$$102, _96$$101, _97$$101, _100$$101, _102$$101, _98$$103, _99$$103;
	zval *this_ptr = getThis();
	...
	ZEPHIR_OBS_VAR(&models);
	zephir_array_fetch_string(&models, intermediate, SL("models"), PH_NOISY, "phalcon/mvc/model/query.zep", 2576);
	...
	if (Z_TYPE_P(&models) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&models), _0)
		{
			...
			if (!(zephir_array_isset_fetch(&model, &_2$$3, &modelName, 0))) {
				ZVAL_BOOL(&_3$$4, 1);
				ZEPHIR_CALL_METHOD(&model, &manager, "load", &_4, 0, &modelName, &_3$$4);
				zephir_check_call_status();
			...
			if (Z_TYPE_P(&connection) == IS_OBJECT) {
				...
				if (zephir_fast_count_int(&connectionTypes) == 2) {
		...
		while (1) {
			...
			zephir_check_call_status();
				ZEPHIR_OBS_NVAR(&model);
				zephir_read_property(&_7$$7, this_ptr, SL("_modelsInstances"), PH_NOISY_CC | PH_READONLY);
				if (!(zephir_array_isset_fetch(&model, &_7$$7, &modelName, 0))) {
					ZVAL_BOOL(&_8$$8, 1);
					ZEPHIR_CALL_METHOD(&model, &manager, "load", &_9, 0, &modelName, &_8$$8);
					zephir_check_call_status();
					zephir_update_property_array(this_ptr, SL("_modelsInstances"), &modelName, &model);
				}
				ZEPHIR_CALL_METHOD(&connection, this_ptr, "getreadconnection", &_5, 0, &model, intermediate, bindParams, bindTypes);
				zephir_check_call_status();
				if (Z_TYPE_P(&connection) == IS_OBJECT) {
					ZEPHIR_CALL_METHOD(&_10$$9, &connection, "gettype", NULL, 0);
					zephir_check_call_status();
					zephir_array_update_zval(&connectionTypes, &_10$$9, &__$true, PH_COPY | PH_SEPARATE);
					if (zephir_fast_count_int(&connectionTypes) == 2) {
						ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_model_exception_ce, "Cannot use models of different database systems in the same query", "phalcon/mvc/model/query.zep", 2592);
						return;
					}
	...
	ZEPHIR_INIT_NVAR(&modelName);
	ZEPHIR_OBS_VAR(&columns);
	zephir_array_fetch_string(&columns, intermediate, SL("columns"), PH_NOISY, "phalcon/mvc/model/query.zep", 2597);
	haveObjects = 0;
	haveScalars = 0;
	isComplex = 0;
	numberObjects = 0;
	...
	if (Z_TYPE_P(&columns) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&columns), _11)
		{
			ZEPHIR_INIT_NVAR(&column);
			ZVAL_COPY(&column, _11);
			...
			zephir_array_fetch_string(&_13$$11, &column, SL("type"), PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 2613);
			if (ZEPHIR_IS_STRING(&_13$$11, "scalar")) {
		...
		zephir_check_call_status();
		while (1) {
			ZEPHIR_CALL_METHOD(&_12, &columns, "valid", NULL, 0);
			zephir_check_call_status();
			if (!zend_is_true(&_12)) {
				break;
			}
			...
			zephir_check_call_status();
				...
				zephir_array_fetch_string(&_14$$16, &column, SL("type"), PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 2613);
				if (ZEPHIR_IS_STRING(&_14$$16, "scalar")) {
					if (!(zephir_array_isset_string(&column, SL("balias")))) {
						isComplex = 1;
					}
					haveScalars = 1;
	...
	if (Z_TYPE_P(&columns) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&columns), _17, _18, _15)
		{
			ZEPHIR_INIT_NVAR(&aliasCopy);
			if (_18 != NULL) { 
				ZVAL_STR_COPY(&aliasCopy, _18);
			} else {
				ZVAL_LONG(&aliasCopy, _17);
			}
			ZEPHIR_INIT_NVAR(&column);
			ZVAL_COPY(&column, _15);
			ZEPHIR_OBS_NVAR(&sqlColumn);
			zephir_array_fetch_string(&sqlColumn, &column, SL("column"), PH_NOISY, "phalcon/mvc/model/query.zep", 2648);
			zephir_array_fetch_string(&_19$$28, &column, SL("type"), PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 2651);
			if (ZEPHIR_IS_STRING(&_19$$28, "object")) {
				ZEPHIR_OBS_NVAR(&modelName);
				zephir_array_fetch_string(&modelName, &column, SL("model"), PH_NOISY, "phalcon/mvc/model/query.zep", 2653);
				ZEPHIR_OBS_NVAR(&instance);
				zephir_read_property(&_20$$29, this_ptr, SL("_modelsInstances"), PH_NOISY_CC | PH_READONLY);
				if (!(zephir_array_isset_fetch(&instance, &_20$$29, &modelName, 0))) {
					ZEPHIR_CALL_METHOD(&instance, &manager, "load", &_21, 0, &modelName);
					zephir_check_call_status();
					zephir_update_property_array(this_ptr, SL("_modelsInstances"), &modelName, &instance);
				}
				ZEPHIR_CALL_METHOD(&attributes, &metaData, "getattributes", &_22, 0, &instance);
				zephir_check_call_status();
				if (isComplex == 1) {
					if (ZEPHIR_GLOBAL(orm).column_renaming) {
						ZEPHIR_CALL_METHOD(&columnMap, &metaData, "getcolumnmap", &_23, 0, &instance);
						zephir_check_call_status();
					} else {
						ZEPHIR_INIT_NVAR(&columnMap);
						ZVAL_NULL(&columnMap);
					...
					if (Z_TYPE_P(&attributes) == IS_ARRAY) {
						ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&attributes), _24$$31)
						{
							ZEPHIR_INIT_NVAR(&attribute);
							ZVAL_COPY(&attribute, _24$$31);
							ZEPHIR_INIT_NVAR(&_26$$34);
							zephir_create_array(&_26$$34, 3, 0);
							zephir_array_fast_append(&_26$$34, &attribute);
							zephir_array_fast_append(&_26$$34, &sqlColumn);
							ZEPHIR_INIT_NVAR(&_27$$34);
							ZEPHIR_CONCAT_SVSV(&_27$$34, "_", &sqlColumn, "_", &attribute);
							zephir_array_fast_append(&_26$$34, &_27$$34);
							zephir_array_append(&selectColumns, &_26$$34, PH_SEPARATE, "phalcon/mvc/model/query.zep", 2675);
						} ZEND_HASH_FOREACH_END();
					} else {
						ZEPHIR_CALL_METHOD(NULL, &attributes, "rewind", NULL, 0);
						zephir_check_call_status();
						while (1) {
							ZEPHIR_CALL_METHOD(&_25$$31, &attributes, "valid", NULL, 0);
							zephir_check_call_status();
							if (!zend_is_true(&_25$$31)) {
								break;
							}
							ZEPHIR_CALL_METHOD(&attribute, &attributes, "current", NULL, 0);
							zephir_check_call_status();
								ZEPHIR_INIT_NVAR(&_28$$35);
								zephir_create_array(&_28$$35, 3, 0);
								zephir_array_fast_append(&_28$$35, &attribute);
								zephir_array_fast_append(&_28$$35, &sqlColumn);
								ZEPHIR_INIT_NVAR(&_29$$35);
								ZEPHIR_CONCAT_SVSV(&_29$$35, "_", &sqlColumn, "_", &attribute);
								zephir_array_fast_append(&_28$$35, &_29$$35);
								zephir_array_append(&selectColumns, &_28$$35, PH_SEPARATE, "phalcon/mvc/model/query.zep", 2675);
					...
					ZEPHIR_CALL_METHOD(&_30$$31, &manager, "iskeepingsnapshots", &_31, 0, &instance);
					zephir_check_call_status();
					isKeepingSnapshots = zephir_get_boolval(&_30$$31);
					if (isKeepingSnapshots) {
						ZEPHIR_INIT_NVAR(&_32$$36);
						ZVAL_BOOL(&_32$$36, isKeepingSnapshots);
						zephir_array_update_multi(&columns1, &_32$$36, SL("zs"), 3, &aliasCopy, SL("keepSnapshots"));
					}
				} else {
					zephir_is_iterable(&attributes, 0, "phalcon/mvc/model/query.zep", 2697);
					if (Z_TYPE_P(&attributes) == IS_ARRAY) {
						ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&attributes), _33$$37)
						{
							ZEPHIR_INIT_NVAR(&attribute);
							ZVAL_COPY(&attribute, _33$$37);
							ZEPHIR_INIT_NVAR(&_35$$38);
							zephir_create_array(&_35$$38, 2, 0);
							zephir_array_fast_append(&_35$$38, &attribute);
							zephir_array_fast_append(&_35$$38, &sqlColumn);
							zephir_array_append(&selectColumns, &_35$$38, PH_SEPARATE, "phalcon/mvc/model/query.zep", 2695);
						} ZEND_HASH_FOREACH_END();
					} else {
						ZEPHIR_CALL_METHOD(NULL, &attributes, "rewind", NULL, 0);
						zephir_check_call_status();
						while (1) {
							ZEPHIR_CALL_METHOD(&_34$$37, &attributes, "valid", NULL, 0);
							zephir_check_call_status();
							if (!zend_is_true(&_34$$37)) {
								break;
							}
							ZEPHIR_CALL_METHOD(&attribute, &attributes, "current", NULL, 0);
							zephir_check_call_status();
								ZEPHIR_INIT_NVAR(&_36$$39);
								zephir_create_array(&_36$$39, 2, 0);
								zephir_array_fast_append(&_36$$39, &attribute);
								zephir_array_fast_append(&_36$$39, &sqlColumn);
								zephir_array_append(&selectColumns, &_36$$39, PH_SEPARATE, "phalcon/mvc/model/query.zep", 2695);
							ZEPHIR_CALL_METHOD(NULL, &attributes, "next", NULL, 0);
							zephir_check_call_status();
						}
					}
				...
				if (Z_TYPE_P(&aliasCopy) == IS_LONG) {
					...
					zephir_create_array(&_37$$41, 2, 0);
					zephir_array_fast_append(&_37$$41, &sqlColumn);
					zephir_array_fast_append(&_37$$41, &__$null);
					ZEPHIR_CPY_WRT(&columnAlias, &_37$$41);
				} else {
					ZEPHIR_INIT_NVAR(&_38$$42);
					zephir_create_array(&_38$$42, 3, 0);
					zephir_array_fast_append(&_38$$42, &sqlColumn);
					zephir_array_fast_append(&_38$$42, &__$null);
					zephir_array_fast_append(&_38$$42, &aliasCopy);
					ZEPHIR_CPY_WRT(&columnAlias, &_38$$42);
				}
				zephir_array_append(&selectColumns, &columnAlias, PH_SEPARATE, "phalcon/mvc/model/query.zep", 2708);
			}
			_39$$28 = isComplex == 0;
			if (_39$$28) {
				_39$$28 = isSimpleStd == 1;
			}
			if (_39$$28) {
		...
		zephir_check_call_status();
		while (1) {
			ZEPHIR_CALL_METHOD(&_16, &columns, "valid", NULL, 0);
			zephir_check_call_status();
			if (!zend_is_true(&_16)) {
				break;
			}
			...
			zephir_check_call_status();
				ZEPHIR_OBS_NVAR(&sqlColumn);
				zephir_array_fetch_string(&sqlColumn, &column, SL("column"), PH_NOISY, "phalcon/mvc/model/query.zep", 2648);
				zephir_array_fetch_string(&_40$$46, &column, SL("type"), PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 2651);
				if (ZEPHIR_IS_STRING(&_40$$46, "object")) {
					ZEPHIR_OBS_NVAR(&modelName);
					zephir_array_fetch_string(&modelName, &column, SL("model"), PH_NOISY, "phalcon/mvc/model/query.zep", 2653);
					ZEPHIR_OBS_NVAR(&instance);
					zephir_read_property(&_41$$47, this_ptr, SL("_modelsInstances"), PH_NOISY_CC | PH_READONLY);
					if (!(zephir_array_isset_fetch(&instance, &_41$$47, &modelName, 0))) {
						ZEPHIR_CALL_METHOD(&instance, &manager, "load", &_42, 0, &modelName);
						zephir_check_call_status();
						zephir_update_property_array(this_ptr, SL("_modelsInstances"), &modelName, &instance);
					}
					ZEPHIR_CALL_METHOD(&attributes, &metaData, "getattributes", &_43, 0, &instance);
					zephir_check_call_status();
					if (isComplex == 1) {
						if (ZEPHIR_GLOBAL(orm).column_renaming) {
							ZEPHIR_CALL_METHOD(&columnMap, &metaData, "getcolumnmap", &_44, 0, &instance);
							zephir_check_call_status();
						} else {
							ZEPHIR_INIT_NVAR(&columnMap);
							ZVAL_NULL(&columnMap);
						...
						zephir_is_iterable(&attributes, 0, "phalcon/mvc/model/query.zep", 2679);
						if (Z_TYPE_P(&attributes) == IS_ARRAY) {
							ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&attributes), _45$$49)
							{
								ZEPHIR_INIT_NVAR(&attribute);
								ZVAL_COPY(&attribute, _45$$49);
								ZEPHIR_INIT_NVAR(&_47$$52);
								zephir_create_array(&_47$$52, 3, 0);
								zephir_array_fast_append(&_47$$52, &attribute);
								zephir_array_fast_append(&_47$$52, &sqlColumn);
								ZEPHIR_INIT_NVAR(&_48$$52);
								ZEPHIR_CONCAT_SVSV(&_48$$52, "_", &sqlColumn, "_", &attribute);
								zephir_array_fast_append(&_47$$52, &_48$$52);
								zephir_array_append(&selectColumns, &_47$$52, PH_SEPARATE, "phalcon/mvc/model/query.zep", 2675);
							} ZEND_HASH_FOREACH_END();
						} else {
							ZEPHIR_CALL_METHOD(NULL, &attributes, "rewind", NULL, 0);
							zephir_check_call_status();
							while (1) {
								ZEPHIR_CALL_METHOD(&_46$$49, &attributes, "valid", NULL, 0);
								zephir_check_call_status();
								if (!zend_is_true(&_46$$49)) {
									break;
								}
								ZEPHIR_CALL_METHOD(&attribute, &attributes, "current", NULL, 0);
								zephir_check_call_status();
									ZEPHIR_INIT_NVAR(&_49$$53);
									zephir_create_array(&_49$$53, 3, 0);
									zephir_array_fast_append(&_49$$53, &attribute);
									zephir_array_fast_append(&_49$$53, &sqlColumn);
									ZEPHIR_INIT_NVAR(&_50$$53);
									ZEPHIR_CONCAT_SVSV(&_50$$53, "_", &sqlColumn, "_", &attribute);
									zephir_array_fast_append(&_49$$53, &_50$$53);
									zephir_array_append(&selectColumns, &_49$$53, PH_SEPARATE, "phalcon/mvc/model/query.zep", 2675);
								ZEPHIR_CALL_METHOD(NULL, &attributes, "next", NULL, 0);
								zephir_check_call_status();
							}
						}
						...
						zephir_array_update_multi(&columns1, &attributes, SL("zs"), 3, &aliasCopy, SL("attributes"));
						zephir_array_update_multi(&columns1, &columnMap, SL("zs"), 3, &aliasCopy, SL("columnMap"));
						ZEPHIR_CALL_METHOD(&_51$$49, &manager, "iskeepingsnapshots", &_52, 0, &instance);
						zephir_check_call_status();
						isKeepingSnapshots = zephir_get_boolval(&_51$$49);
						if (isKeepingSnapshots) {
							ZEPHIR_INIT_NVAR(&_53$$54);
							ZVAL_BOOL(&_53$$54, isKeepingSnapshots);
							zephir_array_update_multi(&columns1, &_53$$54, SL("zs"), 3, &aliasCopy, SL("keepSnapshots"));
						}
					} else {
						zephir_is_iterable(&attributes, 0, "phalcon/mvc/model/query.zep", 2697);
						if (Z_TYPE_P(&attributes) == IS_ARRAY) {
							ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&attributes), _54$$55)
							{
								ZEPHIR_INIT_NVAR(&attribute);
								ZVAL_COPY(&attribute, _54$$55);
								ZEPHIR_INIT_NVAR(&_56$$56);
								zephir_create_array(&_56$$56, 2, 0);
								zephir_array_fast_append(&_56$$56, &attribute);
								zephir_array_fast_append(&_56$$56, &sqlColumn);
								zephir_array_append(&selectColumns, &_56$$56, PH_SEPARATE, "phalcon/mvc/model/query.zep", 2695);
							} ZEND_HASH_FOREACH_END();
						} else {
							ZEPHIR_CALL_METHOD(NULL, &attributes, "rewind", NULL, 0);
							zephir_check_call_status();
							while (1) {
								ZEPHIR_CALL_METHOD(&_55$$55, &attributes, "valid", NULL, 0);
								zephir_check_call_status();
								if (!zend_is_true(&_55$$55)) {
									break;
								}
								ZEPHIR_CALL_METHOD(&attribute, &attributes, "current", NULL, 0);
								zephir_check_call_status();
									ZEPHIR_INIT_NVAR(&_57$$57);
									zephir_create_array(&_57$$57, 2, 0);
									zephir_array_fast_append(&_57$$57, &attribute);
									zephir_array_fast_append(&_57$$57, &sqlColumn);
									zephir_array_append(&selectColumns, &_57$$57, PH_SEPARATE, "phalcon/mvc/model/query.zep", 2695);
								ZEPHIR_CALL_METHOD(NULL, &attributes, "next", NULL, 0);
								zephir_check_call_status();
							}
						}
					...
					if (Z_TYPE_P(&aliasCopy) == IS_LONG) {
						ZEPHIR_INIT_NVAR(&_58$$59);
						zephir_create_array(&_58$$59, 2, 0);
						zephir_array_fast_append(&_58$$59, &sqlColumn);
						zephir_array_fast_append(&_58$$59, &__$null);
						ZEPHIR_CPY_WRT(&columnAlias, &_58$$59);
					} else {
						ZEPHIR_INIT_NVAR(&_59$$60);
						zephir_create_array(&_59$$60, 3, 0);
						zephir_array_fast_append(&_59$$60, &sqlColumn);
						zephir_array_fast_append(&_59$$60, &__$null);
						zephir_array_fast_append(&_59$$60, &aliasCopy);
						ZEPHIR_CPY_WRT(&columnAlias, &_59$$60);
					}
					zephir_array_append(&selectColumns, &columnAlias, PH_SEPARATE, "phalcon/mvc/model/query.zep", 2708);
				}
				_60$$46 = isComplex == 0;
				if (_60$$46) {
					_60$$46 = isSimpleStd == 1;
				}
				if (_60$$46) {
					ZEPHIR_OBS_NVAR(&sqlAlias);
					if (zephir_array_isset_string_fetch(&sqlAlias, &column, SL("sqlAlias"), 0)) {
	...
	if (Z_TYPE_P(bindParams) == IS_ARRAY) {
		...
		if (Z_TYPE_P(bindParams) == IS_ARRAY) {
			ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(bindParams), _63$$64, _64$$64, _61$$64)
			{
				ZEPHIR_INIT_NVAR(&wildcard);
				if (_64$$64 != NULL) { 
					ZVAL_STR_COPY(&wildcard, _64$$64);
				} else {
					ZVAL_LONG(&wildcard, _63$$64);
				}
				ZEPHIR_INIT_NVAR(&value);
				ZVAL_COPY(&value, _61$$64);
				...
				if (Z_TYPE_P(&value) == IS_ARRAY) {
					ZEPHIR_INIT_NVAR(&_65$$68);
					ZVAL_LONG(&_65$$68, zephir_fast_count_int(&value));
					zephir_array_update_zval(&bindCounts, &wildcardValue, &_65$$68, PH_COPY | PH_SEPARATE);
				}
			} ZEND_HASH_FOREACH_END();
		} else {
			...
			zephir_check_call_status();
			while (1) {
				ZEPHIR_CALL_METHOD(&_62$$64, bindParams, "valid", NULL, 0);
				zephir_check_call_status();
				if (!zend_is_true(&_62$$64)) {
					break;
				}
				...
				zephir_check_call_status();
					...
					zephir_array_update_zval(&processed, &wildcardValue, &value, PH_COPY | PH_SEPARATE);
					if (Z_TYPE_P(&value) == IS_ARRAY) {
						ZEPHIR_INIT_NVAR(&_66$$72);
						ZVAL_LONG(&_66$$72, zephir_fast_count_int(&value));
						zephir_array_update_zval(&bindCounts, &wildcardValue, &_66$$72, PH_COPY | PH_SEPARATE);
					}
	...
	if (Z_TYPE_P(bindTypes) == IS_ARRAY) {
		...
		if (Z_TYPE_P(bindTypes) == IS_ARRAY) {
			ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(bindTypes), _69$$74, _70$$74, _67$$74)
			{
				ZEPHIR_INIT_NVAR(&typeWildcard);
				if (_70$$74 != NULL) { 
					ZVAL_STR_COPY(&typeWildcard, _70$$74);
				} else {
					ZVAL_LONG(&typeWildcard, _69$$74);
				}
				ZEPHIR_INIT_NVAR(&value);
				ZVAL_COPY(&value, _67$$74);
			...
			zephir_check_call_status();
			while (1) {
				ZEPHIR_CALL_METHOD(&_68$$74, bindTypes, "valid", NULL, 0);
				zephir_check_call_status();
				if (!zend_is_true(&_68$$74)) {
					break;
				}
				...
				zephir_check_call_status();
					if (Z_TYPE_P(&typeWildcard) == IS_LONG) {
						ZEPHIR_INIT_NVAR(&_72$$79);
						ZEPHIR_CONCAT_SV(&_72$$79, ":", &typeWildcard);
						zephir_array_update_zval(&processedTypes, &_72$$79, &value, PH_COPY | PH_SEPARATE);
					} else {
						zephir_array_update_zval(&processedTypes, &typeWildcard, &value, PH_COPY | PH_SEPARATE);
					}
	...
	zephir_check_call_status();
	zephir_read_property(&_73, this_ptr, SL("_sharedLock"), PH_NOISY_CC | PH_READONLY);
	if (zephir_is_true(&_73)) {
		ZEPHIR_CALL_METHOD(&_74$$83, &dialect, "sharedlock", NULL, 0, &sqlSelect);
		zephir_check_call_status();
		ZEPHIR_CPY_WRT(&sqlSelect, &_74$$83);
	}
	if (simulate) {
		zephir_create_array(return_value, 3, 0);
	...
	zephir_check_call_status();
	_75 = zephir_instance_of_ev(&result, phalcon_db_resultinterface_ce);
	if (_75) {
		ZEPHIR_CALL_METHOD(&_76, &result, "numrows", NULL, 0);
		zephir_check_call_status();
		_75 = zephir_is_true(&_76);
	}
	if (_75) {
	...
	if (isComplex == 0) {
		if (isSimpleStd == 1) {
			...
			if (!(ZEPHIR_GLOBAL(orm).cast_on_hydrate)) {
				...
				if (Z_TYPE_P(&columnMap) == IS_NULL) {
					array_init(&simpleColumnMap);
					ZEPHIR_CALL_METHOD(&_77$$94, &metaData, "getattributes", NULL, 0, &resultObject);
					zephir_check_call_status();
					zephir_is_iterable(&_77$$94, 0, "phalcon/mvc/model/query.zep", 2846);
					if (Z_TYPE_P(&_77$$94) == IS_ARRAY) {
						ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_77$$94), _78$$94)
						{
							ZEPHIR_INIT_NVAR(&attribute);
							ZVAL_COPY(&attribute, _78$$94);
							ZEPHIR_INIT_NVAR(&_80$$95);
							zephir_create_array(&_80$$95, 2, 0);
							zephir_array_fast_append(&_80$$95, &attribute);
							ZEPHIR_OBS_NVAR(&_81$$95);
							zephir_array_fetch(&_81$$95, &typesColumnMap, &attribute, PH_NOISY, "phalcon/mvc/model/query.zep", 2844);
							zephir_array_fast_append(&_80$$95, &_81$$95);
							zephir_array_update_zval(&simpleColumnMap, &attribute, &_80$$95, PH_COPY | PH_SEPARATE);
						} ZEND_HASH_FOREACH_END();
					} else {
						ZEPHIR_CALL_METHOD(NULL, &_77$$94, "rewind", NULL, 0);
						zephir_check_call_status();
						while (1) {
							ZEPHIR_CALL_METHOD(&_79$$94, &_77$$94, "valid", NULL, 0);
							zephir_check_call_status();
							if (!zend_is_true(&_79$$94)) {
								break;
							}
							ZEPHIR_CALL_METHOD(&attribute, &_77$$94, "current", NULL, 0);
							zephir_check_call_status();
								ZEPHIR_INIT_NVAR(&_82$$96);
								zephir_create_array(&_82$$96, 2, 0);
								zephir_array_fast_append(&_82$$96, &attribute);
								ZEPHIR_OBS_NVAR(&_83$$96);
								zephir_array_fetch(&_83$$96, &typesColumnMap, &attribute, PH_NOISY, "phalcon/mvc/model/query.zep", 2844);
								zephir_array_fast_append(&_82$$96, &_83$$96);
								zephir_array_update_zval(&simpleColumnMap, &attribute, &_82$$96, PH_COPY | PH_SEPARATE);
							ZEPHIR_CALL_METHOD(NULL, &_77$$94, "next", NULL, 0);
							zephir_check_call_status();
						}
					}
					ZEPHIR_INIT_NVAR(&attribute);
					...
					if (Z_TYPE_P(&columnMap) == IS_ARRAY) {
						ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&columnMap), _86$$97, _87$$97, _84$$97)
						{
							ZEPHIR_INIT_NVAR(&column);
							if (_87$$97 != NULL) { 
								ZVAL_STR_COPY(&column, _87$$97);
							} else {
								ZVAL_LONG(&column, _86$$97);
							}
							ZEPHIR_INIT_NVAR(&attribute);
							ZVAL_COPY(&attribute, _84$$97);
							ZEPHIR_INIT_NVAR(&_88$$98);
							zephir_create_array(&_88$$98, 2, 0);
							zephir_array_fast_append(&_88$$98, &attribute);
							ZEPHIR_OBS_NVAR(&_89$$98);
							zephir_array_fetch(&_89$$98, &typesColumnMap, &column, PH_NOISY, "phalcon/mvc/model/query.zep", 2849);
							zephir_array_fast_append(&_88$$98, &_89$$98);
							zephir_array_update_zval(&simpleColumnMap, &column, &_88$$98, PH_COPY | PH_SEPARATE);
						} ZEND_HASH_FOREACH_END();
					} else {
						ZEPHIR_CALL_METHOD(NULL, &columnMap, "rewind", NULL, 0);
						zephir_check_call_status();
						while (1) {
							ZEPHIR_CALL_METHOD(&_85$$97, &columnMap, "valid", NULL, 0);
							zephir_check_call_status();
							if (!zend_is_true(&_85$$97)) {
								break;
							}
							...
							zephir_check_call_status();
								ZEPHIR_INIT_NVAR(&_90$$99);
								zephir_create_array(&_90$$99, 2, 0);
								zephir_array_fast_append(&_90$$99, &attribute);
								ZEPHIR_OBS_NVAR(&_91$$99);
								zephir_array_fetch(&_91$$99, &typesColumnMap, &column, PH_NOISY, "phalcon/mvc/model/query.zep", 2849);
								zephir_array_fast_append(&_90$$99, &_91$$99);
								zephir_array_update_zval(&simpleColumnMap, &column, &_90$$99, PH_COPY | PH_SEPARATE);
			...
			ZEPHIR_CALL_METHOD(&_92$$89, &manager, "iskeepingsnapshots", NULL, 0, &resultObject);
			zephir_check_call_status();
			isKeepingSnapshots = zephir_get_boolval(&_92$$89);
		}
		_93$$87 = zephir_instance_of_ev(&resultObject, phalcon_mvc_modelinterface_ce);
		if (_93$$87) {
			_93$$87 = (zephir_method_exists_ex(&resultObject, ZEND_STRL("getresultsetclass")) == SUCCESS);
		}
		if (_93$$87) {
			ZEPHIR_CALL_METHOD(&resultsetClassName, &resultObject, "getresultsetclass", NULL, 0);
			zephir_check_call_status();
			if (zephir_is_true(&resultsetClassName)) {
				if (!(zephir_class_exists(&resultsetClassName, 1))) {
					ZEPHIR_INIT_VAR(&_94$$102);
					object_init_ex(&_94$$102, phalcon_mvc_model_exception_ce);
					ZEPHIR_INIT_VAR(&_95$$102);
					ZEPHIR_CONCAT_SVS(&_95$$102, "Resultset class \"", &resultsetClassName, "\" not found");
					ZEPHIR_CALL_METHOD(NULL, &_94$$102, "__construct", NULL, 4, &_95$$102);
					zephir_check_call_status();
					zephir_throw_exception_debug(&_94$$102, "phalcon/mvc/model/query.zep", 2865);
					ZEPHIR_MM_RESTORE();
					return;
				}
				ZEPHIR_INIT_VAR(&_96$$101);
				ZVAL_STRING(&_96$$101, "Phalcon\\Mvc\\Model\\ResultsetInterface");
				ZEPHIR_CALL_FUNCTION(&_97$$101, "is_subclass_of", NULL, 313, &resultsetClassName, &_96$$101);
				zephir_check_call_status();
				if (!(zephir_is_true(&_97$$101))) {
					ZEPHIR_INIT_VAR(&_98$$103);
					object_init_ex(&_98$$103, phalcon_mvc_model_exception_ce);
					ZEPHIR_INIT_VAR(&_99$$103);
					ZEPHIR_CONCAT_SVS(&_99$$103, "Resultset class \"", &resultsetClassName, "\" must be an implementation of Phalcon\\Mvc\\Model\\ResultsetInterface");
					ZEPHIR_CALL_METHOD(NULL, &_98$$103, "__construct", NULL, 4, &_99$$103);
					zephir_check_call_status();
					zephir_throw_exception_debug(&_98$$103, "phalcon/mvc/model/query.zep", 2869);
					ZEPHIR_MM_RESTORE();
					return;
				}
				zephir_fetch_safe_class(&_100$$101, &resultsetClassName);
				_101$$101 = zephir_fetch_class_str_ex(Z_STRVAL_P(&_100$$101), Z_STRLEN_P(&_100$$101), ZEND_FETCH_CLASS_AUTO);
				if(!_101$$101) {
					RETURN_MM_NULL();
				}
				object_init_ex(return_value, _101$$101);
				if (zephir_has_constructor(return_value)) {
					if (isKeepingSnapshots) {
						ZVAL_BOOL(&_102$$101, 1);
					} else {
						ZVAL_BOOL(&_102$$101, 0);
					}
					ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 0, &simpleColumnMap, &resultObject, &resultData, &cache, &_102$$101);
					zephir_check_call_status();
				}
				RETURN_MM();
			}
		...
		ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 341, &simpleColumnMap, &resultObject, &resultData, &cache, &_103$$87);
		zephir_check_call_status();
		RETURN_MM();
	}
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _executeInsert) {
	...
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zephir_fcall_cache_entry *_7 = NULL, *_9 = NULL, *_14 = NULL, *_16 = NULL, *_17 = NULL, *_21 = NULL, *_23 = NULL, *_29 = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *intermediate, intermediate_sub, *bindParams, bindParams_sub, *bindTypes, bindTypes_sub, modelName, manager, connection, metaData, attributes, fields, columnMap, dialect, insertValues, number, value, model, values, exprValue, insertValue, wildcard, fieldName, attributeName, insertModel, _0, *_2, _3, _32, _33, _1$$3, _6$$8, _8$$11, _10$$11, _11$$11, _12$$13, _13$$13, _15$$14, _18$$17, _19$$17, _20$$20, _22$$23, _24$$23, _25$$23, _26$$25, _27$$25, _28$$26, _30$$29, _31$$29;
	zval *this_ptr = getThis();
	...
	ZEPHIR_OBS_VAR(&modelName);
	zephir_array_fetch_string(&modelName, intermediate, SL("model"), PH_NOISY, "phalcon/mvc/model/query.zep", 2904);
	ZEPHIR_OBS_VAR(&manager);
	zephir_read_property(&manager, this_ptr, SL("_manager"), PH_NOISY_CC);
	ZEPHIR_OBS_VAR(&model);
	...
	ZEPHIR_OBS_VAR(&values);
	zephir_array_fetch_string(&values, intermediate, SL("values"), PH_NOISY, "phalcon/mvc/model/query.zep", 2930);
	if (zephir_fast_count_int(&fields) != zephir_fast_count_int(&values)) {
	...
	if (Z_TYPE_P(&values) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&values), _4, _5, _2)
		{
			...
			zephir_array_fetch_string(&exprValue, &value, SL("value"), PH_NOISY, "phalcon/mvc/model/query.zep", 2947);
			zephir_array_fetch_string(&_6$$8, &value, SL("type"), PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 2948);
			do {
				...
				if (ZEPHIR_IS_LONG(&_6$$8, 273) || ZEPHIR_IS_LONG(&_6$$8, 274) || ZEPHIR_IS_LONG(&_6$$8, 277)) {
					...
					if (!(zephir_array_isset_fetch(&insertValue, bindParams, &wildcard, 0))) {
						ZEPHIR_INIT_NVAR(&_12$$13);
						...
						zephir_check_call_status();
						zephir_throw_exception_debug(&_12$$13, "phalcon/mvc/model/query.zep", 2972);
						ZEPHIR_MM_RESTORE();
						return;
					}
					break;
				...
				zephir_check_call_status();
				ZEPHIR_CALL_METHOD(NULL, &insertValue, "__construct", &_17, 21, &_15$$14);
				zephir_check_call_status();
				break;
			} while(0);

			ZEPHIR_OBS_NVAR(&fieldName);
			zephir_array_fetch(&fieldName, &fields, &number, PH_NOISY, "phalcon/mvc/model/query.zep", 2982);
			if (automaticFields == 1) {
				if (Z_TYPE_P(&columnMap) == IS_ARRAY) {
					ZEPHIR_OBS_NVAR(&attributeName);
					if (!(zephir_array_isset_fetch(&attributeName, &columnMap, &fieldName, 0))) {
						ZEPHIR_INIT_NVAR(&_18$$17);
						object_init_ex(&_18$$17, phalcon_mvc_model_exception_ce);
						ZEPHIR_INIT_NVAR(&_19$$17);
						ZEPHIR_CONCAT_SVS(&_19$$17, "Column '", &fieldName, "' isn't part of the column map");
						ZEPHIR_CALL_METHOD(NULL, &_18$$17, "__construct", &_14, 4, &_19$$17);
						zephir_check_call_status();
						zephir_throw_exception_debug(&_18$$17, "phalcon/mvc/model/query.zep", 2990);
						ZEPHIR_MM_RESTORE();
						return;
					}
				} else {
		...
		while (1) {
			...
			zephir_check_call_status();
				ZEPHIR_OBS_NVAR(&exprValue);
				zephir_array_fetch_string(&exprValue, &value, SL("value"), PH_NOISY, "phalcon/mvc/model/query.zep", 2947);
				zephir_array_fetch_string(&_20$$20, &value, SL("type"), PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 2948);
				do {
					if (ZEPHIR_IS_LONG(&_20$$20, 260) || ZEPHIR_IS_LONG(&_20$$20, 258) || ZEPHIR_IS_LONG(&_20$$20, 259)) {
						ZEPHIR_CALL_METHOD(&insertValue, &dialect, "getsqlexpression", &_21, 0, &exprValue);
						zephir_check_call_status();
						break;
					}
					if (ZEPHIR_IS_LONG(&_20$$20, 322)) {
						ZEPHIR_INIT_NVAR(&insertValue);
						ZVAL_NULL(&insertValue);
						break;
					}
					if (ZEPHIR_IS_LONG(&_20$$20, 273) || ZEPHIR_IS_LONG(&_20$$20, 274) || ZEPHIR_IS_LONG(&_20$$20, 277)) {
						if (Z_TYPE_P(bindParams) != IS_ARRAY) {
							ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_model_exception_ce, "Bound parameter cannot be replaced because placeholders is not an array", "phalcon/mvc/model/query.zep", 2965);
							return;
						}
						ZEPHIR_CALL_METHOD(&_22$$23, &dialect, "getsqlexpression", &_23, 0, &exprValue);
						zephir_check_call_status();
						...
						ZVAL_STRING(&_25$$23, "");
						ZEPHIR_INIT_NVAR(&wildcard);
						zephir_fast_str_replace(&wildcard, &_24$$23, &_25$$23, &_22$$23);
						ZEPHIR_OBS_NVAR(&insertValue);
						if (!(zephir_array_isset_fetch(&insertValue, bindParams, &wildcard, 0))) {
							ZEPHIR_INIT_NVAR(&_26$$25);
							object_init_ex(&_26$$25, phalcon_mvc_model_exception_ce);
							ZEPHIR_INIT_NVAR(&_27$$25);
							ZEPHIR_CONCAT_SVS(&_27$$25, "Bound parameter '", &wildcard, "' cannot be replaced because it isn't in the placeholders list");
							ZEPHIR_CALL_METHOD(NULL, &_26$$25, "__construct", &_14, 4, &_27$$25);
							zephir_check_call_status();
							zephir_throw_exception_debug(&_26$$25, "phalcon/mvc/model/query.zep", 2972);
							ZEPHIR_MM_RESTORE();
							return;
						}
						break;
					...
					ZEPHIR_INIT_NVAR(&insertValue);
					object_init_ex(&insertValue, phalcon_db_rawvalue_ce);
					ZEPHIR_CALL_METHOD(&_28$$26, &dialect, "getsqlexpression", &_29, 0, &exprValue);
					zephir_check_call_status();
					ZEPHIR_CALL_METHOD(NULL, &insertValue, "__construct", &_17, 21, &_28$$26);
					zephir_check_call_status();
					break;
				} while(0);
				...
				if (automaticFields == 1) {
					if (Z_TYPE_P(&columnMap) == IS_ARRAY) {
						...
						if (!(zephir_array_isset_fetch(&attributeName, &columnMap, &fieldName, 0))) {
							...
							ZEPHIR_CONCAT_SVS(&_31$$29, "Column '", &fieldName, "' isn't part of the column map");
							ZEPHIR_CALL_METHOD(NULL, &_30$$29, "__construct", &_14, 4, &_31$$29);
							zephir_check_call_status();
							zephir_throw_exception_debug(&_30$$29, "phalcon/mvc/model/query.zep", 2990);
							ZEPHIR_MM_RESTORE();
							return;
						}
					} else {
	...
	ZEPHIR_INIT_NVAR(&value);
	ZEPHIR_INIT_NVAR(&number);
	ZEPHIR_CALL_METHOD(&_32, &manager, "load", NULL, 0, &modelName);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&insertModel);
	if (zephir_clone(&insertModel, &_32) == FAILURE) {
		RETURN_MM();
	}
	object_init_ex(return_value, phalcon_mvc_model_query_status_ce);
	ZEPHIR_CALL_METHOD(&_33, &insertModel, "create", NULL, 0, &insertValues);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 343, &_33, &insertModel);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _executeUpdate) {
	...
	ZEPHIR_OBS_VAR(&models);
	zephir_array_fetch_string(&models, intermediate, SL("models"), PH_NOISY, "phalcon/mvc/model/query.zep", 3030);
	...
	ZEPHIR_OBS_VAR(&modelName);
	zephir_array_fetch_long(&modelName, &models, 0, PH_NOISY, "phalcon/mvc/model/query.zep", 3036);
	ZEPHIR_OBS_VAR(&model);
	zephir_read_property(&_0, this_ptr, SL("_modelsInstances"), PH_NOISY_CC | PH_READONLY);
	if (!(zephir_array_isset_fetch(&model, &_0, &modelName, 0))) {
	...
	zephir_check_call_status();
	ZEPHIR_OBS_VAR(&fields);
	zephir_array_fetch_string(&fields, intermediate, SL("fields"), PH_NOISY, "phalcon/mvc/model/query.zep", 3049);
	ZEPHIR_OBS_VAR(&values);
	zephir_array_fetch_string(&values, intermediate, SL("values"), PH_NOISY, "phalcon/mvc/model/query.zep", 3050);
	ZEPHIR_INIT_VAR(&updateValues);
	...
	if (Z_TYPE_P(&fields) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&fields), _4, _5, _2)
		{
			...
			ZVAL_COPY(&field, _2);
			ZEPHIR_OBS_NVAR(&value);
			zephir_array_fetch(&value, &values, &number, PH_NOISY, "phalcon/mvc/model/query.zep", 3065);
			ZEPHIR_OBS_NVAR(&exprValue);
			zephir_array_fetch_string(&exprValue, &value, SL("value"), PH_NOISY, "phalcon/mvc/model/query.zep", 3066);
			if (zephir_array_isset_string(&field, SL("balias"))) {
				ZEPHIR_OBS_NVAR(&fieldName);
				zephir_array_fetch_string(&fieldName, &field, SL("balias"), PH_NOISY, "phalcon/mvc/model/query.zep", 3069);
			} else {
				ZEPHIR_OBS_NVAR(&fieldName);
				zephir_array_fetch_string(&fieldName, &field, SL("name"), PH_NOISY, "phalcon/mvc/model/query.zep", 3071);
			}
			zephir_array_fetch_string(&_6$$5, &value, SL("type"), PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 3074);
			do {
				...
				if (ZEPHIR_IS_LONG(&_6$$5, 273) || ZEPHIR_IS_LONG(&_6$$5, 274) || ZEPHIR_IS_LONG(&_6$$5, 277)) {
					...
					if (zephir_array_isset_fetch(&updateValue, bindParams, &wildcard, 0)) {
						...
						ZEPHIR_CALL_METHOD(NULL, &_12$$13, "__construct", &_14, 4, &_13$$13);
						zephir_check_call_status();
						zephir_throw_exception_debug(&_12$$13, "phalcon/mvc/model/query.zep", 3101);
						ZEPHIR_MM_RESTORE();
						return;
					}
					break;
				...
				zephir_check_call_status();
				ZEPHIR_CALL_METHOD(NULL, &updateValue, "__construct", &_17, 21, &_15$$15);
				zephir_check_call_status();
				break;
			} while(0);
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				zephir_array_fetch_string(&_18$$16, &value, SL("type"), PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 3074);
				do {
					...
					if (ZEPHIR_IS_LONG(&_18$$16, 273) || ZEPHIR_IS_LONG(&_18$$16, 274) || ZEPHIR_IS_LONG(&_18$$16, 277)) {
						...
						ZVAL_STRING(&_23$$21, "");
						ZEPHIR_INIT_NVAR(&wildcard);
						zephir_fast_str_replace(&wildcard, &_22$$21, &_23$$21, &_20$$21);
						ZEPHIR_OBS_NVAR(&updateValue);
						if (zephir_array_isset_fetch(&updateValue, bindParams, &wildcard, 0)) {
							zephir_array_unset(&selectBindParams, &wildcard, PH_SEPARATE);
							zephir_array_unset(&selectBindTypes, &wildcard, PH_SEPARATE);
							...
							zephir_check_call_status();
							zephir_throw_exception_debug(&_24$$24, "phalcon/mvc/model/query.zep", 3101);
							ZEPHIR_MM_RESTORE();
							return;
						}
						break;
					...
					zephir_check_call_status();
					ZEPHIR_CALL_METHOD(NULL, &updateValue, "__construct", &_17, 21, &_26$$26);
					zephir_check_call_status();
					break;
				} while(0);
	...
	if (!(zephir_fast_count_int(&records))) {
		object_init_ex(return_value, phalcon_mvc_model_query_status_ce);
		ZVAL_BOOL(&_28$$27, 1);
		ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 343, &_28$$27);
		zephir_check_call_status();
		RETURN_MM();
	}
	ZEPHIR_CALL_METHOD(&connection, this_ptr, "getwriteconnection", NULL, 0, &model, intermediate, bindParams, bindTypes);
	...
	while (1) {
		...
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(&_31$$28, &record, "update", NULL, 0, &updateValues);
		zephir_check_call_status();
		if (!(zephir_is_true(&_31$$28))) {
			...
			object_init_ex(return_value, phalcon_mvc_model_query_status_ce);
			ZVAL_BOOL(&_33$$29, 0);
			ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 343, &_33$$29, &record);
			zephir_check_call_status();
			RETURN_MM();
		}
	...
	object_init_ex(return_value, phalcon_mvc_model_query_status_ce);
	ZVAL_BOOL(&_35, 1);
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 343, &_35);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _executeDelete) {
	...
	ZEPHIR_OBS_VAR(&models);
	zephir_array_fetch_string(&models, intermediate, SL("models"), PH_NOISY, "phalcon/mvc/model/query.zep", 3178);
	if (zephir_array_isset_long(&models, 1)) {
	...
	ZEPHIR_OBS_VAR(&modelName);
	zephir_array_fetch_long(&modelName, &models, 0, PH_NOISY, "phalcon/mvc/model/query.zep", 3184);
	ZEPHIR_OBS_VAR(&model);
	zephir_read_property(&_0, this_ptr, SL("_modelsInstances"), PH_NOISY_CC | PH_READONLY);
	if (!(zephir_array_isset_fetch(&model, &_0, &modelName, 0))) {
		zephir_read_property(&_1$$4, this_ptr, SL("_manager"), PH_NOISY_CC | PH_READONLY);
	...
	if (!(zephir_fast_count_int(&records))) {
		object_init_ex(return_value, phalcon_mvc_model_query_status_ce);
		ZVAL_BOOL(&_2$$5, 1);
		ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 343, &_2$$5);
		zephir_check_call_status();
		RETURN_MM();
	}
	ZEPHIR_CALL_METHOD(&connection, this_ptr, "getwriteconnection", NULL, 0, &model, intermediate, bindParams, bindTypes);
	...
	while (1) {
		...
		if (!(zephir_is_true(&_5$$6))) {
			...
			object_init_ex(return_value, phalcon_mvc_model_query_status_ce);
			ZVAL_BOOL(&_7$$7, 0);
			ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 343, &_7$$7, &record);
			zephir_check_call_status();
			RETURN_MM();
		}
	...
	object_init_ex(return_value, phalcon_mvc_model_query_status_ce);
	ZVAL_BOOL(&_9, 1);
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 343, &_9);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getRelatedRecords) {
	...
	ZEPHIR_OBS_VAR(&_4);
	zephir_array_fetch_string(&_4, intermediate, SL("models"), PH_NOISY, "phalcon/mvc/model/query.zep", 3267);
	zephir_array_update_string(&selectIr, SL("models"), &_4, PH_COPY | PH_SEPARATE);
	ZEPHIR_OBS_NVAR(&_4);
	zephir_array_fetch_string(&_4, intermediate, SL("tables"), PH_NOISY, "phalcon/mvc/model/query.zep", 3269);
	...
	zephir_check_call_status();
	ZVAL_LONG(&_6, 309);
	ZEPHIR_CALL_METHOD(NULL, &query, "settype", NULL, 347, &_6);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, execute) {
	...
	do {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_4$$27, "phalcon/mvc/model/query.zep", 3431);
		ZEPHIR_MM_RESTORE();
		return;
	} while(0);
...
PHP_METHOD(Phalcon_Mvc_Model_Query, cache) {
	...
	zephir_fetch_params_without_memory_grow(1, 0, &cacheOptions);
...
PHP_METHOD(Phalcon_Mvc_Model_Query, getSql) {
	...
	if (ZEPHIR_IS_LONG(&_0, 309)) {
		...
		ZVAL_BOOL(&_3$$3, 1);
		ZEPHIR_RETURN_CALL_METHOD(this_ptr, "_executeselect", NULL, 350, &intermediate, &_1$$3, &_2$$3, &_3$$3);
		zephir_check_call_status();
		RETURN_MM();
	}
