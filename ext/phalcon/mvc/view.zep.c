...
ZEPHIR_INIT_CLASS(Phalcon_Mvc_View) {
	...
	zend_declare_property_long(phalcon_mvc_view_ce, SL("_renderLevel"), 5, ZEND_ACC_PROTECTED);
	...
	zend_declare_property_null(phalcon_mvc_view_ce, SL("_viewsDirs"), ZEND_ACC_PROTECTED);
	...
	zend_declare_property_null(phalcon_mvc_view_ce, SL("_activeRenderPaths"), ZEND_ACC_PROTECTED);
...
PHP_METHOD(Phalcon_Mvc_View, _loadTemplateEngines) {
	...
	zend_string *_5$$5;
	zend_ulong _4$$5;
	zval engines, dependencyInjector, registeredEngines, arguments, engineService, extension, _0$$3, _1$$4, *_2$$5, _3$$5, _6$$9, _7$$12, _8$$12, _10$$11, _12$$15, _13$$18, _14$$18, _15$$17;
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zephir_fcall_cache_entry *_9 = NULL, *_11 = NULL, *_16 = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *this_ptr = getThis();
	...
	if (ZEPHIR_IS_FALSE_IDENTICAL(&engines)) {
		...
		if (Z_TYPE_P(&registeredEngines) != IS_ARRAY) {
			...
			ZEPHIR_CALL_METHOD(NULL, &_1$$4, "__construct", NULL, 365, this_ptr, &dependencyInjector);
			zephir_check_call_status();
			...
			zephir_is_iterable(&registeredEngines, 0, "phalcon/mvc/view.zep", 571);
			if (Z_TYPE_P(&registeredEngines) == IS_ARRAY) {
				ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&registeredEngines), _4$$5, _5$$5, _2$$5)
				{
					...
					if (Z_TYPE_P(&engineService) == IS_OBJECT) {
						if (zephir_instance_of_ev(&engineService, zend_ce_closure)) {
							...
							ZEPHIR_CALL_USER_FUNC_ARRAY(&_6$$9, &engineService, &arguments);
							zephir_check_call_status();
						...
						if (Z_TYPE_P(&engineService) != IS_STRING) {
							...
							object_init_ex(&_7$$12, phalcon_mvc_view_exception_ce);
							ZEPHIR_INIT_NVAR(&_8$$12);
							ZEPHIR_CONCAT_SV(&_8$$12, "Invalid template engine registration for extension: ", &extension);
							ZEPHIR_CALL_METHOD(NULL, &_7$$12, "__construct", &_9, 4, &_8$$12);
							zephir_check_call_status();
							zephir_throw_exception_debug(&_7$$12, "phalcon/mvc/view.zep", 565);
							ZEPHIR_MM_RESTORE();
							return;
						}
						ZEPHIR_CALL_METHOD(&_10$$11, &dependencyInjector, "getshared", &_11, 0, &engineService, &arguments);
						zephir_check_call_status();
						zephir_array_update_zval(&engines, &extension, &_10$$11, PH_COPY | PH_SEPARATE);
					}
				} ZEND_HASH_FOREACH_END();
			} else {
					...
					zephir_check_call_status();
						if (Z_TYPE_P(&engineService) == IS_OBJECT) {
							if (zephir_instance_of_ev(&engineService, zend_ce_closure)) {
								...
								ZEPHIR_CALL_USER_FUNC_ARRAY(&_12$$15, &engineService, &arguments);
								zephir_check_call_status();
								zephir_array_update_zval(&engines, &extension, &_12$$15, PH_COPY | PH_SEPARATE);
							} else {
								zephir_array_update_zval(&engines, &extension, &engineService, PH_COPY | PH_SEPARATE);
							}
						} else {
							if (Z_TYPE_P(&engineService) != IS_STRING) {
								...
								object_init_ex(&_13$$18, phalcon_mvc_view_exception_ce);
								ZEPHIR_INIT_NVAR(&_14$$18);
								ZEPHIR_CONCAT_SV(&_14$$18, "Invalid template engine registration for extension: ", &extension);
								ZEPHIR_CALL_METHOD(NULL, &_13$$18, "__construct", &_9, 4, &_14$$18);
								zephir_check_call_status();
								zephir_throw_exception_debug(&_13$$18, "phalcon/mvc/view.zep", 565);
								ZEPHIR_MM_RESTORE();
								return;
							}
							ZEPHIR_CALL_METHOD(&_15$$17, &dependencyInjector, "getshared", &_16, 0, &engineService, &arguments);
							zephir_check_call_status();
							zephir_array_update_zval(&engines, &extension, &_15$$17, PH_COPY | PH_SEPARATE);
						}
...
PHP_METHOD(Phalcon_Mvc_View, _engineRender) {
	...
	zval _17$$16, _24$$21, _43$$37, _50$$42;
	...
	zval *engines, engines_sub, *viewPath_param = NULL, *silence_param = NULL, *mustClean_param = NULL, *cache = NULL, cache_sub, __$null, key, lifetime, viewsDir, basePath, viewsDirPath, viewOptions, cacheOptions, cachedView, viewParams, eventsManager, extension, engine, viewEnginePath, viewEnginePaths, _0, _1, *_2, _3, _4$$3, *_13$$3, _14$$3, _6$$6, _7$$6, _8$$7, _11$$7, _18$$16, _19$$16, _21$$15, _22$$18, _25$$21, _26$$21, _28$$20, _29$$23, _31$$24, *_39$$24, _40$$24, _32$$27, _33$$27, _34$$28, _37$$28, _44$$37, _45$$37, _47$$36, _48$$39, _51$$42, _52$$42, _54$$41, _55$$44, _57$$46, _58$$47;
	zval *this_ptr = getThis();
	...
	zephir_check_call_status();
	zephir_is_iterable(&_1, 0, "phalcon/mvc/view.zep", 698);
	if (Z_TYPE_P(&_1) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_1), _2)
		{
			ZEPHIR_INIT_NVAR(&viewsDir);
			ZVAL_COPY(&viewsDir, _2);
			ZEPHIR_CALL_METHOD(&_4$$3, this_ptr, "_isabsolutepath", &_5, 366, &viewPath);
			zephir_check_call_status();
			...
			zephir_is_iterable(engines, 0, "phalcon/mvc/view.zep", 696);
		...
		while (1) {
			...
			zephir_check_call_status();
				ZEPHIR_CALL_METHOD(&_31$$24, this_ptr, "_isabsolutepath", &_5, 366, &viewPath);
				zephir_check_call_status();
					...
					ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(engines), _41$$24, _42$$24, _39$$24)
					{
						...
						if ((zephir_file_exists(&viewEnginePath) == SUCCESS)) {
							if (Z_TYPE_P(&eventsManager) == IS_OBJECT) {
								...
								zephir_create_array(&_43$$37, 1, 0);
						...
						zephir_check_call_status();
							...
							if ((zephir_file_exists(&viewEnginePath) == SUCCESS)) {
								if (Z_TYPE_P(&eventsManager) == IS_OBJECT) {
									...
									zephir_create_array(&_50$$42, 1, 0);
	...
	if (notExists == 1) {
		...
		if (!(silence)) {
			...
			zephir_check_call_status();
			zephir_throw_exception_debug(&_58$$47, "phalcon/mvc/view.zep", 708);
			ZEPHIR_MM_RESTORE();
			return;
		}
	}
...
PHP_METHOD(Phalcon_Mvc_View, exists) {
	...
	ZEPHIR_CALL_METHOD(&_1, this_ptr, "getviewsdirs", NULL, 0);
	zephir_check_call_status();
	zephir_is_iterable(&_1, 0, "phalcon/mvc/view.zep", 755);
	if (Z_TYPE_P(&_1) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_1), _2)
		{
			ZEPHIR_INIT_NVAR(&viewsDir);
			...
			zephir_is_iterable(&engines, 0, "phalcon/mvc/view.zep", 753);
			if (Z_TYPE_P(&engines) == IS_ARRAY) {
				ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&engines), _7$$4, _8$$4, _5$$4)
				{
					...
					if ((zephir_file_exists(&_9$$5) == SUCCESS)) {
						RETURN_MM_BOOL(1);
					}
				} ZEND_HASH_FOREACH_END();
			} else {
				...
				while (1) {
					...
					zephir_check_call_status();
						...
						if ((zephir_file_exists(&_10$$7) == SUCCESS)) {
							RETURN_MM_BOOL(1);
						}
					ZEPHIR_CALL_METHOD(NULL, &engines, "next", NULL, 0);
					zephir_check_call_status();
			...
			zephir_check_call_status();
				...
				if (Z_TYPE_P(&engines) == IS_ARRAY) {
					ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&engines), _14$$9, _15$$9, _12$$9)
					{
						...
						if ((zephir_file_exists(&_16$$10) == SUCCESS)) {
							RETURN_MM_BOOL(1);
						}
					} ZEND_HASH_FOREACH_END();
				} else {
					...
					while (1) {
						...
						zephir_check_call_status();
							...
							if ((zephir_file_exists(&_17$$12) == SUCCESS)) {
								RETURN_MM_BOOL(1);
							}
						ZEPHIR_CALL_METHOD(NULL, &engines, "next", NULL, 0);
						zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_View, render) {
	...
	if (!ZEPHIR_IS_FALSE_IDENTICAL(&_0)) {
		ZEPHIR_CALL_FUNCTION(&_1$$3, "ob_get_contents", NULL, 128);
		zephir_check_call_status();
	...
	if (Z_TYPE_P(&pickView) == IS_NULL) {
		...
		zephir_array_fetch_long(&renderView, &pickView, 0, PH_NOISY, "phalcon/mvc/view.zep", 831);
	...
	ZEPHIR_CALL_FUNCTION(&_8, "ob_get_contents", NULL, 128);
	zephir_check_call_status();
	...
	if (renderLevel) {
		...
		if (renderLevel >= 2) {
			if (!(zephir_array_isset_long(&disabledLevels, 2))) {
				...
				silence = 0;
				zephir_is_iterable(&templatesBefore, 0, "phalcon/mvc/view.zep", 906);
		...
		if (renderLevel >= 4) {
			if (!(zephir_array_isset_long(&disabledLevels, 4))) {
				...
				silence = 0;
				zephir_is_iterable(&templatesAfter, 0, "phalcon/mvc/view.zep", 933);
...
PHP_METHOD(Phalcon_Mvc_View, pick) {
	...
	if (Z_TYPE_P(renderView) == IS_ARRAY) {
		...
		if (zephir_memnstr_str(renderView, SL("/"), "phalcon/mvc/view.zep", 998)) {
			...
			zephir_array_fetch_long(&layout, &parts, 0, PH_NOISY, "phalcon/mvc/view.zep", 999);
		}
...
PHP_METHOD(Phalcon_Mvc_View, partial) {
	...
	if (Z_TYPE_P(params) == IS_ARRAY) {
		...
		zephir_read_property(&viewParams, this_ptr, SL("_viewParams"), PH_NOISY_CC);
		ZEPHIR_INIT_VAR(&_0$$3);
		zephir_fast_array_merge(&_0$$3, &viewParams, params);
		zephir_update_property_zval(this_ptr, SL("_viewParams"), &_0$$3);
...
PHP_METHOD(Phalcon_Mvc_View, _createCache) {
	...
	if (zephir_array_isset_string_fetch(&cacheOptions, &viewOptions, SL("cache"), 0)) {
		if (zephir_array_isset_string(&cacheOptions, SL("service"))) {
			...
			zephir_array_fetch_string(&cacheService, &cacheOptions, SL("service"), PH_NOISY, "phalcon/mvc/view.zep", 1192);
		}
	}
...
PHP_METHOD(Phalcon_Mvc_View, cache) {
	...
	if (Z_TYPE_P(options) == IS_ARRAY) {
		...
		zephir_is_iterable(options, 0, "phalcon/mvc/view.zep", 1264);
		if (Z_TYPE_P(options) == IS_ARRAY) {
...
PHP_METHOD(Phalcon_Mvc_View, getActiveRenderPath) {
	...
	if (viewsDirsCount == 1) {
		if (Z_TYPE_P(&activeRenderPath) == IS_ARRAY) {
			if (zephir_fast_count_int(&activeRenderPath)) {
				zephir_array_fetch_long(&_1$$5, &activeRenderPath, 0, PH_NOISY | PH_READONLY, "phalcon/mvc/view.zep", 1322);
