...
ZEPHIR_INIT_CLASS(Phalcon_Tag) {
	...
	zend_declare_property_null(phalcon_tag_ce, SL("_documentAppendTitle"), ZEND_ACC_PROTECTED|ZEND_ACC_STATIC);

	zend_declare_property_null(phalcon_tag_ce, SL("_documentPrependTitle"), ZEND_ACC_PROTECTED|ZEND_ACC_STATIC);
		...
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&attrs), _11, _12, _9)
		{
			...
			if (_13$$11) {
				...
				if (_14$$12) {
					...
					zephir_check_call_status();
					zephir_throw_exception_debug(&_15$$13, "phalcon/tag.zep", 151);
					ZEPHIR_MM_RESTORE();
					return;
				}
			...
			zephir_check_call_status();
				...
				if (_21$$16) {
					...
					if (_22$$17) {
						...
						zephir_check_call_status();
						zephir_throw_exception_debug(&_23$$18, "phalcon/tag.zep", 151);
						ZEPHIR_MM_RESTORE();
						return;
					}
					if (zephir_is_true(&escaper)) {
...
PHP_METHOD(Phalcon_Tag, setDI) {
	...
	zephir_update_static_property_ce(phalcon_tag_ce, ZEND_STRL("_dependencyInjector"), dependencyInjector);
...
PHP_METHOD(Phalcon_Tag, getUrlService) {
	...
	if (Z_TYPE_P(&url) != IS_OBJECT) {
		...
		zephir_update_static_property_ce(phalcon_tag_ce, ZEND_STRL("_urlService"), &url);
	}
	RETURN_CCTOR(&url);
...
PHP_METHOD(Phalcon_Tag, getEscaperService) {
	...
	if (Z_TYPE_P(&escaper) != IS_OBJECT) {
		...
		zephir_update_static_property_ce(phalcon_tag_ce, ZEND_STRL("_escaperService"), &escaper);
	}
...
PHP_METHOD(Phalcon_Tag, setAutoescape) {
	...
	zephir_update_static_property_ce(phalcon_tag_ce, ZEND_STRL("_autoEscape"), &_0);
...
PHP_METHOD(Phalcon_Tag, setDefault) {
	...
	zephir_update_static_property_array_multi_ce(phalcon_tag_ce, SL("_displayValues"), value, SL("z"), 1, &id);
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Phalcon_Tag, setDefaults) {
	...
	if (_0) {
		...
		zephir_update_static_property_ce(phalcon_tag_ce, ZEND_STRL("_displayValues"), &_2$$3);
	} else {
		zephir_update_static_property_ce(phalcon_tag_ce, ZEND_STRL("_displayValues"), &values);
	}
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Phalcon_Tag, getValue) {
	...
	if (_0) {
		...
		if (!(zephir_array_isset_fetch(&value, &_1$$3, name, 0))) {
			ZEPHIR_OBS_NVAR(&value);
...
PHP_METHOD(Phalcon_Tag, resetInput) {
	...
	ZEPHIR_INIT_VAR(&_0);
	array_init(&_0);
	zephir_update_static_property_ce(phalcon_tag_ce, ZEND_STRL("_displayValues"), &_0);
	zephir_update_static_property_ce(phalcon_tag_ce, ZEND_STRL("_documentTitle"), &__$null);
	ZEPHIR_INIT_VAR(&_1);
	array_init(&_1);
	zephir_update_static_property_ce(phalcon_tag_ce, ZEND_STRL("_documentAppendTitle"), &_1);
	ZEPHIR_INIT_VAR(&_2);
	array_init(&_2);
	zephir_update_static_property_ce(phalcon_tag_ce, ZEND_STRL("_documentPrependTitle"), &_2);
	zephir_update_static_property_ce(phalcon_tag_ce, ZEND_STRL("_documentTitleSeparator"), &__$null);
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Phalcon_Tag, _inputField) {
	...
	if (asValue == 0) {
		...
		if (!(zephir_array_isset_long_fetch(&id, &params, 0, 0))) {
			zephir_array_fetch_string(&_0$$6, &params, SL("id"), PH_NOISY | PH_READONLY, "phalcon/tag.zep", 478);
...
PHP_METHOD(Phalcon_Tag, _inputFieldChecked) {
	...
	if (!(zephir_array_isset_long(&params, 0))) {
		zephir_array_fetch_string(&_0$$5, &params, SL("id"), PH_NOISY | PH_READONLY, "phalcon/tag.zep", 544);
		zephir_array_update_long(&params, 0, &_0$$5, PH_COPY | PH_SEPARATE ZEPHIR_DEBUG_PARAMS_DUMMY);
	}
	ZEPHIR_OBS_VAR(&id);
	zephir_array_fetch_long(&id, &params, 0, PH_NOISY, "phalcon/tag.zep", 547);
	if (!(zephir_array_isset_string(&params, SL("name")))) {
		zephir_array_update_string(&params, SL("name"), &id, PH_COPY | PH_SEPARATE);
	} else {
		ZEPHIR_OBS_VAR(&name);
		zephir_array_fetch_string(&name, &params, SL("name"), PH_NOISY, "phalcon/tag.zep", 551);
		if (ZEPHIR_IS_EMPTY(&name)) {
			zephir_array_update_string(&params, SL("name"), &id, PH_COPY | PH_SEPARATE);
		}
	}
...
PHP_METHOD(Phalcon_Tag, colorField) {
	...
	ZEPHIR_RETURN_CALL_SELF("_inputfield", &_0, 416, &_1, parameters);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Tag, checkField) {
	...
	ZEPHIR_RETURN_CALL_SELF("_inputfieldchecked", &_0, 417, &_1, parameters);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Tag, imageInput) {
	...
	ZVAL_BOOL(&_2, 1);
	ZEPHIR_RETURN_CALL_SELF("_inputfield", &_0, 416, &_1, parameters, &_2);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Tag, textArea) {
	...
	if (!(zephir_array_isset_long(&params, 0))) {
		if (zephir_array_isset_string(&params, SL("id"))) {
			zephir_array_fetch_string(&_0$$6, &params, SL("id"), PH_NOISY | PH_READONLY, "phalcon/tag.zep", 1027);
			zephir_array_update_long(&params, 0, &_0$$6, PH_COPY | PH_SEPARATE ZEPHIR_DEBUG_PARAMS_DUMMY);
		}
	}
	ZEPHIR_OBS_VAR(&id);
	zephir_array_fetch_long(&id, &params, 0, PH_NOISY, "phalcon/tag.zep", 1031);
	if (!(zephir_array_isset_string(&params, SL("name")))) {
		zephir_array_update_string(&params, SL("name"), &id, PH_COPY | PH_SEPARATE);
	} else {
		ZEPHIR_OBS_VAR(&name);
		zephir_array_fetch_string(&name, &params, SL("name"), PH_NOISY, "phalcon/tag.zep", 1035);
		if (ZEPHIR_IS_EMPTY(&name)) {
			zephir_array_update_string(&params, SL("name"), &id, PH_COPY | PH_SEPARATE);
		}
	}
	...
	if (zephir_array_isset_string(&params, SL("value"))) {
		...
		zephir_array_fetch_string(&content, &params, SL("value"), PH_NOISY, "phalcon/tag.zep", 1046);
		zephir_array_unset_string(&params, SL("value"), PH_SEPARATE);
	} else {
...
PHP_METHOD(Phalcon_Tag, form) {
	...
	if (zephir_array_isset_string_fetch(parameters, &params, SL("parameters"), 0)) {
		...
		zephir_array_unset_string(&params, SL("parameters"), PH_SEPARATE);
	}
...
PHP_METHOD(Phalcon_Tag, setTitle) {
	...
	zephir_update_static_property_ce(phalcon_tag_ce, ZEND_STRL("_documentTitle"), &title);
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Phalcon_Tag, setTitleSeparator) {
	...
	zephir_update_static_property_ce(phalcon_tag_ce, ZEND_STRL("_documentTitleSeparator"), &titleSeparator);
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Phalcon_Tag, appendTitle) {
	...
	if (Z_TYPE_P(&_0) == IS_NULL) {
		ZEPHIR_INIT_VAR(&_1$$3);
		array_init(&_1$$3);
		zephir_update_static_property_ce(phalcon_tag_ce, ZEND_STRL("_documentAppendTitle"), &_1$$3);
	}
	if (Z_TYPE_P(title) == IS_ARRAY) {
		zephir_update_static_property_ce(phalcon_tag_ce, ZEND_STRL("_documentAppendTitle"), title);
	} else {
		zephir_update_static_property_array_multi_ce(phalcon_tag_ce, SL("_documentAppendTitle"), title, SL("a"), 1);
	}
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Phalcon_Tag, prependTitle) {
	...
	if (Z_TYPE_P(&_0) == IS_NULL) {
		ZEPHIR_INIT_VAR(&_1$$3);
		array_init(&_1$$3);
		zephir_update_static_property_ce(phalcon_tag_ce, ZEND_STRL("_documentPrependTitle"), &_1$$3);
	}
	if (Z_TYPE_P(title) == IS_ARRAY) {
		zephir_update_static_property_ce(phalcon_tag_ce, ZEND_STRL("_documentPrependTitle"), title);
	} else {
		zephir_update_static_property_array_multi_ce(phalcon_tag_ce, SL("_documentPrependTitle"), title, SL("a"), 1);
	}
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Phalcon_Tag, getTitle) {
	...
	zval _1;
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zephir_fcall_cache_entry *_11 = NULL, *_13 = NULL, *_17 = NULL, *_19 = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *tags_param = NULL, __$true, items, output, title, documentTitle, documentAppendTitle, documentPrependTitle, documentTitleSeparator, escaper, _0, _2, _3, _4, _6, _5$$3, _7$$4, tmp$$5, *_8$$5, _9$$5, _10$$6, _12$$7, *_14$$9, _15$$9, _16$$10, _18$$11, _20$$14;
	zend_bool tags;
	zval *this_ptr = getThis();
	...
	if (Z_TYPE_P(&_4) == IS_NULL) {
		...
		array_init(&_5$$3);
		zephir_update_static_property_ce(phalcon_tag_ce, ZEND_STRL("_documentAppendTitle"), &_5$$3);
	}
	...
	if (Z_TYPE_P(&_6) == IS_NULL) {
		...
		array_init(&_7$$4);
		zephir_update_static_property_ce(phalcon_tag_ce, ZEND_STRL("_documentPrependTitle"), &_7$$4);
	}
	...
	if (!(ZEPHIR_IS_EMPTY(&documentPrependTitle))) {
		ZEPHIR_CALL_FUNCTION(&tmp$$5, "array_reverse", NULL, 418, &documentPrependTitle);
		zephir_check_call_status();
		zephir_is_iterable(&tmp$$5, 0, "phalcon/tag.zep", 1229);
		if (Z_TYPE_P(&tmp$$5) == IS_ARRAY) {
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&tmp$$5), _8$$5)
			{
				ZEPHIR_INIT_NVAR(&title);
				ZVAL_COPY(&title, _8$$5);
				ZEPHIR_CALL_METHOD(&_10$$6, &escaper, "escapehtml", &_11, 0, &title);
				zephir_check_call_status();
				zephir_array_append(&items, &_10$$6, PH_SEPARATE, "phalcon/tag.zep", 1227);
			} ZEND_HASH_FOREACH_END();
		} else {
			ZEPHIR_CALL_METHOD(NULL, &tmp$$5, "rewind", NULL, 0);
			zephir_check_call_status();
			while (1) {
				ZEPHIR_CALL_METHOD(&_9$$5, &tmp$$5, "valid", NULL, 0);
				zephir_check_call_status();
				...
				zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_12$$7, &escaper, "escapehtml", &_13, 0, &title);
					zephir_check_call_status();
					zephir_array_append(&items, &_12$$7, PH_SEPARATE, "phalcon/tag.zep", 1227);
	...
	if (!(ZEPHIR_IS_EMPTY(&documentAppendTitle))) {
		zephir_is_iterable(&documentAppendTitle, 0, "phalcon/tag.zep", 1239);
		if (Z_TYPE_P(&documentAppendTitle) == IS_ARRAY) {
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&documentAppendTitle), _14$$9)
			{
				ZEPHIR_INIT_NVAR(&title);
				ZVAL_COPY(&title, _14$$9);
				ZEPHIR_CALL_METHOD(&_16$$10, &escaper, "escapehtml", &_17, 0, &title);
				zephir_check_call_status();
				zephir_array_append(&items, &_16$$10, PH_SEPARATE, "phalcon/tag.zep", 1237);
			} ZEND_HASH_FOREACH_END();
		} else {
			ZEPHIR_CALL_METHOD(NULL, &documentAppendTitle, "rewind", NULL, 0);
			zephir_check_call_status();
			while (1) {
				ZEPHIR_CALL_METHOD(&_15$$9, &documentAppendTitle, "valid", NULL, 0);
				zephir_check_call_status();
				...
				zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_18$$11, &escaper, "escapehtml", &_19, 0, &title);
					zephir_check_call_status();
					zephir_array_append(&items, &_18$$11, PH_SEPARATE, "phalcon/tag.zep", 1237);
	...
	if (tags) {
		...
		ZEPHIR_GET_CONSTANT(&_20$$14, "PHP_EOL");
		ZEPHIR_CONCAT_SVSV(return_value, "<title>", &output, "</title>", &_20$$14);
		RETURN_MM();
	}
	RETURN_CCTOR(&output);
...
PHP_METHOD(Phalcon_Tag, stylesheetLink) {
	...
	if (zephir_array_isset_long(&params, 1)) {
		ZEPHIR_OBS_VAR(&_1$$5);
		zephir_array_fetch_long(&_1$$5, &params, 1, PH_NOISY, "phalcon/tag.zep", 1301);
		local = zephir_get_boolval(&_1$$5);
	} else {
		if (zephir_array_isset_string(&params, SL("local"))) {
			ZEPHIR_OBS_VAR(&_2$$7);
			zephir_array_fetch_string(&_2$$7, &params, SL("local"), PH_NOISY, "phalcon/tag.zep", 1304);
	...
	if (!(zephir_array_isset_string(&params, SL("href")))) {
		if (zephir_array_isset_long(&params, 0)) {
			zephir_array_fetch_long(&_4$$10, &params, 0, PH_NOISY | PH_READONLY, "phalcon/tag.zep", 1315);
	...
	if (local == 1) {
		...
		zephir_check_call_status();
		zephir_array_fetch_string(&_8$$12, &params, SL("href"), PH_NOISY | PH_READONLY, "phalcon/tag.zep", 1325);
...
PHP_METHOD(Phalcon_Tag, javascriptInclude) {
	...
	if (zephir_array_isset_long(&params, 1)) {
		ZEPHIR_OBS_VAR(&_1$$5);
		zephir_array_fetch_long(&_1$$5, &params, 1, PH_NOISY, "phalcon/tag.zep", 1375);
		local = zephir_get_boolval(&_1$$5);
	} else {
		if (zephir_array_isset_string(&params, SL("local"))) {
			ZEPHIR_OBS_VAR(&_2$$7);
			zephir_array_fetch_string(&_2$$7, &params, SL("local"), PH_NOISY, "phalcon/tag.zep", 1378);
			local = zephir_get_boolval(&_2$$7);
			zephir_array_unset_string(&params, SL("local"), PH_SEPARATE);
		}
	}
	...
	if (!(zephir_array_isset_string(&params, SL("src")))) {
		if (zephir_array_isset_long(&params, 0)) {
			zephir_array_fetch_long(&_4$$10, &params, 0, PH_NOISY | PH_READONLY, "phalcon/tag.zep", 1389);
	...
	if (local == 1) {
		ZEPHIR_CALL_SELF(&_6$$12, "geturlservice", NULL, 0);
		zephir_check_call_status();
		zephir_array_fetch_string(&_8$$12, &params, SL("src"), PH_NOISY | PH_READONLY, "phalcon/tag.zep", 1399);
		ZEPHIR_CALL_METHOD(&_7$$12, &_6$$12, "getstatic", NULL, 0, &_8$$12);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Tag, image) {
	...
	if (Z_TYPE_P(parameters) != IS_ARRAY) {
		...
		if (zephir_array_isset_long(&params, 1)) {
			ZEPHIR_OBS_VAR(&_0$$5);
			zephir_array_fetch_long(&_0$$5, &params, 1, PH_NOISY, "phalcon/tag.zep", 1442);
	...
	if (local) {
		...
		zephir_check_call_status();
		zephir_array_fetch_string(&_4$$9, &params, SL("src"), PH_NOISY | PH_READONLY, "phalcon/tag.zep", 1458);
...
PHP_METHOD(Phalcon_Tag, friendlyTitle) {
	...
	if (zephir_is_true(&_1)) {
		...
		ZEPHIR_CALL_FUNCTION(&locale, "setlocale", NULL, 419, &_2$$3, &_3$$3);
		zephir_check_call_status();
		ZEPHIR_INIT_NVAR(&_3$$3);
		ZVAL_STRING(&_3$$3, "UTF-8");
		ZEPHIR_INIT_VAR(&_4$$3);
		ZVAL_STRING(&_4$$3, "ASCII//TRANSLIT");
		ZEPHIR_CALL_FUNCTION(&_5$$3, "iconv", NULL, 374, &_3$$3, &_4$$3, &text);
		zephir_check_call_status();
	...
	if (zephir_is_true(replace)) {
		...
		if (Z_TYPE_P(replace) == IS_ARRAY) {
			zephir_is_iterable(replace, 0, "phalcon/tag.zep", 1503);
			if (Z_TYPE_P(replace) == IS_ARRAY) {
				ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(replace), _7$$6)
				{
					...
					ZVAL_STRING(&_10$$7, " ");
					zephir_fast_str_replace(&_9$$7, &search, &_10$$7, &text);
				...
				while (1) {
					...
					zephir_check_call_status();
						...
						ZVAL_STRING(&_12$$8, " ");
						zephir_fast_str_replace(&_11$$8, &search, &_12$$8, &text);
			...
			ZVAL_STRING(&_14$$9, " ");
			zephir_fast_str_replace(&_13$$9, replace, &_14$$9, &text);
	...
	ZEPHIR_INIT_VAR(&_15);
	ZVAL_STRING(&_15, "");
	ZEPHIR_CALL_FUNCTION(&friendly, "preg_replace", NULL, 35, &_0, &_15, &text);
	zephir_check_call_status();
	if (lowercase) {
	...
	ZEPHIR_INIT_NVAR(&_0);
	ZVAL_STRING(&_0, "/[\\/_|+ -]+/");
	ZEPHIR_CALL_FUNCTION(&_17, "preg_replace", NULL, 35, &_0, &separator, &friendly);
	zephir_check_call_status();
	...
	ZEPHIR_INIT_NVAR(&_0);
	ZVAL_STRING(&_0, "iconv");
	ZEPHIR_CALL_FUNCTION(&_17, "extension_loaded", NULL, 135, &_0);
	zephir_check_call_status();
	if (zephir_is_true(&_17)) {
		ZVAL_LONG(&_18$$11, 6);
		ZEPHIR_CALL_FUNCTION(NULL, "setlocale", NULL, 419, &_18$$11, &locale);
		zephir_check_call_status();
	}
...
PHP_METHOD(Phalcon_Tag, setDocType) {
	...
	if (_0) {
		...
		ZVAL_LONG(&_1$$3, 5);
		zephir_update_static_property_ce(phalcon_tag_ce, ZEND_STRL("_documentType"), &_1$$3);
	} else {
		ZEPHIR_INIT_ZVAL_NREF(_2$$4);
		ZVAL_LONG(&_2$$4, doctype);
		zephir_update_static_property_ce(phalcon_tag_ce, ZEND_STRL("_documentType"), &_2$$4);
	}
