...
ZEPHIR_INIT_CLASS(Phalcon_Annotations_Adapter_Apcu) {
	...
	zend_declare_property_string(phalcon_annotations_adapter_apcu_ce, SL("_prefix"), "", ZEND_ACC_PROTECTED);

	zend_declare_property_long(phalcon_annotations_adapter_apcu_ce, SL("_ttl"), 172800, ZEND_ACC_PROTECTED);
...
PHP_METHOD(Phalcon_Annotations_Adapter_Apcu, read) {
	...
	ZEPHIR_RETURN_CALL_FUNCTION("apcu_fetch", NULL, 83, &_0);
...
PHP_METHOD(Phalcon_Annotations_Adapter_Apcu, write) {
	...
	ZEPHIR_RETURN_CALL_FUNCTION("apcu_store", NULL, 84, &_0, data, &_3);
	zephir_check_call_status();
	RETURN_MM();
