...
PHP_METHOD(Phalcon_Annotations_Reader, parse) {
	...
	zval *className_param = NULL, annotations, reflection, comment, properties, methods, property, method, classAnnotations, annotationsProperties, propertyAnnotations, annotationsMethods, methodAnnotations, _0$$3, _1$$3, *_2$$5, _3$$5, _4$$7, _5$$7, _6$$8, _7$$10, _8$$10, _9$$11, *_10$$13, _11$$13, _12$$15, _13$$15, _14$$16, _15$$18, _16$$18, _17$$19;
	zval className;
	...
	ZEPHIR_CALL_METHOD(NULL, &reflection, "__construct", NULL, 89, &className);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&comment, &reflection, "getdoccomment", NULL, 90);
	zephir_check_call_status();
	if (Z_TYPE_P(&comment) == IS_STRING) {
		ZEPHIR_INIT_VAR(&classAnnotations);
		ZEPHIR_CALL_METHOD(&_0$$3, &reflection, "getfilename", NULL, 91);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(&_1$$3, &reflection, "getstartline", NULL, 92);
		zephir_check_call_status();
	...
	ZEPHIR_CALL_METHOD(&properties, &reflection, "getproperties", NULL, 93);
	zephir_check_call_status();
		...
		if (Z_TYPE_P(&properties) == IS_ARRAY) {
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&properties), _2$$5)
			{
				...
				if (Z_TYPE_P(&comment) == IS_STRING) {
					...
					ZEPHIR_CALL_METHOD(&_4$$7, &reflection, "getfilename", NULL, 91);
					zephir_check_call_status();
					ZVAL_LONG(&_5$$7, line);
			...
			while (1) {
				...
				zephir_check_call_status();
					...
					if (Z_TYPE_P(&comment) == IS_STRING) {
						ZEPHIR_INIT_NVAR(&propertyAnnotations);
						ZEPHIR_CALL_METHOD(&_7$$10, &reflection, "getfilename", NULL, 91);
						zephir_check_call_status();
	...
	ZEPHIR_CALL_METHOD(&methods, &reflection, "getmethods", NULL, 94);
	zephir_check_call_status();
