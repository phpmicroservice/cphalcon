...
ZEPHIR_INIT_CLASS(Phalcon_Security) {
	...
	zend_declare_property_null(phalcon_security_ce, SL("_dependencyInjector"), ZEND_ACC_PROTECTED);
	...
	zend_declare_property_string(phalcon_security_ce, SL("_tokenKeySessionID"), "$PHALCON/CSRF/KEY$", ZEND_ACC_PROTECTED);

	zend_declare_property_string(phalcon_security_ce, SL("_tokenValueSessionID"), "$PHALCON/CSRF$", ZEND_ACC_PROTECTED);

	zend_declare_property_null(phalcon_security_ce, SL("_token"), ZEND_ACC_PROTECTED);

	zend_declare_property_null(phalcon_security_ce, SL("_tokenKey"), ZEND_ACC_PROTECTED);

	zend_declare_property_null(phalcon_security_ce, SL("_random"), ZEND_ACC_PROTECTED);

	zend_declare_property_null(phalcon_security_ce, SL("_defaultHash"), ZEND_ACC_PROTECTED);
	...
	zend_class_implements(phalcon_security_ce, 1, phalcon_di_injectionawareinterface_ce);
	return SUCCESS;
...
PHP_METHOD(Phalcon_Security, hash) {
	...
	do {
		...
		ZEPHIR_CALL_FUNCTION(&_9$$17, "sprintf", NULL, 151, &_8$$17, &_7$$17);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Security, getTokenKey) {
	...
	zval dependencyInjector, session, _0, _1$$3, _2$$3, _3$$3, _4$$3, _5$$3, _6$$3, _7$$3;
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *this_ptr = getThis();
...
PHP_METHOD(Phalcon_Security, getToken) {
	...
	if (Z_TYPE_P(&_0) == IS_NULL) {
		...
		zephir_read_property(&_4$$3, this_ptr, SL("_dependencyInjector"), PH_NOISY_CC | PH_READONLY);
		...
		ZVAL_STRING(&_6$$3, "session");
		ZEPHIR_CALL_METHOD(&_5$$3, &dependencyInjector, "getshared", NULL, 0, &_6$$3);
		zephir_check_call_status();
		ZEPHIR_CPY_WRT(&session, &_5$$3);
		zephir_read_property(&_4$$3, this_ptr, SL("_tokenValueSessionID"), PH_NOISY_CC | PH_READONLY);
		zephir_read_property(&_7$$3, this_ptr, SL("_token"), PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Security, checkToken) {
	...
	zval *tokenKey = NULL, tokenKey_sub, *tokenValue = NULL, tokenValue_sub, *destroyIfValid_param = NULL, __$null, dependencyInjector, session, request, equals, userToken, knownToken, _0, _1, _2, _3$$4, _4$$6;
	zval *this_ptr = getThis();
...
PHP_METHOD(Phalcon_Security, getSessionToken) {
	...
	zval dependencyInjector, session, _0, _1, _2;
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *this_ptr = getThis();
...
PHP_METHOD(Phalcon_Security, destroyToken) {
	...
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zval __$null, dependencyInjector, session, _0, _1, _2, _3;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *this_ptr = getThis();
...
PHP_METHOD(Phalcon_Security, computeHmac) {
	...
	ZEPHIR_CALL_FUNCTION(&hmac, "hash_hmac", NULL, 145, &algo, &data, &key, &_0);
	zephir_check_call_status();
	if (!(zephir_is_true(&hmac))) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_1$$3, "phalcon/security.zep", 465);
		ZEPHIR_MM_RESTORE();
		return;
	}
	RETURN_CCTOR(&hmac);
...
PHP_METHOD(Phalcon_Security, hasLibreSsl) {
	...
	ZEPHIR_INIT_VAR(&_0);
	ZVAL_STRING(&_0, "OPENSSL_VERSION_TEXT");
	ZEPHIR_CALL_FUNCTION(&_1, "defined", NULL, 31, &_0);
	zephir_check_call_status();
	...
	ZEPHIR_INIT_VAR(&_2);
	ZVAL_STRING(&_2, "LibreSSL");
	ZEPHIR_INIT_VAR(&_3);
	zephir_fast_strpos(&_3, &_0, &_2, 0 );
...
PHP_METHOD(Phalcon_Security, getSslVersionNumber) {
	...
	ZEPHIR_OBS_VAR(&_5);
	zephir_array_fetch_long(&_5, &matches, 1, PH_NOISY, "phalcon/security.zep", 532);
	major = zephir_get_intval(&_5);
	ZEPHIR_OBS_VAR(&_6);
	zephir_array_fetch_long(&_6, &matches, 2, PH_NOISY, "phalcon/security.zep", 533);
	minor = zephir_get_intval(&_6);
	if (zephir_array_isset_long(&matches, 3)) {
		ZEPHIR_OBS_VAR(&_7$$5);
		zephir_array_fetch_long(&_7$$5, &matches, 3, PH_NOISY, "phalcon/security.zep", 536);
