...
#if PHP_VERSION_ID >= 70200
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_phalcon_assets_manager_addresourcebytype, 0, 2, Phalcon\\Assets\\Manager, 0)
#else
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_phalcon_assets_manager_addresourcebytype, 0, 2, IS_OBJECT, "Phalcon\\Assets\\Manager", 0)
#endif
#if PHP_VERSION_ID >= 70200
...
#if PHP_VERSION_ID >= 70200
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_phalcon_assets_manager_addresource, 0, 1, Phalcon\\Assets\\Manager, 0)
#else
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_phalcon_assets_manager_addresource, 0, 1, IS_OBJECT, "Phalcon\\Assets\\Manager", 0)
#endif
	ZEND_ARG_OBJ_INFO(0, resource, Phalcon\\Assets\\Resource, 0)
ZEND_END_ARG_INFO()
...
#if PHP_VERSION_ID >= 70200
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_phalcon_assets_manager_collectionresourcesbytype, 0, 2, IS_ARRAY, 0)
#else
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_phalcon_assets_manager_collectionresourcesbytype, 0, 2, IS_ARRAY, NULL, 0)
#endif
