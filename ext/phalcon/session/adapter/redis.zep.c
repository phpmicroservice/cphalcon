...
ZEPHIR_INIT_CLASS(Phalcon_Session_Adapter_Redis) {
	...
	zend_declare_property_null(phalcon_session_adapter_redis_ce, SL("_redis"), ZEND_ACC_PROTECTED);

	zend_declare_property_long(phalcon_session_adapter_redis_ce, SL("_lifetime"), 8600, ZEND_ACC_PROTECTED);
...
PHP_METHOD(Phalcon_Session_Adapter_Redis, destroy) {
	...
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *sessionId = NULL, sessionId_sub, __$null, id, _0, _1, _2, _3;
	zval *this_ptr = getThis();
