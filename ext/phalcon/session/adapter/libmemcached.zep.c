...
PHP_METHOD(Phalcon_Session_Adapter_Libmemcached, __construct) {
	...
	ZEPHIR_CALL_FUNCTION(&_1, "min", NULL, 413, &lifetime, &_0);
	...
	ZEPHIR_CALL_METHOD(NULL, &_3, "__construct", NULL, 319, &_4);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_6);
	zephir_create_array(&_6, 5, 0);
	...
	ZEPHIR_CALL_METHOD(NULL, &_2, "__construct", NULL, 320, &_3, &_6);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Session_Adapter_Libmemcached, destroy) {
	...
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *sessionId = NULL, sessionId_sub, __$null, id, _1, _2, _3$$5, _4$$5;
	zval *this_ptr = getThis();
