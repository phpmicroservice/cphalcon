...
ZEPHIR_INIT_CLASS(Phalcon_Loader) {
	...
	zend_declare_property_null(phalcon_loader_ce, SL("_files"), ZEND_ACC_PROTECTED);
...
PHP_METHOD(Phalcon_Loader, setFileCheckingCallback) {
	...
	if (EXPECTED(zephir_is_callable(callback))) {
		zephir_update_property_zval(this_ptr, SL("fileCheckingCallback"), callback);
	} else if (Z_TYPE_P(callback) == IS_NULL) {
		ZEPHIR_INIT_VAR(&_0$$4);
		ZEPHIR_INIT_NVAR(&_0$$4);
		zephir_create_closure_ex(&_0$$4, NULL, phalcon_0__closure_ce, SL("__invoke"));
	...
	if (merge) {
		...
		if (Z_TYPE_P(&preparedNamespaces) == IS_ARRAY) {
			ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&preparedNamespaces), _2$$3, _3$$3, _0$$3)
			{
				...
				zephir_read_property(&_4$$4, this_ptr, SL("_namespaces"), PH_NOISY_CC | PH_READONLY);
				if (!(zephir_array_isset(&_4$$4, &name))) {
					ZEPHIR_INIT_NVAR(&_5$$5);
					array_init(&_5$$5);
					zephir_update_property_array(this_ptr, SL("_namespaces"), &name, &_5$$5);
				}
				ZEPHIR_INIT_NVAR(&_6$$4);
				zephir_read_property(&_7$$4, this_ptr, SL("_namespaces"), PH_NOISY_CC | PH_READONLY);
				zephir_array_fetch(&_8$$4, &_7$$4, &name, PH_NOISY | PH_READONLY, "phalcon/loader.zep", 154);
				zephir_fast_array_merge(&_6$$4, &_8$$4, &paths);
				zephir_update_property_array(this_ptr, SL("_namespaces"), &name, &_6$$4);
			...
			while (1) {
				...
				zephir_check_call_status();
					zephir_read_property(&_9$$6, this_ptr, SL("_namespaces"), PH_NOISY_CC | PH_READONLY);
					if (!(zephir_array_isset(&_9$$6, &name))) {
						ZEPHIR_INIT_NVAR(&_10$$7);
						array_init(&_10$$7);
						zephir_update_property_array(this_ptr, SL("_namespaces"), &name, &_10$$7);
					}
					ZEPHIR_INIT_NVAR(&_11$$6);
					zephir_read_property(&_12$$6, this_ptr, SL("_namespaces"), PH_NOISY_CC | PH_READONLY);
					zephir_array_fetch(&_13$$6, &_12$$6, &name, PH_NOISY | PH_READONLY, "phalcon/loader.zep", 154);
					zephir_fast_array_merge(&_11$$6, &_13$$6, &paths);
					zephir_update_property_array(this_ptr, SL("_namespaces"), &name, &_11$$6);
...
PHP_METHOD(Phalcon_Loader, prepareNamespace) {
	...
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *namespace_param = NULL, localPaths, name, paths, prepared, *_0, _1, _4$$7;
	zval namespace;
	zval *this_ptr = getThis();
	...
	if (Z_TYPE_P(&namespace) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&namespace), _2, _3, _0)
		{
			ZEPHIR_INIT_NVAR(&name);
			if (_3 != NULL) { 
		...
		ZEPHIR_CALL_METHOD(NULL, &namespace, "rewind", NULL, 0);
		zephir_check_call_status();
		while (1) {
			ZEPHIR_CALL_METHOD(&_1, &namespace, "valid", NULL, 0);
			zephir_check_call_status();
			if (!zend_is_true(&_1)) {
				break;
			}
			ZEPHIR_CALL_METHOD(&name, &namespace, "key", NULL, 0);
			zephir_check_call_status();
			ZEPHIR_CALL_METHOD(&paths, &namespace, "current", NULL, 0);
			zephir_check_call_status();
				if (Z_TYPE_P(&paths) != IS_ARRAY) {
				...
				zephir_array_update_zval(&prepared, &name, &localPaths, PH_COPY | PH_SEPARATE);
			ZEPHIR_CALL_METHOD(NULL, &namespace, "next", NULL, 0);
			zephir_check_call_status();
		}
	}
	ZEPHIR_INIT_NVAR(&paths);
...
PHP_METHOD(Phalcon_Loader, register) {
	...
	if (ZEPHIR_IS_FALSE_IDENTICAL(&_0)) {
		...
		ZEPHIR_CALL_FUNCTION(NULL, "spl_autoload_register", NULL, 279, &_1$$3, &__$true, &_3$$3);
		zephir_check_call_status();
		if (1) {
...
PHP_METHOD(Phalcon_Loader, unregister) {
	...
	if (ZEPHIR_IS_TRUE_IDENTICAL(&_0)) {
		...
		ZVAL_STRING(&_2$$3, "autoLoad");
		zephir_array_fast_append(&_1$$3, &_2$$3);
		ZEPHIR_CALL_FUNCTION(NULL, "spl_autoload_unregister", NULL, 280, &_1$$3);
		zephir_check_call_status();
		if (0) {
			zephir_update_property_zval(this_ptr, SL("_registered"), &__$true);
		} else {
...
PHP_METHOD(Phalcon_Loader, loadFiles) {
	...
	if (Z_TYPE_P(&_0) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_0), _1)
		{
			...
			zephir_read_property(&_3$$3, this_ptr, SL("_eventsManager"), PH_NOISY_CC);
			if (Z_TYPE_P(&_3$$3) == IS_OBJECT) {
				zephir_update_property_zval(this_ptr, SL("_checkedPath"), &filePath);
				zephir_read_property(&_4$$4, this_ptr, SL("_eventsManager"), PH_NOISY_CC | PH_READONLY);
				ZEPHIR_INIT_NVAR(&_5$$4);
				ZVAL_STRING(&_5$$4, "loader:beforeCheckPath");
				ZEPHIR_CALL_METHOD(NULL, &_4$$4, "fire", NULL, 0, &_5$$4, this_ptr, &filePath);
				zephir_check_call_status();
			}
			ZEPHIR_CALL_FUNCTION(&_6$$3, "call_user_func", &_7, 281, &fileCheckingCallback, &filePath);
			zephir_check_call_status();
			if (zephir_is_true(&_6$$3)) {
				ZEPHIR_OBS_NVAR(&_8$$5);
				zephir_read_property(&_8$$5, this_ptr, SL("_eventsManager"), PH_NOISY_CC);
				if (Z_TYPE_P(&_8$$5) == IS_OBJECT) {
					zephir_update_property_zval(this_ptr, SL("_foundPath"), &filePath);
					zephir_read_property(&_9$$6, this_ptr, SL("_eventsManager"), PH_NOISY_CC | PH_READONLY);
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				zephir_read_property(&_11$$7, this_ptr, SL("_eventsManager"), PH_NOISY_CC);
				if (Z_TYPE_P(&_11$$7) == IS_OBJECT) {
					zephir_update_property_zval(this_ptr, SL("_checkedPath"), &filePath);
					zephir_read_property(&_12$$8, this_ptr, SL("_eventsManager"), PH_NOISY_CC | PH_READONLY);
					ZEPHIR_INIT_NVAR(&_13$$8);
					ZVAL_STRING(&_13$$8, "loader:beforeCheckPath");
					ZEPHIR_CALL_METHOD(NULL, &_12$$8, "fire", NULL, 0, &_13$$8, this_ptr, &filePath);
					zephir_check_call_status();
				}
				ZEPHIR_CALL_FUNCTION(&_14$$7, "call_user_func", &_7, 281, &fileCheckingCallback, &filePath);
				zephir_check_call_status();
				if (zephir_is_true(&_14$$7)) {
					ZEPHIR_OBS_NVAR(&_15$$9);
					zephir_read_property(&_15$$9, this_ptr, SL("_eventsManager"), PH_NOISY_CC);
					if (Z_TYPE_P(&_15$$9) == IS_OBJECT) {
						zephir_update_property_zval(this_ptr, SL("_foundPath"), &filePath);
						zephir_read_property(&_16$$10, this_ptr, SL("_eventsManager"), PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Loader, autoLoad) {
	...
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *className_param = NULL, eventsManager, classes, extensions, filePath, ds, fixedDirectory, directories, ns, namespaces, nsPrefix, directory, fileName, extension, nsClassName, fileCheckingCallback, _2, *_3, _4, *_70, _71, _0$$3, _1$$5, _7$$6, _8$$6, _9$$6, *_10$$6, _11$$6, _12$$9, *_13$$9, _14$$9, _15$$11, _17$$10, _19$$13, _21$$15, _23$$14, _24$$17, _26$$18, *_27$$18, _28$$18, _29$$20, _31$$19, _32$$22, _34$$24, _36$$23, _37$$26, _39$$27, _40$$27, _41$$27, *_42$$27, _43$$27, _44$$30, *_45$$30, _46$$30, _47$$32, _49$$31, _50$$34, _52$$36, _54$$35, _55$$38, _57$$39, *_58$$39, _59$$39, _60$$41, _62$$40, _63$$43, _65$$45, _67$$44, _68$$47, _72$$48, *_73$$48, _74$$48, _75$$50, _77$$49, _78$$52, _80$$54, _82$$53, _83$$56, _85$$57, *_86$$57, _87$$57, _88$$59, _90$$58, _91$$61, _93$$63, _95$$62, _96$$65, _98$$66;
	zval className;
	zval *this_ptr = getThis();
	...
	if (Z_TYPE_P(&namespaces) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&namespaces), _5, _6, _3)
		{
			...
			zephir_is_iterable(&directories, 0, "phalcon/loader.zep", 424);
			if (Z_TYPE_P(&directories) == IS_ARRAY) {
				ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&directories), _10$$6)
				{
					...
					zephir_is_iterable(&extensions, 0, "phalcon/loader.zep", 423);
					if (Z_TYPE_P(&extensions) == IS_ARRAY) {
						ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&extensions), _13$$9)
						{
							...
							ZEPHIR_CALL_FUNCTION(&_17$$10, "call_user_func", &_18, 281, &fileCheckingCallback, &filePath);
							zephir_check_call_status();
						...
						while (1) {
							...
							zephir_check_call_status();
								...
								ZEPHIR_CALL_FUNCTION(&_23$$14, "call_user_func", &_18, 281, &fileCheckingCallback, &filePath);
								zephir_check_call_status();
					...
					zephir_check_call_status();
						...
						if (Z_TYPE_P(&extensions) == IS_ARRAY) {
							ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&extensions), _27$$18)
							{
								...
								ZEPHIR_CALL_FUNCTION(&_31$$19, "call_user_func", &_18, 281, &fileCheckingCallback, &filePath);
								zephir_check_call_status();
							...
							while (1) {
								...
								zephir_check_call_status();
									...
									ZEPHIR_CALL_FUNCTION(&_36$$23, "call_user_func", &_18, 281, &fileCheckingCallback, &filePath);
									zephir_check_call_status();
					...
					ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&directories), _42$$27)
					{
						...
						if (Z_TYPE_P(&extensions) == IS_ARRAY) {
							ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&extensions), _45$$30)
							{
								...
								ZEPHIR_CALL_FUNCTION(&_49$$31, "call_user_func", &_18, 281, &fileCheckingCallback, &filePath);
								zephir_check_call_status();
							...
							while (1) {
								...
								zephir_check_call_status();
									...
									ZEPHIR_CALL_FUNCTION(&_54$$35, "call_user_func", &_18, 281, &fileCheckingCallback, &filePath);
									zephir_check_call_status();
						...
						zephir_check_call_status();
							...
							if (Z_TYPE_P(&extensions) == IS_ARRAY) {
								ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&extensions), _58$$39)
								{
									...
									ZEPHIR_CALL_FUNCTION(&_62$$40, "call_user_func", &_18, 281, &fileCheckingCallback, &filePath);
									zephir_check_call_status();
								...
								while (1) {
									...
									zephir_check_call_status();
										...
										ZEPHIR_CALL_FUNCTION(&_67$$44, "call_user_func", &_18, 281, &fileCheckingCallback, &filePath);
										zephir_check_call_status();
	...
	zephir_is_iterable(&directories, 0, "phalcon/loader.zep", 484);
	if (Z_TYPE_P(&directories) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&directories), _70)
		{
			...
			zephir_is_iterable(&extensions, 0, "phalcon/loader.zep", 479);
			if (Z_TYPE_P(&extensions) == IS_ARRAY) {
				ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&extensions), _73$$48)
				{
					...
					ZEPHIR_CALL_FUNCTION(&_77$$49, "call_user_func", &_18, 281, &fileCheckingCallback, &filePath);
					zephir_check_call_status();
				...
				while (1) {
					...
					zephir_check_call_status();
						...
						ZEPHIR_CALL_FUNCTION(&_82$$53, "call_user_func", &_18, 281, &fileCheckingCallback, &filePath);
						zephir_check_call_status();
			...
			zephir_check_call_status();
				...
				if (Z_TYPE_P(&extensions) == IS_ARRAY) {
					ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&extensions), _86$$57)
					{
						...
						ZEPHIR_CALL_FUNCTION(&_90$$58, "call_user_func", &_18, 281, &fileCheckingCallback, &filePath);
						zephir_check_call_status();
					...
					while (1) {
						...
						zephir_check_call_status();
							...
							ZEPHIR_CALL_FUNCTION(&_95$$62, "call_user_func", &_18, 281, &fileCheckingCallback, &filePath);
							zephir_check_call_status();
