...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_phalcon_cache_frontend_factory_load, 0, 1, Phalcon\\Cache\\FrontendInterface, 0)
#else
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_phalcon_cache_frontend_factory_load, 0, 1, IS_OBJECT, "Phalcon\\Cache\\FrontendInterface", 0)
#endif
