...
PHP_METHOD(Phalcon_Validation_Validator_PresenceOf, validate) {
	...
	zval field;
	zval *validation, validation_sub, *field_param = NULL, value, message, label, replacePairs, code, _1$$3, _2$$3, _3$$3;
	...
	if (_0) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_1$$3, "__construct", NULL, 434, &_2$$3, &field, &_3$$3, &code);
		zephir_check_call_status();
