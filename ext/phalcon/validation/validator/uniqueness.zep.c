...
PHP_METHOD(Phalcon_Validation_Validator_Uniqueness, validate) {
	...
	if (!(zephir_is_true(&_0))) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_1$$3, "__construct", NULL, 434, &_4$$3, field, &_6$$3, &_5$$3);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Validation_Validator_Uniqueness, isUniqueness) {
	...
	isDocument = zephir_instance_of_ev(&record, phalcon_mvc_collectioninterface_ce);
	if (isModel) {
...
PHP_METHOD(Phalcon_Validation_Validator_Uniqueness, getColumnNameReal) {
	...
	if (_7) {
		...
		zephir_array_fetch(&_10$$4, &_9$$4, &field, PH_NOISY | PH_READONLY, "phalcon/validation/validator/uniqueness.zep", 201);
		RETURN_CTOR(&_10$$4);
	}
	RETURN_CTOR(&field);
...
PHP_METHOD(Phalcon_Validation_Validator_Uniqueness, isUniquenessModel) {
	...
	if (Z_TYPE_P(&field) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&field), _1)
		{
			...
			zephir_array_fetch(&value, &values, &singleField, PH_NOISY, "phalcon/validation/validator/uniqueness.zep", 226);
			...
			if (zephir_is_true(&except)) {
				...
				if (_9$$6) {
					...
					ZEPHIR_CALL_FUNCTION(&_13$$6, "range", &_14, 422, &_11$$6, &_12$$6);
					zephir_check_call_status();
				...
				if (_9$$6) {
							...
							if (Z_TYPE_P(&fieldExcept) == IS_ARRAY) {
								...
								if (Z_TYPE_P(&fieldExcept) == IS_ARRAY) {
									ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&fieldExcept), _21$$9)
									{
										...
										zephir_array_append(&notInValues, &_24$$10, PH_SEPARATE, "phalcon/validation/validator/uniqueness.zep", 245);
									...
									while (1) {
										...
										zephir_check_call_status();
											...
											zephir_array_append(&notInValues, &_26$$11, PH_SEPARATE, "phalcon/validation/validator/uniqueness.zep", 245);
											zephir_array_update_multi(&params, &singleExcept, SL("sa"), 3, SL("bind"));
											index++;
								...
								zephir_array_append(&exceptConditions, &_28$$9, PH_SEPARATE, "phalcon/validation/validator/uniqueness.zep", 249);
							} else {
								ZEPHIR_INIT_NVAR(&_29$$12);
								ZVAL_LONG(&_29$$12, index);
								ZEPHIR_INIT_NVAR(&_30$$12);
								ZEPHIR_CONCAT_VSV(&_30$$12, &attribute, " <> ?", &_29$$12);
								zephir_array_append(&exceptConditions, &_30$$12, PH_SEPARATE, "phalcon/validation/validator/uniqueness.zep", 251);
								...
								if (Z_TYPE_P(&fieldExcept) == IS_ARRAY) {
									...
									if (Z_TYPE_P(&fieldExcept) == IS_ARRAY) {
										ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&fieldExcept), _33$$14)
										{
											...
											zephir_array_append(&notInValues, &_36$$15, PH_SEPARATE, "phalcon/validation/validator/uniqueness.zep", 245);
											zephir_array_update_multi(&params, &singleExcept, SL("sa"), 3, SL("bind"));
											index++;
										} ZEND_HASH_FOREACH_END();
									} else {
										...
										while (1) {
											...
											zephir_check_call_status();
												...
												zephir_array_append(&notInValues, &_38$$16, PH_SEPARATE, "phalcon/validation/validator/uniqueness.zep", 245);
												zephir_array_update_multi(&params, &singleExcept, SL("sa"), 3, SL("bind"));
												index++;
											ZEPHIR_CALL_METHOD(NULL, &fieldExcept, "next", NULL, 0);
											zephir_check_call_status();
									...
									zephir_array_append(&exceptConditions, &_40$$14, PH_SEPARATE, "phalcon/validation/validator/uniqueness.zep", 249);
								} else {
									ZEPHIR_INIT_NVAR(&_41$$17);
									ZVAL_LONG(&_41$$17, index);
									ZEPHIR_INIT_NVAR(&_42$$17);
									ZEPHIR_CONCAT_VSV(&_42$$17, &attribute, " <> ?", &_41$$17);
									zephir_array_append(&exceptConditions, &_42$$17, PH_SEPARATE, "phalcon/validation/validator/uniqueness.zep", 251);
									zephir_array_update_multi(&params, &fieldExcept, SL("sa"), 3, SL("bind"));
									index++;
								}
					...
					zephir_array_fetch_long(&_44$$18, &field, 0, PH_NOISY | PH_READONLY, "phalcon/validation/validator/uniqueness.zep", 257);
					...
					if (Z_TYPE_P(&except) == IS_ARRAY) {
						...
						if (Z_TYPE_P(&except) == IS_ARRAY) {
							ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&except), _46$$19)
							{
								...
								zephir_array_append(&notInValues, &_49$$20, PH_SEPARATE, "phalcon/validation/validator/uniqueness.zep", 260);
								zephir_array_update_multi(&params, &singleExcept, SL("sa"), 3, SL("bind"));
								index++;
							} ZEND_HASH_FOREACH_END();
						} else {
							...
							while (1) {
								...
								zephir_check_call_status();
									...
									zephir_array_append(&notInValues, &_51$$21, PH_SEPARATE, "phalcon/validation/validator/uniqueness.zep", 260);
									zephir_array_update_multi(&params, &singleExcept, SL("sa"), 3, SL("bind"));
									index++;
								ZEPHIR_CALL_METHOD(NULL, &except, "next", NULL, 0);
								zephir_check_call_status();
						...
						zephir_array_append(&exceptConditions, &_53$$19, PH_SEPARATE, "phalcon/validation/validator/uniqueness.zep", 264);
					} else {
							...
							if (Z_TYPE_P(&except) == IS_ARRAY) {
								...
								if (Z_TYPE_P(&except) == IS_ARRAY) {
									ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&except), _60$$25)
									{
										...
										zephir_array_append(&notInValues, &_63$$26, PH_SEPARATE, "phalcon/validation/validator/uniqueness.zep", 275);
										zephir_array_update_multi(&params, &singleExcept, SL("sa"), 3, SL("bind"));
										index++;
									} ZEND_HASH_FOREACH_END();
								} else {
									...
									while (1) {
										...
										zephir_check_call_status();
											...
											zephir_array_append(&notInValues, &_65$$27, PH_SEPARATE, "phalcon/validation/validator/uniqueness.zep", 275);
											zephir_array_update_multi(&params, &singleExcept, SL("sa"), 3, SL("bind"));
											index++;
										ZEPHIR_CALL_METHOD(NULL, &except, "next", NULL, 0);
										zephir_check_call_status();
								...
								zephir_array_append(&exceptConditions, &_67$$25, PH_SEPARATE, "phalcon/validation/validator/uniqueness.zep", 279);
							} else {
								...
								if (Z_TYPE_P(&except) == IS_ARRAY) {
									...
									if (Z_TYPE_P(&except) == IS_ARRAY) {
										ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&except), _72$$30)
										{
											...
											zephir_array_append(&notInValues, &_75$$31, PH_SEPARATE, "phalcon/validation/validator/uniqueness.zep", 275);
											zephir_array_update_multi(&params, &singleExcept, SL("sa"), 3, SL("bind"));
											index++;
										} ZEND_HASH_FOREACH_END();
									} else {
										...
										while (1) {
											...
											zephir_check_call_status();
												...
												zephir_array_append(&notInValues, &_77$$32, PH_SEPARATE, "phalcon/validation/validator/uniqueness.zep", 275);
												zephir_array_update_multi(&params, &singleExcept, SL("sa"), 3, SL("bind"));
												index++;
											ZEPHIR_CALL_METHOD(NULL, &except, "next", NULL, 0);
											zephir_check_call_status();
									...
									zephir_array_append(&exceptConditions, &_79$$30, PH_SEPARATE, "phalcon/validation/validator/uniqueness.zep", 279);
								} else {
			...
			zephir_check_call_status();
				...
				if (zephir_is_true(&except)) {
					...
					if (_87$$37) {
						...
						ZEPHIR_CALL_FUNCTION(&_91$$37, "range", &_14, 422, &_89$$37, &_90$$37);
						zephir_check_call_status();
					...
					if (_87$$37) {
								...
								if (Z_TYPE_P(&fieldExcept) == IS_ARRAY) {
									...
									if (Z_TYPE_P(&fieldExcept) == IS_ARRAY) {
										ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&fieldExcept), _98$$40)
										{
											...
											zephir_array_append(&notInValues, &_101$$41, PH_SEPARATE, "phalcon/validation/validator/uniqueness.zep", 245);
											zephir_array_update_multi(&params, &singleExcept, SL("sa"), 3, SL("bind"));
											index++;
										} ZEND_HASH_FOREACH_END();
									} else {
										...
										while (1) {
											...
											zephir_check_call_status();
												...
												zephir_array_append(&notInValues, &_103$$42, PH_SEPARATE, "phalcon/validation/validator/uniqueness.zep", 245);
												zephir_array_update_multi(&params, &singleExcept, SL("sa"), 3, SL("bind"));
												index++;
											ZEPHIR_CALL_METHOD(NULL, &fieldExcept, "next", NULL, 0);
											zephir_check_call_status();
									...
									zephir_array_append(&exceptConditions, &_105$$40, PH_SEPARATE, "phalcon/validation/validator/uniqueness.zep", 249);
								} else {
									ZEPHIR_INIT_NVAR(&_106$$43);
									ZVAL_LONG(&_106$$43, index);
									ZEPHIR_INIT_NVAR(&_107$$43);
									ZEPHIR_CONCAT_VSV(&_107$$43, &attribute, " <> ?", &_106$$43);
									zephir_array_append(&exceptConditions, &_107$$43, PH_SEPARATE, "phalcon/validation/validator/uniqueness.zep", 251);
									zephir_array_update_multi(&params, &fieldExcept, SL("sa"), 3, SL("bind"));
									index++;
								}
							} ZEND_HASH_FOREACH_END();
									...
									if (Z_TYPE_P(&fieldExcept) == IS_ARRAY) {
										...
										if (Z_TYPE_P(&fieldExcept) == IS_ARRAY) {
											ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&fieldExcept), _110$$45)
											{
												...
												zephir_array_append(&notInValues, &_113$$46, PH_SEPARATE, "phalcon/validation/validator/uniqueness.zep", 245);
												zephir_array_update_multi(&params, &singleExcept, SL("sa"), 3, SL("bind"));
												index++;
											} ZEND_HASH_FOREACH_END();
										} else {
											...
											while (1) {
												...
												zephir_check_call_status();
													...
													zephir_array_append(&notInValues, &_115$$47, PH_SEPARATE, "phalcon/validation/validator/uniqueness.zep", 245);
													zephir_array_update_multi(&params, &singleExcept, SL("sa"), 3, SL("bind"));
													index++;
												ZEPHIR_CALL_METHOD(NULL, &fieldExcept, "next", NULL, 0);
												zephir_check_call_status();
										...
										zephir_array_append(&exceptConditions, &_117$$45, PH_SEPARATE, "phalcon/validation/validator/uniqueness.zep", 249);
									} else {
										ZEPHIR_INIT_NVAR(&_118$$48);
										ZVAL_LONG(&_118$$48, index);
										ZEPHIR_INIT_NVAR(&_119$$48);
										ZEPHIR_CONCAT_VSV(&_119$$48, &attribute, " <> ?", &_118$$48);
										zephir_array_append(&exceptConditions, &_119$$48, PH_SEPARATE, "phalcon/validation/validator/uniqueness.zep", 251);
										zephir_array_update_multi(&params, &fieldExcept, SL("sa"), 3, SL("bind"));
										index++;
									}
								ZEPHIR_CALL_METHOD(NULL, &except, "next", NULL, 0);
						...
						zephir_array_fetch_long(&_121$$49, &field, 0, PH_NOISY | PH_READONLY, "phalcon/validation/validator/uniqueness.zep", 257);
						...
						if (Z_TYPE_P(&except) == IS_ARRAY) {
							...
							if (Z_TYPE_P(&except) == IS_ARRAY) {
								ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&except), _123$$50)
								{
									...
									zephir_array_append(&notInValues, &_126$$51, PH_SEPARATE, "phalcon/validation/validator/uniqueness.zep", 260);
									zephir_array_update_multi(&params, &singleExcept, SL("sa"), 3, SL("bind"));
									index++;
								} ZEND_HASH_FOREACH_END();
							} else {
								...
								while (1) {
									...
									zephir_check_call_status();
										...
										zephir_array_append(&notInValues, &_128$$52, PH_SEPARATE, "phalcon/validation/validator/uniqueness.zep", 260);
										zephir_array_update_multi(&params, &singleExcept, SL("sa"), 3, SL("bind"));
										index++;
									ZEPHIR_CALL_METHOD(NULL, &except, "next", NULL, 0);
									zephir_check_call_status();
							...
							zephir_array_append(&exceptConditions, &_130$$50, PH_SEPARATE, "phalcon/validation/validator/uniqueness.zep", 264);
						} else {
								...
								if (Z_TYPE_P(&except) == IS_ARRAY) {
									...
									if (Z_TYPE_P(&except) == IS_ARRAY) {
										ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&except), _137$$56)
										{
											...
											zephir_array_append(&notInValues, &_140$$57, PH_SEPARATE, "phalcon/validation/validator/uniqueness.zep", 275);
											zephir_array_update_multi(&params, &singleExcept, SL("sa"), 3, SL("bind"));
											index++;
										} ZEND_HASH_FOREACH_END();
									} else {
										...
										while (1) {
											...
											zephir_check_call_status();
												...
												zephir_array_append(&notInValues, &_142$$58, PH_SEPARATE, "phalcon/validation/validator/uniqueness.zep", 275);
												zephir_array_update_multi(&params, &singleExcept, SL("sa"), 3, SL("bind"));
												index++;
											ZEPHIR_CALL_METHOD(NULL, &except, "next", NULL, 0);
											zephir_check_call_status();
									...
									zephir_array_append(&exceptConditions, &_144$$56, PH_SEPARATE, "phalcon/validation/validator/uniqueness.zep", 279);
								} else {
									...
									if (Z_TYPE_P(&except) == IS_ARRAY) {
										...
										if (Z_TYPE_P(&except) == IS_ARRAY) {
											ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&except), _149$$61)
											{
												...
												zephir_array_append(&notInValues, &_152$$62, PH_SEPARATE, "phalcon/validation/validator/uniqueness.zep", 275);
												zephir_array_update_multi(&params, &singleExcept, SL("sa"), 3, SL("bind"));
												index++;
											} ZEND_HASH_FOREACH_END();
										} else {
											...
											while (1) {
												...
												zephir_check_call_status();
													...
													zephir_array_append(&notInValues, &_154$$63, PH_SEPARATE, "phalcon/validation/validator/uniqueness.zep", 275);
													zephir_array_update_multi(&params, &singleExcept, SL("sa"), 3, SL("bind"));
													index++;
												ZEPHIR_CALL_METHOD(NULL, &except, "next", NULL, 0);
												zephir_check_call_status();
										...
										zephir_array_append(&exceptConditions, &_156$$61, PH_SEPARATE, "phalcon/validation/validator/uniqueness.zep", 279);
									} else {
	...
	if (ZEPHIR_IS_LONG(&_159, 0)) {
		...
		zephir_check_call_status();
		zephir_is_iterable(&_162$$65, 0, "phalcon/validation/validator/uniqueness.zep", 301);
	...
	ZEPHIR_INIT_NVAR(&_0);
	zephir_array_fetch_string(&_177, &params, SL("conditions"), PH_NOISY | PH_READONLY, "phalcon/validation/validator/uniqueness.zep", 307);
...
PHP_METHOD(Phalcon_Validation_Validator_Uniqueness, isUniquenessCollection) {
	...
	zend_bool _5$$6, _6$$6, _12$$21, _13$$21;
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zephir_fcall_cache_entry *_4 = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval field, values, arrayValue$$10, arrayValue$$13, arrayValue$$14, arrayValue$$17, arrayValue$$25, arrayValue$$28, arrayValue$$29, arrayValue$$32, arrayValue$$33, _20$$34;
	zval *record, record_sub, *field_param = NULL, *values_param = NULL, __$null, exceptConditions, fieldExcept, notInValues, value, singleField, params, except, singleExcept, _0, *_1, _2, _18, _3$$3, *_7$$10, _8$$10, *_9$$14, _10$$14, _11$$18, *_14$$25, _15$$25, *_16$$29, _17$$29, _19$$33;
	zval *this_ptr = getThis();
	...
	ZVAL_UNDEF(&arrayValue$$14);
	ZVAL_UNDEF(&arrayValue$$17);
	ZVAL_UNDEF(&arrayValue$$25);
	ZVAL_UNDEF(&arrayValue$$28);
	ZVAL_UNDEF(&arrayValue$$29);
	ZVAL_UNDEF(&arrayValue$$32);
	ZVAL_UNDEF(&arrayValue$$33);
	ZVAL_UNDEF(&_20$$34);
	...
	if (Z_TYPE_P(&field) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&field), _1)
		{
			...
			array_init(&notInValues);
			ZEPHIR_OBS_NVAR(&value);
			zephir_array_fetch(&value, &values, &singleField, PH_NOISY, "phalcon/validation/validator/uniqueness.zep", 325);
			ZEPHIR_INIT_NVAR(&_3$$3);
			ZVAL_STRING(&_3$$3, "except");
			ZEPHIR_CALL_METHOD(&except, this_ptr, "getoption", &_4, 0, &_3$$3);
			zephir_check_call_status();
			if (Z_TYPE_P(&value) != IS_NULL) {
				zephir_array_update_multi(&params, &value, SL("sz"), 3, SL("conditions"), &singleField);
			} else {
				zephir_array_update_multi(&params, &__$null, SL("sz"), 3, SL("conditions"), &singleField);
			}
			if (zephir_is_true(&except)) {
				_5$$6 = Z_TYPE_P(&except) == IS_ARRAY;
				if (_5$$6) {
					_5$$6 = zephir_fast_count_int(&field) > 1;
				}
				if (_5$$6) {
					if (zephir_array_isset(&except, &singleField)) {
						ZEPHIR_OBS_NVAR(&fieldExcept);
						zephir_array_fetch(&fieldExcept, &except, &singleField, PH_NOISY, "phalcon/validation/validator/uniqueness.zep", 338);
					}
				}
				_6$$6 = Z_TYPE_P(&except) == IS_ARRAY;
				if (_6$$6) {
					_6$$6 = zephir_fast_count_int(&field) == 1;
				}
				if (Z_TYPE_P(&fieldExcept) != IS_NULL) {
					if (Z_TYPE_P(&fieldExcept) == IS_ARRAY) {
						zephir_is_iterable(&fieldExcept, 0, "phalcon/validation/validator/uniqueness.zep", 347);
						if (Z_TYPE_P(&fieldExcept) == IS_ARRAY) {
							ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&fieldExcept), _7$$10)
							{
								ZEPHIR_INIT_NVAR(&singleExcept);
								ZVAL_COPY(&singleExcept, _7$$10);
							...
							zephir_check_call_status();
							while (1) {
								ZEPHIR_CALL_METHOD(&_8$$10, &fieldExcept, "valid", NULL, 0);
								zephir_check_call_status();
						...
						zephir_create_array(&arrayValue$$10, 1, 0);
						...
						zephir_create_array(&arrayValue$$13, 1, 0);
						zephir_array_update_string(&arrayValue$$13, SL("$ne"), &fieldExcept, PH_COPY | PH_SEPARATE);
						zephir_array_update_zval(&exceptConditions, &singleField, &arrayValue$$13, PH_COPY | PH_SEPARATE);
					}
				} else if (_6$$6) {
					zephir_is_iterable(&except, 0, "phalcon/validation/validator/uniqueness.zep", 357);
					if (Z_TYPE_P(&except) == IS_ARRAY) {
						ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&except), _9$$14)
						{
							ZEPHIR_INIT_NVAR(&singleExcept);
							ZVAL_COPY(&singleExcept, _9$$14);
						...
						zephir_check_call_status();
						while (1) {
							ZEPHIR_CALL_METHOD(&_10$$14, &except, "valid", NULL, 0);
							zephir_check_call_status();
							if (!zend_is_true(&_10$$14)) {
								break;
							}
							ZEPHIR_CALL_METHOD(&singleExcept, &except, "current", NULL, 0);
							zephir_check_call_status();
					...
					ZEPHIR_INIT_NVAR(&singleExcept);
					ZEPHIR_INIT_NVAR(&arrayValue$$14);
					zephir_create_array(&arrayValue$$14, 1, 0);
					zephir_array_update_string(&arrayValue$$14, SL("$nin"), &notInValues, PH_COPY | PH_SEPARATE);
					zephir_array_update_multi(&params, &arrayValue$$14, SL("sz"), 3, SL("conditions"), &singleField);
				} else if (zephir_fast_count_int(&field) == 1) {
					ZEPHIR_INIT_NVAR(&arrayValue$$17);
					zephir_create_array(&arrayValue$$17, 1, 0);
					zephir_array_update_string(&arrayValue$$17, SL("$ne"), &except, PH_COPY | PH_SEPARATE);
					zephir_array_update_multi(&params, &arrayValue$$17, SL("sz"), 3, SL("conditions"), &singleField);
				}
			}
		} ZEND_HASH_FOREACH_END();
	} else {
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				ZVAL_STRING(&_11$$18, "except");
				ZEPHIR_CALL_METHOD(&except, this_ptr, "getoption", &_4, 0, &_11$$18);
				zephir_check_call_status();
				if (Z_TYPE_P(&value) != IS_NULL) {
					zephir_array_update_multi(&params, &value, SL("sz"), 3, SL("conditions"), &singleField);
				} else {
				...
				if (zephir_is_true(&except)) {
					_12$$21 = Z_TYPE_P(&except) == IS_ARRAY;
					if (_12$$21) {
						_12$$21 = zephir_fast_count_int(&field) > 1;
					}
					if (_12$$21) {
						if (zephir_array_isset(&except, &singleField)) {
							ZEPHIR_OBS_NVAR(&fieldExcept);
					...
					_13$$21 = Z_TYPE_P(&except) == IS_ARRAY;
					if (_13$$21) {
						_13$$21 = zephir_fast_count_int(&field) == 1;
					}
					if (Z_TYPE_P(&fieldExcept) != IS_NULL) {
						if (Z_TYPE_P(&fieldExcept) == IS_ARRAY) {
							zephir_is_iterable(&fieldExcept, 0, "phalcon/validation/validator/uniqueness.zep", 347);
							if (Z_TYPE_P(&fieldExcept) == IS_ARRAY) {
								ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&fieldExcept), _14$$25)
								{
									ZEPHIR_INIT_NVAR(&singleExcept);
									ZVAL_COPY(&singleExcept, _14$$25);
									zephir_array_append(&notInValues, &singleExcept, PH_SEPARATE, "phalcon/validation/validator/uniqueness.zep", 345);
								} ZEND_HASH_FOREACH_END();
							} else {
								ZEPHIR_CALL_METHOD(NULL, &fieldExcept, "rewind", NULL, 0);
								zephir_check_call_status();
								while (1) {
									ZEPHIR_CALL_METHOD(&_15$$25, &fieldExcept, "valid", NULL, 0);
									zephir_check_call_status();
									if (!zend_is_true(&_15$$25)) {
										break;
									}
									ZEPHIR_CALL_METHOD(&singleExcept, &fieldExcept, "current", NULL, 0);
									zephir_check_call_status();
							...
							ZEPHIR_INIT_NVAR(&singleExcept);
							ZEPHIR_INIT_NVAR(&arrayValue$$25);
							zephir_create_array(&arrayValue$$25, 1, 0);
							zephir_array_update_string(&arrayValue$$25, SL("$nin"), &notInValues, PH_COPY | PH_SEPARATE);
							zephir_array_update_zval(&exceptConditions, &singleField, &arrayValue$$25, PH_COPY | PH_SEPARATE);
						} else {
							ZEPHIR_INIT_NVAR(&arrayValue$$28);
							zephir_create_array(&arrayValue$$28, 1, 0);
							zephir_array_update_string(&arrayValue$$28, SL("$ne"), &fieldExcept, PH_COPY | PH_SEPARATE);
							zephir_array_update_zval(&exceptConditions, &singleField, &arrayValue$$28, PH_COPY | PH_SEPARATE);
						}
					} else if (_13$$21) {
						zephir_is_iterable(&except, 0, "phalcon/validation/validator/uniqueness.zep", 357);
						if (Z_TYPE_P(&except) == IS_ARRAY) {
							ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&except), _16$$29)
							{
								ZEPHIR_INIT_NVAR(&singleExcept);
								ZVAL_COPY(&singleExcept, _16$$29);
								zephir_array_append(&notInValues, &singleExcept, PH_SEPARATE, "phalcon/validation/validator/uniqueness.zep", 355);
							} ZEND_HASH_FOREACH_END();
						} else {
							ZEPHIR_CALL_METHOD(NULL, &except, "rewind", NULL, 0);
							zephir_check_call_status();
							while (1) {
								ZEPHIR_CALL_METHOD(&_17$$29, &except, "valid", NULL, 0);
								zephir_check_call_status();
								if (!zend_is_true(&_17$$29)) {
									break;
								}
								ZEPHIR_CALL_METHOD(&singleExcept, &except, "current", NULL, 0);
								zephir_check_call_status();
						...
						ZEPHIR_INIT_NVAR(&singleExcept);
						ZEPHIR_INIT_NVAR(&arrayValue$$29);
						zephir_create_array(&arrayValue$$29, 1, 0);
						zephir_array_update_string(&arrayValue$$29, SL("$nin"), &notInValues, PH_COPY | PH_SEPARATE);
						zephir_array_update_multi(&params, &arrayValue$$29, SL("sz"), 3, SL("conditions"), &singleField);
					} else if (zephir_fast_count_int(&field) == 1) {
						ZEPHIR_INIT_NVAR(&arrayValue$$32);
						zephir_create_array(&arrayValue$$32, 1, 0);
						zephir_array_update_string(&arrayValue$$32, SL("$ne"), &except, PH_COPY | PH_SEPARATE);
						zephir_array_update_multi(&params, &arrayValue$$32, SL("sz"), 3, SL("conditions"), &singleField);
					}
				}
			ZEPHIR_CALL_METHOD(NULL, &field, "next", NULL, 0);
			zephir_check_call_status();
	...
	ZEPHIR_INIT_NVAR(&singleField);
	ZEPHIR_CALL_METHOD(&_18, record, "getdirtystate", NULL, 0);
	zephir_check_call_status();
	if (ZEPHIR_IS_LONG(&_18, 0)) {
		ZEPHIR_INIT_VAR(&arrayValue$$33);
		zephir_create_array(&arrayValue$$33, 1, 0);
		ZEPHIR_CALL_METHOD(&_19$$33, record, "getid", NULL, 0);
		zephir_check_call_status();
		zephir_array_update_string(&arrayValue$$33, SL("$ne"), &_19$$33, PH_COPY | PH_SEPARATE);
		zephir_array_update_multi(&params, &arrayValue$$33, SL("ss"), 4, SL("conditions"), SL("_id"));
	}
	if (!(ZEPHIR_IS_EMPTY(&exceptConditions))) {
		ZEPHIR_INIT_VAR(&_20$$34);
		zephir_create_array(&_20$$34, 1, 0);
		zephir_array_fast_append(&_20$$34, &exceptConditions);
		zephir_array_update_multi(&params, &_20$$34, SL("ss"), 4, SL("conditions"), SL("$or"));
	}
	RETURN_CCTOR(&params);
