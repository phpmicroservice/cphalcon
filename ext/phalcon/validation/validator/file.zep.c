...
PHP_METHOD(Phalcon_Validation_Validator_File, validate) {
	...
	zephir_check_call_status();
	zephir_array_fetch_string(&_0, &_SERVER, SL("REQUEST_METHOD"), PH_NOISY | PH_READONLY, "phalcon/validation/validator/file.zep", 112);
	...
	_3 = _2;
	if (_3) {
		zephir_array_fetch_string(&_4, &_SERVER, SL("CONTENT_LENGTH"), PH_NOISY | PH_READONLY, "phalcon/validation/validator/file.zep", 112);
	...
	if (!(_5)) {
		...
		if (_6) {
			zephir_array_fetch_string(&_7, &value, SL("error"), PH_NOISY | PH_READONLY, "phalcon/validation/validator/file.zep", 112);
	...
	if (_5) {
		...
		ZEPHIR_CALL_FUNCTION(&_10$$3, "strtr", NULL, 22, &message, &replacePairs);
		zephir_check_call_status();
		ZEPHIR_INIT_NVAR(&_9$$3);
		ZVAL_STRING(&_9$$3, "FileIniSize");
		ZEPHIR_CALL_METHOD(NULL, &_8$$3, "__construct", NULL, 434, &_10$$3, &field, &_9$$3, &code);
		zephir_check_call_status();
	...
	_12 = _11;
	if (!(_12)) {
		zephir_array_fetch_string(&_13, &value, SL("error"), PH_NOISY | PH_READONLY, "phalcon/validation/validator/file.zep", 128);
		_12 = !ZEPHIR_IS_LONG_IDENTICAL(&_13, 0);
	}
	_14 = _12;
	if (!(_14)) {
		zephir_array_fetch_string(&_15, &value, SL("tmp_name"), PH_NOISY | PH_READONLY, "phalcon/validation/validator/file.zep", 128);
		ZEPHIR_CALL_FUNCTION(&_16, "is_uploaded_file", NULL, 226, &_15);
		zephir_check_call_status();
	...
	if (_14) {
		...
		ZEPHIR_CALL_FUNCTION(&_20$$4, "strtr", NULL, 22, &message, &replacePairs);
		zephir_check_call_status();
		ZEPHIR_INIT_NVAR(&_18$$4);
		ZVAL_STRING(&_18$$4, "FileEmpty");
		ZEPHIR_CALL_METHOD(NULL, &_17$$4, "__construct", NULL, 434, &_20$$4, &field, &_18$$4, &code);
		zephir_check_call_status();
	...
	if (_22) {
		...
		object_init_ex(&_23$$5, phalcon_validation_message_ce);
		ZEPHIR_CALL_FUNCTION(&_26$$5, "strtr", NULL, 22, &message, &replacePairs);
		zephir_check_call_status();
		ZEPHIR_INIT_NVAR(&_24$$5);
		ZVAL_STRING(&_24$$5, "FileValid");
		ZEPHIR_CALL_METHOD(NULL, &_23$$5, "__construct", NULL, 434, &_26$$5, &field, &_24$$5, &code);
		zephir_check_call_status();
	...
	if (zephir_is_true(&_27)) {
		...
		if (Z_TYPE_P(&maxSize) == IS_ARRAY) {
			zephir_array_fetch(&_30$$7, &maxSize, &field, PH_NOISY | PH_READONLY, "phalcon/validation/validator/file.zep", 168);
			ZEPHIR_CPY_WRT(&maxSize, &_30$$7);
		}
		ZEPHIR_INIT_NVAR(&_29$$6);
		ZEPHIR_INIT_VAR(&_31$$6);
		zephir_array_keys(&_31$$6, &byteUnits);
		zephir_fast_join_str(&_29$$6, SL("|"), &_31$$6);
		ZEPHIR_INIT_VAR(&_32$$6);
		ZEPHIR_CONCAT_SVS(&_32$$6, "/^([0-9]+(?:\\.[0-9]+)?)(", &_29$$6, ")?$/Di");
		ZEPHIR_INIT_VAR(&_33$$6);
		zephir_preg_match(&_33$$6, &_32$$6, &maxSize, &matches, 0, 0 , 0 );
		if (zephir_array_isset_long(&matches, 2)) {
			ZEPHIR_OBS_NVAR(&unit);
			zephir_array_fetch_long(&unit, &matches, 2, PH_NOISY, "phalcon/validation/validator/file.zep", 174);
		}
		zephir_array_fetch_long(&_34$$6, &matches, 1, PH_NOISY | PH_READONLY, "phalcon/validation/validator/file.zep", 177);
		ZEPHIR_CALL_FUNCTION(&_35$$6, "floatval", NULL, 305, &_34$$6);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(&_36$$6);
		zephir_array_fetch(&_37$$6, &byteUnits, &unit, PH_NOISY | PH_READONLY, "phalcon/validation/validator/file.zep", 177);
		ZVAL_LONG(&_38$$6, 2);
		zephir_pow_function(&_36$$6, &_38$$6, &_37$$6);
		ZEPHIR_INIT_VAR(&bytes);
		mul_function(&bytes, &_35$$6, &_36$$6);
		zephir_array_fetch_string(&_39$$6, &value, SL("size"), PH_NOISY | PH_READONLY, "phalcon/validation/validator/file.zep", 179);
		ZEPHIR_CALL_FUNCTION(&_35$$6, "floatval", NULL, 305, &_39$$6);
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&_40$$6, "floatval", NULL, 305, &bytes);
		zephir_check_call_status();
		if (ZEPHIR_GT(&_35$$6, &_40$$6)) {
			...
			object_init_ex(&_41$$9, phalcon_validation_message_ce);
			ZEPHIR_CALL_FUNCTION(&_44$$9, "strtr", NULL, 22, &message, &replacePairs);
			zephir_check_call_status();
			ZEPHIR_INIT_NVAR(&_42$$9);
			ZVAL_STRING(&_42$$9, "FileSize");
			ZEPHIR_CALL_METHOD(NULL, &_41$$9, "__construct", NULL, 434, &_44$$9, &field, &_42$$9, &code);
			zephir_check_call_status();
	...
	if (zephir_is_true(&_45)) {
		...
		if ((zephir_function_exists_ex(ZEND_STRL("finfo_open")) == SUCCESS)) {
			ZVAL_LONG(&_47$$13, 16);
			ZEPHIR_CALL_FUNCTION(&tmp, "finfo_open", NULL, 223, &_47$$13);
			zephir_check_call_status();
			zephir_array_fetch_string(&_48$$13, &value, SL("tmp_name"), PH_NOISY | PH_READONLY, "phalcon/validation/validator/file.zep", 210);
			ZEPHIR_CALL_FUNCTION(&mime, "finfo_file", NULL, 224, &tmp, &_48$$13);
			zephir_check_call_status();
			ZEPHIR_CALL_FUNCTION(NULL, "finfo_close", NULL, 225, &tmp);
			zephir_check_call_status();
		} else {
			ZEPHIR_OBS_NVAR(&mime);
			zephir_array_fetch_string(&mime, &value, SL("type"), PH_NOISY, "phalcon/validation/validator/file.zep", 214);
		}
		if (!(zephir_fast_in_array(&mime, &types))) {
			...
			zephir_fast_join_str(&_49$$15, SL(", "), &types);
			...
			ZEPHIR_CALL_FUNCTION(&_52$$15, "strtr", NULL, 22, &message, &replacePairs);
			zephir_check_call_status();
			ZEPHIR_INIT_NVAR(&_50$$15);
			ZVAL_STRING(&_50$$15, "FileType");
			ZEPHIR_CALL_METHOD(NULL, &_49$$15, "__construct", NULL, 434, &_52$$15, &field, &_50$$15, &code);
			zephir_check_call_status();
	...
	if (_54) {
		zephir_array_fetch_string(&_56$$16, &value, SL("tmp_name"), PH_NOISY | PH_READONLY, "phalcon/validation/validator/file.zep", 235);
		ZEPHIR_CALL_FUNCTION(&tmp, "getimagesize", NULL, 234, &_56$$16);
		zephir_check_call_status();
		ZEPHIR_OBS_VAR(&width);
		zephir_array_fetch_long(&width, &tmp, 0, PH_NOISY, "phalcon/validation/validator/file.zep", 236);
		ZEPHIR_OBS_VAR(&height);
		zephir_array_fetch_long(&height, &tmp, 1, PH_NOISY, "phalcon/validation/validator/file.zep", 237);
		...
		if (zephir_is_true(&_57$$16)) {
			...
			if (Z_TYPE_P(&minResolution) == IS_ARRAY) {
				zephir_array_fetch(&_60$$18, &minResolution, &field, PH_NOISY | PH_READONLY, "phalcon/validation/validator/file.zep", 242);
				ZEPHIR_CPY_WRT(&minResolution, &_60$$18);
			}
			ZEPHIR_INIT_VAR(&minResolutionArray);
			zephir_fast_explode_str(&minResolutionArray, SL("x"), &minResolution, LONG_MAX);
			ZEPHIR_OBS_VAR(&minWidth);
			zephir_array_fetch_long(&minWidth, &minResolutionArray, 0, PH_NOISY, "phalcon/validation/validator/file.zep", 245);
			ZEPHIR_OBS_VAR(&minHeight);
			zephir_array_fetch_long(&minHeight, &minResolutionArray, 1, PH_NOISY, "phalcon/validation/validator/file.zep", 246);
		} else {
		...
		if (_61$$16) {
			...
			zephir_create_array(&_64$$20, 2, 0);
			...
			object_init_ex(&_62$$20, phalcon_validation_message_ce);
			ZEPHIR_CALL_FUNCTION(&_65$$20, "strtr", NULL, 22, &message, &replacePairs);
			zephir_check_call_status();
			ZEPHIR_INIT_NVAR(&_63$$20);
			ZVAL_STRING(&_63$$20, "FileMinResolution");
			ZEPHIR_CALL_METHOD(NULL, &_62$$20, "__construct", NULL, 434, &_65$$20, &field, &_63$$20, &code);
			zephir_check_call_status();
		...
		if (zephir_is_true(&_66$$16)) {
			...
			if (Z_TYPE_P(&maxResolution) == IS_ARRAY) {
				zephir_array_fetch(&_68$$22, &maxResolution, &field, PH_NOISY | PH_READONLY, "phalcon/validation/validator/file.zep", 272);
				ZEPHIR_CPY_WRT(&maxResolution, &_68$$22);
			}
			ZEPHIR_INIT_VAR(&maxResolutionArray);
			zephir_fast_explode_str(&maxResolutionArray, SL("x"), &maxResolution, LONG_MAX);
			ZEPHIR_OBS_VAR(&maxWidth);
			zephir_array_fetch_long(&maxWidth, &maxResolutionArray, 0, PH_NOISY, "phalcon/validation/validator/file.zep", 275);
			ZEPHIR_OBS_VAR(&maxHeight);
			zephir_array_fetch_long(&maxHeight, &maxResolutionArray, 1, PH_NOISY, "phalcon/validation/validator/file.zep", 276);
			...
			if (_69$$21) {
				...
				zephir_create_array(&_72$$23, 2, 0);
				...
				ZEPHIR_CALL_FUNCTION(&_73$$23, "strtr", NULL, 22, &message, &replacePairs);
				zephir_check_call_status();
				ZEPHIR_INIT_NVAR(&_71$$23);
				ZVAL_STRING(&_71$$23, "FileMaxResolution");
				ZEPHIR_CALL_METHOD(NULL, &_70$$23, "__construct", NULL, 434, &_73$$23, &field, &_71$$23, &code);
				zephir_check_call_status();
...
PHP_METHOD(Phalcon_Validation_Validator_File, isAllowEmpty) {
	...
	if (!(_0)) {
		...
		if (_1) {
			zephir_array_fetch_string(&_2, &value, SL("error"), PH_NOISY | PH_READONLY, "phalcon/validation/validator/file.zep", 308);
