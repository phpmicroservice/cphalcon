...
#if PHP_VERSION_ID >= 70200
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_phalcon_http_responseinterface_sendheaders, 0, 0, Phalcon\\Http\\ResponseInterface, 0)
#else
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_phalcon_http_responseinterface_sendheaders, 0, 0, IS_OBJECT, "Phalcon\\Http\\ResponseInterface", 0)
#endif
ZEND_END_ARG_INFO()
