...
ZEPHIR_INIT_CLASS(Phalcon_Http_Cookie) {
	...
	zend_declare_property_null(phalcon_http_cookie_ce, SL("_dependencyInjector"), ZEND_ACC_PROTECTED);
	...
	zend_class_implements(phalcon_http_cookie_ce, 1, phalcon_http_cookieinterface_ce);
	zend_class_implements(phalcon_http_cookie_ce, 1, phalcon_di_injectionawareinterface_ce);
	return SUCCESS;
