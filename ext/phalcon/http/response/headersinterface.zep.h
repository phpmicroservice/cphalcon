...
#else
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_phalcon_http_response_headersinterface___set_state, 0, 1, IS_OBJECT, "Phalcon\\Http\\Response\\HeadersInterface", 0)
#endif
