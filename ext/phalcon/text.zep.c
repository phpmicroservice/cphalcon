...
PHP_METHOD(Phalcon_Text, random) {
	...
	do {
		if (type == 1) {
			...
			ZVAL_STRING(&_1$$3, "z");
			ZEPHIR_CALL_FUNCTION(&_2$$3, "range", NULL, 422, &_0$$3, &_1$$3);
			zephir_check_call_status();
			ZEPHIR_INIT_NVAR(&_0$$3);
			ZVAL_STRING(&_0$$3, "A");
			ZEPHIR_INIT_NVAR(&_1$$3);
			ZVAL_STRING(&_1$$3, "Z");
			ZEPHIR_CALL_FUNCTION(&_3$$3, "range", NULL, 422, &_0$$3, &_1$$3);
			zephir_check_call_status();
		...
		if (type == 2) {
			ZVAL_LONG(&_4$$4, 0);
			ZVAL_LONG(&_5$$4, 9);
			ZEPHIR_CALL_FUNCTION(&_6$$4, "range", NULL, 422, &_4$$4, &_5$$4);
			zephir_check_call_status();
			ZEPHIR_INIT_VAR(&_7$$4);
			ZVAL_STRING(&_7$$4, "a");
			ZEPHIR_INIT_VAR(&_8$$4);
			ZVAL_STRING(&_8$$4, "f");
			ZEPHIR_CALL_FUNCTION(&_9$$4, "range", NULL, 422, &_7$$4, &_8$$4);
			zephir_check_call_status();
		...
		if (type == 3) {
			ZVAL_LONG(&_10$$5, 0);
			ZVAL_LONG(&_11$$5, 9);
			ZEPHIR_CALL_FUNCTION(&pool, "range", NULL, 422, &_10$$5, &_11$$5);
			zephir_check_call_status();
			break;
		}
		if (type == 4) {
			ZVAL_LONG(&_12$$6, 1);
			ZVAL_LONG(&_13$$6, 9);
			ZEPHIR_CALL_FUNCTION(&pool, "range", NULL, 422, &_12$$6, &_13$$6);
			zephir_check_call_status();
			break;
		}
		if (type == 5) {
		...
		ZVAL_LONG(&_15$$8, 0);
		ZVAL_LONG(&_16$$8, 9);
		ZEPHIR_CALL_FUNCTION(&_17$$8, "range", NULL, 422, &_15$$8, &_16$$8);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(&_18$$8);
		ZVAL_STRING(&_18$$8, "a");
		ZEPHIR_INIT_VAR(&_19$$8);
		ZVAL_STRING(&_19$$8, "z");
		ZEPHIR_CALL_FUNCTION(&_20$$8, "range", NULL, 422, &_18$$8, &_19$$8);
		zephir_check_call_status();
		ZEPHIR_INIT_NVAR(&_18$$8);
		ZVAL_STRING(&_18$$8, "A");
		ZEPHIR_INIT_NVAR(&_19$$8);
		ZVAL_STRING(&_19$$8, "Z");
		ZEPHIR_CALL_FUNCTION(&_21$$8, "range", NULL, 422, &_18$$8, &_19$$8);
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&pool, "array_merge", NULL, 423, &_17$$8, &_20$$8, &_21$$8);
		zephir_check_call_status();
		break;
	} while(0);
...
PHP_METHOD(Phalcon_Text, reduceSlashes) {
	...
	ZEPHIR_INIT_VAR(&_1);
	ZVAL_STRING(&_1, "/");
	ZEPHIR_RETURN_CALL_FUNCTION("preg_replace", NULL, 35, &_0, &_1, &str);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Text, concat) {
	...
	if (ZEND_NUM_ARGS() > 3) {
		...
		ZVAL_LONG(&_4$$3, 3);
		ZEPHIR_CALL_FUNCTION(&_5$$3, "array_slice", NULL, 375, &_3$$3, &_4$$3);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Text, dynamic) {
	...
	ZEPHIR_CALL_FUNCTION(&_0, "substr_count", NULL, 424, &text, &leftDelimiter);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&_1, "substr_count", NULL, 424, &text, &rightDelimiter);
	zephir_check_call_status();
	if (!ZEPHIR_IS_IDENTICAL(&_0, &_1)) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_2$$3, "__construct", NULL, 425, &_3$$3);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_2$$3, "phalcon/text.zep", 289);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_CALL_FUNCTION(&ldS, "preg_quote", NULL, 426, &leftDelimiter);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&rdS, "preg_quote", NULL, 426, &rightDelimiter);
	zephir_check_call_status();
	...
	if (Z_TYPE_P(&matches) == IS_ARRAY) {
		...
		if (Z_TYPE_P(&matches) == IS_ARRAY) {
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&matches), _5$$5)
			{
				...
				ZEPHIR_CALL_FUNCTION(&_9$$6, "array_rand", &_10, 427, &words);
				zephir_check_call_status();
				...
				ZEPHIR_CALL_FUNCTION(&sub, "preg_quote", NULL, 426, &_11$$6, &separator);
				zephir_check_call_status();
				ZEPHIR_INIT_NVAR(&_12$$6);
				ZEPHIR_CONCAT_SVS(&_12$$6, "/", &sub, "/");
				ZVAL_LONG(&_13$$6, 1);
				ZEPHIR_CALL_FUNCTION(&_14$$6, "preg_replace", &_15, 35, &_12$$6, &word, &text, &_13$$6);
				zephir_check_call_status();
			...
			while (1) {
				...
				zephir_check_call_status();
					...
					ZEPHIR_OBS_NVAR(&word);
					ZEPHIR_CALL_FUNCTION(&_18$$8, "array_rand", &_10, 427, &words);
					zephir_check_call_status();
					...
					ZEPHIR_CALL_FUNCTION(&sub, "preg_quote", NULL, 426, &_19$$8, &separator);
					zephir_check_call_status();
					ZEPHIR_INIT_NVAR(&_20$$8);
					ZEPHIR_CONCAT_SVS(&_20$$8, "/", &sub, "/");
					ZVAL_LONG(&_21$$8, 1);
					ZEPHIR_CALL_FUNCTION(&_22$$8, "preg_replace", &_15, 35, &_20$$8, &word, &text, &_21$$8);
					zephir_check_call_status();
...
PHP_METHOD(Phalcon_Text, underscore) {
	...
	ZEPHIR_INIT_VAR(&_2);
	ZVAL_STRING(&_2, "_");
	ZEPHIR_RETURN_CALL_FUNCTION("preg_replace", NULL, 35, &_1, &_2, &_0);
	zephir_check_call_status();
	RETURN_MM();
