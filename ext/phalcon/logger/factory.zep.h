...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_phalcon_logger_factory_load, 0, 1, Phalcon\\Logger\\AdapterInterface, 0)
#else
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_phalcon_logger_factory_load, 0, 1, IS_OBJECT, "Phalcon\\Logger\\AdapterInterface", 0)
#endif
